...
unsafe extern "C" fn limb_mask(mut start: libc::c_int, mut last: libc::c_int)
 -> limb_t {
    ...
    if n == (1 as libc::c_int) << 6 as libc::c_int {
        ...
        v =
            ((1 as libc::c_int as limb_t) <<
                 n).wrapping_sub(1 as libc::c_int as libc::c_ulong) << start
    }
    return v;
}
            ...
            scan_bit_nz(r,
                        l.wrapping_mul(((1 as libc::c_int) <<
                                           ...
                                           libc::c_ulong).wrapping_sub(1 as
                                                                           libc::c_int
                                                                           as
                                                                           libc::c_ulong).wrapping_sub(bf_max(0
                                                                                                                  as
                                                                                                                  libc::c_int
                                                                                                                  as
                                                                                                                  slimb_t,
        ...
        get_bit((*r).tab, l,
                l.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as
                                   libc::c_ulong).wrapping_sub(1 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_ulong).wrapping_sub(prec
                                                                                                   as
                                                                                                   libc::c_ulong)
                    as slimb_t);
    inexact =
        (bit1 | bit0 != 0 as libc::c_int as libc::c_ulong) as libc::c_int;
...
unsafe extern "C" fn __bf_round(mut r: *mut bf_t, mut prec1: limb_t,
    ...
    if flags & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint != 0 {
        ...
        if prec1 !=
                                                                                          ...
                                                                                          libc::c_ulong)
           {
            ...
            __assert_fail(b"prec1 != BF_PREC_INF\x00" as *const u8 as
                              *const libc::c_char,
                          b"libbf.c\x00" as *const u8 as *const libc::c_char,
                          505 as libc::c_int as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 56],
                                                    &[libc::c_char; 56]>(b"int __bf_round(bf_t *, limb_t, bf_flags_t, limb_t, int)\x00")).as_ptr());
        }
        prec =
            prec1.wrapping_sub((e_min - (*r).expn) as libc::c_ulong) as
                slimb_t
    } else { prec = prec1 as slimb_t }
    /* round to prec bits */
    rnd_mode =
    ...
    if prec <= 0 as libc::c_int as libc::c_long {
        ...
        if add_one != 0 {
            ...
            while (i as libc::c_ulong) < l {
                ...
                *(*r).tab.offset(i as isize) = v;
                if carry == 0 as libc::c_int as libc::c_ulong { break ; }
                i += 1
            }
            if carry != 0 {
                ...
                v = 1 as libc::c_int as limb_t;
                i =
                    l.wrapping_sub(1 as libc::c_int as libc::c_ulong) as
                        slimb_t;
                while i >= pos {
        ...
        if ((*r).expn < e_min) as libc::c_int as libc::c_long != 0 {
            ...
            } else { current_block = 1297731417707248850; }
        ...
        match current_block {
            ...
            _ => {
                ...
                if i > 0 as libc::c_int as libc::c_long {
                    l =
                        (l as libc::c_ulong).wrapping_sub(i as libc::c_ulong)
                            as limb_t as limb_t;
...
pub unsafe extern "C" fn bf_normalize_and_round(mut r: *mut bf_t,
 ...
 -> libc::c_int {
    ...
    if l == 0 as libc::c_int as libc::c_ulong {
        ...
        (*r).expn =
            -(9223372036854775807 as libc::c_long) -
                1 as libc::c_int as libc::c_long; /* cannot fail */
        bf_resize(r, 0 as libc::c_int as limb_t);
        ret = 0 as libc::c_int
    } else {
        (*r).expn =
            ((*r).expn as
                 libc::c_ulong).wrapping_sub((*r).len.wrapping_sub(l).wrapping_mul(((1
                                                                                         as
                                                                                         libc::c_int)
                                                                                        <<
                                                                                        6
        ...
        v =
            *(*r).tab.offset(l.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                                 as isize);
        shift = clz(v);
        if shift != 0 as libc::c_int {
...
pub unsafe extern "C" fn mp_print_str(mut str: *const libc::c_char,
    ...
    while i >= 0 as libc::c_int as libc::c_long {
        ...
        printf(b"%016lx\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn bf_print_str(mut str: *const libc::c_char,
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long {
        ...
        if (*a).expn ==
            ...
            i =
                (*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as
                    slimb_t;
            while i >= 0 as libc::c_int as libc::c_long {
                printf(b"%016lx\x00" as *const u8 as *const libc::c_char,
            ...
            printf(b"p%ld\x00" as *const u8 as *const libc::c_char,
                   (*a).expn);
        }
    }
    printf(b"\n\x00" as *const u8 as *const libc::c_char);
        ...
        (*b).len.wrapping_sub((*a).len).wrapping_mul(((1 as libc::c_int) <<
                                                         ...
                                                         libc::c_ulong).wrapping_sub((((1
                                                                                          ...
                                                                                          1
                                                                                              ...
                                                                                              libc::c_int)
                                                                                         as
                                                                                         libc::c_ulong).wrapping_add((*a).expn
                                                                                                                         as
                                                                                                                         libc::c_ulong).wrapping_sub((*b).expn
                                                                                                                                                         as
                                                                                                                                                         libc::c_ulong)
            as slimb_t;
    ...
    if cmp_res == 0 as libc::c_int && is_sub != 0 &&
        ...
        if (*a).len == 0 as libc::c_int as libc::c_ulong ||
           ...
           subtraction */
            ...
            precl =
                (cancelled_bits as
                     libc::c_ulong).wrapping_add(prec).wrapping_add(2 as
                                                                        libc::c_int
                                                                        as
                                                                        libc::c_ulong).wrapping_add(((1
                                                                                                          as
            ...
            if bf_resize(r, r_len) != 0 {
                ...
                */
                    ...
                    u =
                        (u as libc::c_ulong).wrapping_add(carry) as limb_t as
                            limb_t;
                    carry =
                        (u < carry) as libc::c_int as libc::c_ulong | carry1;
                    z |= u
                }
                /* and the result */
                i = 0 as libc::c_int as slimb_t;
                ...
                let ref mut fresh1 =
                    *(*r).tab.offset(0 as libc::c_int as isize);
                *fresh1 |=
                    (z != 0 as libc::c_int as libc::c_ulong) as libc::c_int as
                        libc::c_ulong;
                ...
                } else { current_block = 6887627722379705880; }
            }
            match current_block {
                6887627722379705880 => { }
                _ => {
...
pub unsafe extern "C" fn mp_add_ui(mut tab: *mut limb_t, mut b: limb_t,
    ...
    while i < n {
        if k == 0 as libc::c_int as libc::c_ulong { break ; }
...
unsafe extern "C" fn mp_shr(mut tab_r: *mut limb_t, mut tab: *const limb_t,
    ...
    if shift >= 1 as libc::c_int &&
        ...
        __assert_fail(b"shift >= 1 && shift < LIMB_BITS\x00" as *const u8 as
                          *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
                      1119 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 64],
                                                &[libc::c_char; 64]>(b"limb_t mp_shr(limb_t *, const limb_t *, mp_size_t, int, limb_t)\x00")).as_ptr());
    }
    l = high;
    ...
    return l &
               ((1 as libc::c_int as limb_t) <<
                    shift).wrapping_sub(1 as libc::c_int as libc::c_ulong);
}
...
pub unsafe extern "C" fn mp_mul(mut s: *mut bf_context_t,
 ...
 -> libc::c_int {
    if (bf_min(op1_size as slimb_t, op2_size as slimb_t) >=
            100 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long
           != 0 {
        let mut r_s: bf_t =
...
unsafe extern "C" fn udiv1norm_init(mut d: limb_t) -> limb_t {
    let mut a0: limb_t = 0;
    let mut a1: limb_t = 0;
    a1 = d.wrapping_neg().wrapping_sub(1 as libc::c_int as libc::c_ulong);
...
unsafe extern "C" fn mp_divnorm(mut s: *mut bf_context_t,
    ...
    let mut j: slimb_t = 0;
    b1 =
        *tabb.offset(nb.wrapping_sub(1 as libc::c_int as libc::c_ulong) as
                         isize);
    ...
    while j >= 0 as libc::c_int as libc::c_long {
        if *taba.offset(n.wrapping_add(j as libc::c_ulong) as isize) !=
    ...
    *tabq.offset(n as isize) = q;
    ...
    i = n.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
    while i >= 0 as libc::c_int as libc::c_long {
        if (*taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize) >=
                b1) as libc::c_int as libc::c_long != 0 {
            q = -(1 as libc::c_int) as limb_t
        } else if b1_inv != 0 {
            q =
                udiv1norm(&mut dummy_r,
                          *taba.offset((i as libc::c_ulong).wrapping_add(nb)
                                           as isize),
                          *taba.offset((i as
                                            libc::c_ulong).wrapping_add(nb).wrapping_sub(1
                                                                                             as
                                                                                             libc::c_int
                                                                                             as
                                                                                             libc::c_ulong)
            ...
            al =
                (*taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize)
                     as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int) |
                    *taba.offset((i as
                                      libc::c_ulong).wrapping_add(nb).wrapping_sub(1
                                                                                       as
                                                                                       libc::c_int
        ...
        *taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize) = a;
        if c != 0 as libc::c_int as libc::c_ulong {
            loop 
                ...
                if !(c != 0 as libc::c_int as libc::c_ulong) { continue ; }
                let ref mut fresh2 =
                    *taba.offset((i as libc::c_ulong).wrapping_add(nb) as
                                     isize);
                *fresh2 = (*fresh2).wrapping_add(1);
                if *fresh2 == 0 as libc::c_int as libc::c_ulong { break ; }
            }
        }
 ...
 -> libc::c_int {
    ...
    if n <= 2 as libc::c_int as libc::c_ulong {
            ...
            bf_malloc(s,
                      (::std::mem::size_of::<limb_t>() as
                           libc::c_ulong).wrapping_mul((2 as libc::c_int as
                                                            libc::c_ulong).wrapping_mul(n).wrapping_add(1
                                                                                                            as
                                                                                                            libc::c_int
                                                                                                            as
                                                                                                            libc::c_ulong)))
        ...
        tabt =
            bf_malloc(s,
                      (::std::mem::size_of::<limb_t>() as
                           libc::c_ulong).wrapping_mul(n.wrapping_add(2 as
                                                                          libc::c_int
                                                                          as
                                                                          libc::c_ulong)))
                as *mut limb_t;
        if tabt.is_null() || tabu.is_null() {
            ...
            while (i as libc::c_ulong) <
                      (2 as libc::c_int as libc::c_ulong).wrapping_mul(n) {
                *tabu.offset(i as isize) = 0 as libc::c_int as limb_t;
                i += 1
            }
            *tabu.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(n)
                             as isize) = 1 as libc::c_int as limb_t;
        ...
        */
        tabt =
            bf_malloc(s,
                      (::std::mem::size_of::<limb_t>() as
                           libc::c_ulong).wrapping_mul(n.wrapping_add(h as
                                                                          libc::c_ulong).wrapping_add(1
                                                                                                          as
                                                                                                          libc::c_int
                                                                                                          as
        ...
        if tabt.is_null() || tabu.is_null() {
            ...
            if mp_recip(s, tabxh, taba.offset(l as isize), h as limb_t) != 0 {
                ...
                while *tabt.offset(n.wrapping_add(h as libc::c_ulong) as
                                       isize) !=
                          0 as libc::c_int as libc::c_ulong {
                ...
                let ref mut fresh3 =
                    *tabt.offset(n.wrapping_add(h as libc::c_ulong) as isize);
...
unsafe extern "C" fn mp_divnorm_large(mut s: *mut bf_context_t,
 ...
 -> libc::c_int {
    ...
    tabb_inv =
        bf_malloc(s,
                  (::std::mem::size_of::<limb_t>() as
                       libc::c_ulong).wrapping_mul(n.wrapping_add(1 as
                                                                      libc::c_int
                                                                      as
                                                                      libc::c_ulong)))
            as *mut limb_t;
    ...
    if !(tabb_inv.is_null() || tabt.is_null()) {
        ...
        match current_block {
            18317007320854588510 => {
                ...
                } else { current_block = 10280019852174212328; }
            }
            _ => { }
        }
        match current_block {
            ...
            /* Q=A*B^-1 */
            {
                if !(mp_mul(s, tabt, tabb_inv,
                        ...
                        *tabq.offset(i as isize) =
                            *tabt.offset(i.wrapping_add((2 as libc::c_int as
                                                             libc::c_ulong).wrapping_mul(n.wrapping_add(1
                                                                                                            ...
                                                                                                            libc::c_int
                                                                                                            as
                                                                                                            libc::c_ulong))).wrapping_sub(nq.wrapping_add(1
                                                                                                                                                              as
                                                                                                                                                              libc::c_int
                                                                                                                                                              as
                                                                                                                                                              libc::c_ulong))
                    ...
                    tabt =
                        bf_malloc(s,
                                  (::std::mem::size_of::<limb_t>() as
                                       libc::c_ulong).wrapping_mul(na.wrapping_add(1
                                                                                       as
                                                                                       libc::c_int
                                                                                       as
                                                                                       libc::c_ulong)))
       ...
       hence we may have to increment it */
                            while !(*taba.offset(nb as isize) ==
                                ...
                                *fresh4 =
                                    (*fresh4 as
                                         libc::c_ulong).wrapping_sub(mp_sub(taba,
                                                                            taba,
                                                                            tabb,
                                                                            nb
                                                                                as
...
pub unsafe extern "C" fn bf_get_exp_min(mut a: *const bf_t) -> slimb_t {
    ...
    while (i as libc::c_ulong) < (*a).len {
        ...
        if v != 0 as libc::c_int as libc::c_ulong {
            k = ctz(v);
            return ((*a).expn as
                        libc::c_ulong).wrapping_sub((*a).len.wrapping_sub(i as
    ...
    taba =
        bf_malloc(s,
                  na.wrapping_add(1 as libc::c_int as
                                      libc::c_ulong).wrapping_mul(::std::mem::size_of::<limb_t>()
                                                                      as
                                                                      libc::c_ulong))
            as *mut limb_t;
    if !taba.is_null() {
        ...
        memcpy(taba.offset(d as isize) as *mut libc::c_void,
               ...
               (*a).len.wrapping_mul(::std::mem::size_of::<limb_t>() as
                                         libc::c_ulong));
        if !(bf_resize(r, n.wrapping_add(1 as libc::c_int as libc::c_ulong))
                 != 0) {
                                ...
                                get_bit((*q).tab, (*q).len,
                                        (*q).len.wrapping_mul(((1 as
                                                                   ...
                                                                   6 as
                                                                       libc::c_int)
                                                                  as
                                                                  libc::c_ulong).wrapping_sub((*q).expn
                                                                                                  as
                                                                                                  libc::c_ulong)
                                            as slimb_t) != 0) {
...
unsafe extern "C" fn mp_sqrtrem1(mut pr: *mut limb_t, mut a: limb_t)
 -> limb_t {
        ...
        r1 =
            (r1 as
                 libc::c_ulong).wrapping_sub((2 as libc::c_int as
                                                  libc::c_ulong).wrapping_mul(s1).wrapping_add(1
                                                                                                   as
                                                                                                   libc::c_int
                                                                                                   as
                                                                                                   libc::c_ulong))
    ...
    r =
        (r as libc::c_ulong).wrapping_sub(q.wrapping_mul(q)) as limb_t as
            limb_t;
        ...
        r =
            (r as
                 libc::c_ulong).wrapping_add((2 as libc::c_int as
                                                  libc::c_ulong).wrapping_mul(s).wrapping_add(1
                                                                                                  as
                                                                                                  libc::c_int
                                                                                                  as
                                                                                                  libc::c_ulong))
...
unsafe extern "C" fn mp_sqrtrem2(mut tabs: *mut limb_t, mut taba: *mut limb_t)
 -> limb_t {
    ...
    q =
        num.wrapping_div((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1)
                             as u128) as limb_t;
    u =
        num.wrapping_rem((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1)
                             as u128) as limb_t;
        ...
        (u as dlimb_t) << l |
            (a0 &
                 ((1 as libc::c_int as limb_t) <<
                      l).wrapping_sub(1 as libc::c_int as libc::c_ulong)) as
                u128;
    if (q >> l != 0 as libc::c_int as libc::c_ulong) as libc::c_int as
           libc::c_long != 0 {
        r =
            (r as
...
unsafe extern "C" fn mp_sqrtrem_rec(mut s: *mut bf_context_t,
    ...
    if mp_sqrtrem_rec(s, tabs.offset(l as isize),
                      taba.offset((2 as libc::c_int as
                                       libc::c_ulong).wrapping_mul(l) as
                                      isize), h, tmp_buf, &mut qh) != 0 {
        return -(1 as libc::c_int)
    }
    /* the remainder is in taba + 2 * l. Its high bit is in qh */
    if qh != 0 {
        mp_sub(taba.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(l)
                               as isize),
               taba.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(l)
                               as isize), tabs.offset(l as isize),
    ...
    qh =
        (qh as libc::c_ulong).wrapping_add(*tmp_buf.offset(l as isize)) as
            limb_t as limb_t;
    i = 0 as libc::c_int as limb_t;
    while i < l {
    ...
    if qh != 0 {
        ...
        c =
            mp_sub(taba, taba, taba.offset(n as isize),
                   (2 as libc::c_int as libc::c_ulong).wrapping_mul(l) as
                       mp_size_t, 0 as libc::c_int as limb_t)
    }
    rh =
        (rh as
             libc::c_ulong).wrapping_sub(mp_sub_ui(taba.offset((2 as
                                                                    libc::c_int
                                                                    as
    ...
    if (rh as slimb_t) < 0 as libc::c_int as libc::c_long {
        ...
        rh =
            (rh as
                 libc::c_ulong).wrapping_add(mp_add_mul1(taba, tabs, n,
                                                         2 as libc::c_int as
                                                             limb_t)) as
                limb_t as limb_t;
        rh =
            (rh as
                 libc::c_ulong).wrapping_add(mp_add_ui(taba,
                                                       1 as libc::c_int as
                                                           limb_t, n)) as
                limb_t as limb_t
    }
    ...
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        if (*a).expn == 9223372036854775807 as libc::c_long {
            ...
            current_block_30 = 7815301370352969686;
                      ...
                      9223372036854775807 as libc::c_long -
                          1 as libc::c_int as libc::c_long && (*a).sign != 0 {
        ...
        bf_sqrt(r, a,
                (((*a).expn + 1 as libc::c_int as libc::c_long) /
                     2 as libc::c_int as libc::c_long) as limb_t,
                BF_RNDZ as libc::c_int as bf_flags_t);
...
pub unsafe extern "C" fn bf_sqrt(mut r: *mut bf_t, mut a: *const bf_t,
 ...
 -> libc::c_int {
    ...
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
                      2131 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 54],
                                                &[libc::c_char; 54]>(b"int bf_sqrt(bf_t *, const bf_t *, limb_t, bf_flags_t)\x00")).as_ptr());
    }
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        if (*a).expn == 9223372036854775807 as libc::c_long {
            bf_set_nan(r);
        ...
        n =
            (2 as libc::c_int as
                 libc::c_ulong).wrapping_mul(prec.wrapping_add(2 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_ulong)).wrapping_add((2
                                                                                                     as
        ...
        if bf_resize(r, n as limb_t) != 0 {
            ...
            if a1.is_null() {
                ...
                n1 =
                    bf_min(2 as libc::c_int as libc::c_long * n,
                           (*a).len as slimb_t);
                memset(a1 as *mut libc::c_void, 0 as libc::c_int,
                       ((2 as libc::c_int as libc::c_long * n - n1) as
                            libc::c_ulong).wrapping_mul(::std::mem::size_of::<limb_t>()
                                                            as
                                                            libc::c_ulong));
                memcpy(a1.offset((2 as libc::c_int as libc::c_long * n) as
                ...
                if (*a).expn & 1 as libc::c_int as libc::c_long != 0 {
                    res =
                        mp_shr(a1, a1, 2 as libc::c_int as libc::c_long * n,
                               1 as libc::c_int, 0 as libc::c_int as limb_t)
...
unsafe extern "C" fn bf_pow_ui(mut r: *mut bf_t, mut a: *const bf_t,
    ...
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 64],
                                                &[libc::c_char; 64]>(b"int bf_pow_ui(bf_t *, const bf_t *, limb_t, limb_t, bf_flags_t)\x00")).as_ptr());
    }
...
unsafe extern "C" fn bf_pow_ui_ui(mut r: *mut bf_t, mut a1: limb_t,
    ...
    let mut a: bf_t =
        bf_t{ctx: 0 as *mut bf_context_t,
             ...
             tab: 0 as *mut limb_t,};
    let mut ret: libc::c_int = 0;
    if a1 == 10 as libc::c_int as libc::c_ulong &&
           b <= 19 as libc::c_int as libc::c_ulong {
...
unsafe extern "C" fn bf_logic_op(mut r: *mut bf_t, mut a1: *const bf_t,
 ...
 -> libc::c_int {
    ...
    if r != a1 as *mut bf_t && r != b1 as *mut bf_t {
        ...
        __assert_fail(b"r != a1 && r != b1\x00" as *const u8 as
                          *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
                      2330 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 57],
                                                &[libc::c_char; 57]>(b"int bf_logic_op(bf_t *, const bf_t *, const bf_t *, int)\x00")).as_ptr());
    }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if op == 2 as libc::c_int &&
                           r_sign == 0 as libc::c_int as libc::c_ulong {
                    ...
                    if bf_resize(r, l as limb_t) != 0 {
                        ...
                        a_bit_offset =
                            (*a).len.wrapping_mul(((1 as libc::c_int) <<
                                                       6 as libc::c_int) as
                                                      libc::c_ulong).wrapping_sub((*a).expn
                                                                                      as
                                                                                      libc::c_ulong)
                                as slimb_t;
                        b_bit_offset =
 ...
 -> libc::c_int {
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long {
        ...
        if (*b).expn ==
            ...
            e =
                ((*b).expn + 1023 as libc::c_int as libc::c_long -
                     1 as libc::c_int as libc::c_long) as libc::c_int;
        ...
        if (*a).sign != 0 {
            ...
            if (*a).expn == 32 as libc::c_int as libc::c_long &&
                   *(*a).tab.offset((*a).len.wrapping_sub(1 as libc::c_int as
                                        ...
                                        as isize) >>
                       ((1 as libc::c_int) << 6 as libc::c_int) -
                           32 as libc::c_int == v as libc::c_ulong {
                ret = 0 as libc::c_int
            }
        } else { v = 2147483647 as libc::c_int as uint32_t }
    } else {
...
pub unsafe extern "C" fn bf_get_int64(mut pres: *mut int64_t,
    ...
    if (*a).expn >=
        ...
        if flags & (1 as libc::c_int) << 0 as libc::c_int != 0 {
            ...
            v =
                (9223372036854775807 as libc::c_long as
                     uint64_t).wrapping_add((*a).sign as libc::c_ulong)
        } else { v = 9223372036854775807 as libc::c_long as uint64_t }
    } else if (*a).expn <= 0 as libc::c_int as libc::c_long {
        v = 0 as libc::c_int as uint64_t;
        ret = 0 as libc::c_int
        ...
        let mut bit_pos: slimb_t =
            (*a).len.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as
                                      libc::c_ulong).wrapping_sub((*a).expn as
                                                                      libc::c_ulong)
                as slimb_t;
...
pub unsafe extern "C" fn bf_get_uint64(mut pres: *mut uint64_t,
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long {
        ...
        ret = 0 as libc::c_int;
        current_block_10 = 17407779659766490442;
    } else { current_block_10 = 8344853031916340450; }
...
unsafe extern "C" fn get_limb_radix(mut radix: libc::c_int) -> limb_t {
    ...
    while i < k {
        radixl =
            (radixl as libc::c_ulong).wrapping_mul(radix as libc::c_ulong) as
                limb_t as limb_t;
        i += 1
    }
    return radixl;
...
unsafe extern "C" fn bf_integer_from_radix_rec(mut r: *mut bf_t,
 ...
 -> libc::c_int {
    ...
    if n == 1 as libc::c_int as libc::c_ulong {
        ...
        let mut n2: limb_t = 0;
        n2 =
            (n0.wrapping_mul(2 as libc::c_int as libc::c_ulong) >>
                 level +
                     1 as
 ...
 -> libc::c_int {
    ...
    if prec ==
                                                                                      ...
                                                                                      libc::c_ulong)
       {
        ...
        loop  {
            prec1 =
                prec.wrapping_add(ziv_extra_bits as libc::c_ulong) as slimb_t;
            ...
            if ret & (1 as libc::c_int) << 4 as libc::c_int != 0 &&
                                    ...
                                    as bf_rnd_t, prec1) == 0 && overflow == 0
               {
                ...
                ziv_extra_bits =
                    ziv_extra_bits +
                        ziv_extra_bits / 2 as libc::c_int as libc::c_long
            } else {
...
unsafe extern "C" fn bf_add_limb(mut a: *mut bf_t, mut ppos: *mut slimb_t,
    ...
    let mut pos: slimb_t = 0;
    pos = *ppos;
    if (pos < 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long
           != 0 {
        let mut new_size: limb_t = 0;
        let mut d: limb_t = 0;
        let mut new_tab: *mut limb_t = 0 as *mut limb_t;
        new_size =
            bf_max((*a).len.wrapping_add(1 as libc::c_int as libc::c_ulong) as
                       slimb_t,
        ...
        new_tab =
            bf_realloc((*a).ctx, (*a).tab as *mut libc::c_void,
                       (::std::mem::size_of::<limb_t>() as
                            libc::c_ulong).wrapping_mul(new_size)) as
                *mut limb_t;
                        ...
                        if shift != digits_per_limb {
                            if radix_bits == 0 as libc::c_int {
                                while shift != 0 as libc::c_int {
                                    cur_limb =
                                        (cur_limb as
                                             libc::c_ulong).wrapping_mul(radix
                                                                             as
                                                                             libc::c_ulong)
                                            as limb_t as limb_t;
                                    shift -= 1
                                        ...
                                        _ => {
                                            if is_dec != 0 {
                                                ...
                                                if l ==
                                                    ...
                                                    expn =
                                                        (expn as
                                                             libc::c_ulong).wrapping_sub(l.wrapping_mul(digits_per_limb
                                                                                                            as
                                                                                                            libc::c_ulong).wrapping_sub(int_len
                                                                                                                                            as
                                                                                                                                            libc::c_ulong))
                                                            as slimb_t as
                                                            slimb_t;
...
static mut log2_radix: [limb_t; 35] =
    [0x2000000000000000 as libc::c_long as limb_t,
     ...
     0x8000000000000000 as libc::c_ulong, 0x82cc7edf592262d0 as libc::c_ulong,
     0x8570068e7ef5a1e8 as libc::c_ulong, 0x87ef05ae409a0289 as libc::c_ulong,
     0x8a4d3c25e68dc57f as libc::c_ulong, 0x8c8ddd448f8b845a as libc::c_ulong,
     0x8eb3a9f01975077f as libc::c_ulong, 0x90c10500d63aa659 as libc::c_ulong,
     0x92b803473f7ad0f4 as libc::c_ulong, 0x949a784bcd1b8afe as libc::c_ulong,
     0x966a008e4788cbcd as libc::c_ulong, 0x982809d5be7072dc as libc::c_ulong,
     0x99d5d9fd5010b366 as libc::c_ulong, 0x9b74948f5532da4b as libc::c_ulong,
     0x9d053f6d26089673 as libc::c_ulong, 0x9e88c6b3626a72aa as libc::c_ulong,
     0xa000000000000000 as libc::c_ulong, 0xa16bad3758efd873 as libc::c_ulong,
     0xa2cc7edf592262d0 as libc::c_ulong, 0xa4231623369e78e6 as libc::c_ulong,
    ...
    if radix & radix.wrapping_sub(1 as libc::c_int as libc::c_uint) ==
        ...
        if is_inv != 0 {
            if is_ceil != 0 {
                a =
                    (a as
                         libc::c_ulong).wrapping_add((radix_bits -
                                                          1 as libc::c_int) as
                                                         libc::c_ulong) as
                        limb_t as limb_t
            }
            a = a.wrapping_div(radix_bits as libc::c_ulong)
        } else { a = a.wrapping_mul(radix_bits as libc::c_ulong) }
    } else {
        ...
        a =
            (a as libc::c_ulong).wrapping_add(is_ceil as libc::c_ulong) as
                limb_t as limb_t
    }
        ...
        *out.offset(0 as libc::c_int as isize) =
        ...
        t =
            (get_bits((*a).tab, (*a).len,
                      pos +
                          ((1 as libc::c_int) << 6 as libc::c_int) as
                              libc::c_long) as dlimb_t) <<
                ((1 as libc::c_int) << 6 as libc::c_int) |
                get_bits((*a).tab, (*a).len, pos) as u128;
        if (radixl == 10000000000000000000 as libc::c_ulong) as libc::c_int as
               libc::c_long != 0 {
            /* use division by a constant when possible */
            *out.offset(0 as libc::c_int as isize) =
                t.wrapping_rem(10000000000000000000 as libc::c_ulong as u128)
                    as limb_t;
            *out.offset(1 as libc::c_int as isize) =
                t.wrapping_div(10000000000000000000 as libc::c_ulong as u128)
                    as limb_t
        } else {
            *out.offset(0 as libc::c_int as isize) =
            ...
            ret |=
                bf_div(B_inv, &mut R, B,
                       n2.wrapping_add(1 as libc::c_int as
                                           libc::c_ulong).wrapping_mul(radixl_bits
                                                                           as
                                                                           libc::c_ulong).wrapping_add(2
                                                                                                           as
                                                                                                           libc::c_int
        ...
        if ret & (1 as libc::c_int) << 5 as libc::c_int != 0 {
            ...
            loop  {
                if !(R.sign != 0 &&
                         R.len != 0 as libc::c_int as libc::c_ulong) {
...
unsafe extern "C" fn output_digits(mut s: *mut DynBuf, mut a1: *const bf_t,
    ...
    if is_dec != 0 {
        ...
        pos =
            (*a).len.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as
                                      libc::c_ulong).wrapping_add(smod(-(*a).expn,
                                                                       radix_bits
                                                                           as
                                                                           slimb_t))
                as slimb_t;
        ...
        n =
            n_digits.wrapping_add(digits_per_limb as
                                      libc::c_ulong).wrapping_sub(1 as
                                                                      libc::c_int
                                                                      as
                                                                      libc::c_ulong).wrapping_div(digits_per_limb
                                                                                                      as
                                                                                                      libc::c_ulong);
        if bf_resize(a, n) != 0 {
            dbuf_set_error(s);
            ...
            pos_incr = 1 as libc::c_int as slimb_t;
            first_buf_pos =
                ((pos * digits_per_limb as libc::c_long) as
                     libc::c_ulong).wrapping_sub(n_digits) as libc::c_int;
            current_block = 5689316957504528238;
        }
    }
    match current_block {
            ...
            while i < n_digits {
                ...
                dbuf_put(s,
                         buf.as_mut_ptr().offset(buf_pos as isize) as
                             *mut uint8_t, l);
                buf_pos =
                    (buf_pos as libc::c_ulong).wrapping_add(l) as libc::c_int
                        as libc::c_int;
...
unsafe extern "C" fn bf_ftoa_internal(mut plen: *mut size_t,
                                      ...
                                      mut radix: libc::c_int,
                                      mut prec: limb_t, mut flags: bf_flags_t,
                                      mut is_dec: BOOL) -> *mut libc::c_char {
    let mut a_s_0: bf_t =
        bf_t{ctx: 0 as *mut bf_context_t,
             sign: 0,
             expn: 0,
    ...
    if (*a2).expn == 9223372036854775807 as libc::c_long {
        ...
        if (*a2).expn ==
                            ...
                            _ => {
                                ...
                                if (*a1).expn ==
                                           ...
                                           - 1 as libc::c_int as libc::c_long
                                   {
                                    ...
                                    n_digits =
                                        prec.wrapping_add(n as libc::c_ulong)
                                            as slimb_t;
                    ...
                    n =
                        1 as libc::c_int as libc::c_long +
                            bf_mul_log2_radix(bf_max((*a).expn,
                                              ...
                                              TRUE as libc::c_int);
                    n_digits =
                        (n as libc::c_ulong).wrapping_add(prec) as slimb_t;
                    n1 = n;
                ...
                if is_dec != 0 {
                    if bf_set(a1, a2) != 0 {
                        ...
                        if fmt == (0 as libc::c_int) << 16 as libc::c_int {
                            ...
                            n_max =
                                n_digits + 4 as libc::c_int as libc::c_long;
                    ...
                    if bf_set(a1, a2) != 0 {
                        ...
                        if fmt == (0 as libc::c_int) << 16 as libc::c_int {
                            ...
                            prec_bits =
                                prec.wrapping_mul(radix_bits as
                                                      libc::c_ulong).wrapping_sub(smod(-(*a1).expn,
                                                                                       radix_bits
                                                                                           as
                                                                                           slimb_t))
                                    as slimb_t;
                           ...
                           significant digit in bits */
                            pos_0 =
                                (*a1).len.wrapping_mul(((1 as libc::c_int) <<
                                                            6 as libc::c_int)
                                                           as
                                                           libc::c_ulong).wrapping_add(smod(-(*a1).expn,
                                                                                            radix_bits
                                                                                                as
                                                                                                slimb_t))
                                    as slimb_t;
            ...
            match current_block {
                ...
                _ => { bf_delete(a1); current_block = 2562566406710242701; }
            }
        }
    }
    match current_block {
...
unsafe extern "C" fn bf_const_log2_rec(mut T: *mut bf_t, mut P: *mut bf_t,
    ...
    if n2.wrapping_sub(n1) == 1 as libc::c_int as libc::c_ulong {
        ...
        bf_set_ui(Q,
                  (2 as libc::c_int as
                       libc::c_ulong).wrapping_mul(n1).wrapping_add(1 as
                                                                        libc::c_int
                                                                        as
                                                                        libc::c_ulong));
...
unsafe extern "C" fn chud_bs(mut P: *mut bf_t, mut Q: *mut bf_t,
    ...
    if a == b - 1 as libc::c_int as libc::c_long {
        ...
        bf_init(s, &mut T1);
        bf_set_ui(G,
                  (2 as libc::c_int as libc::c_long * b -
                       1 as libc::c_int as libc::c_long) as uint64_t);
        bf_mul_ui(G, G,
                  (6 as libc::c_int as libc::c_long * b -
                       1 as libc::c_int as libc::c_long) as uint64_t, prec,
                  BF_RNDN as libc::c_int as bf_flags_t);
        bf_mul_ui(G, G,
                  (6 as libc::c_int as libc::c_long * b -
                       5 as libc::c_int as libc::c_long) as uint64_t, prec,
                  BF_RNDN as libc::c_int as bf_flags_t);
        ...
        bf_mul_ui(Q, Q,
                  (640320 as libc::c_int as
                       uint64_t).wrapping_mul(640320 as libc::c_int as
                                                  libc::c_ulong).wrapping_mul(640320
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
                                                                                  libc::c_ulong).wrapping_div(24
                                                                                                                  as
                                                                                                                  libc::c_int
                                                                                                                  as
                                                                                                                  libc::c_ulong),
...
unsafe extern "C" fn bf_const_pi_internal(mut Q: *mut bf_t,
    ...
    bf_mul_ui(&mut G, &mut G,
              (640320 as libc::c_int as
                   uint64_t).wrapping_div(12 as libc::c_int as libc::c_ulong),
    ...
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 58],
                                                &[libc::c_char; 58]>(b"int bf_exp_internal(bf_t *, const bf_t *, limb_t, void *)\x00")).as_ptr());
    }
    /* argument reduction:
    ...
    */
    ...
    l =
        prec.wrapping_sub(1 as libc::c_int as
                              libc::c_ulong).wrapping_div(K as
                                                              libc::c_ulong).wrapping_add(1
                                                                                              as
                                                                                              libc::c_int
                                                                                              as
    ...
    /* XXX: precision analysis ? */
    prec1 =
        prec.wrapping_add((K + 2 as libc::c_int as libc::c_long * l +
                               18 as libc::c_int as libc::c_long) as
                              libc::c_ulong).wrapping_add(K as
                                                              libc::c_ulong).wrapping_add(8
                                                                                              ...
                                                                                              libc::c_ulong)
            as slimb_t;
    if (*a).expn > 0 as libc::c_int as libc::c_long { prec1 += (*a).expn }
...
unsafe extern "C" fn check_exp_underflow_overflow(mut s: *mut bf_context_t,
 ...
 -> libc::c_int {
    ...
    if flags & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint != 0 {
        e_min =
            (e_min as
                 libc::c_ulong).wrapping_sub(prec.wrapping_sub(1 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_ulong))
                as slimb_t as slimb_t
    ...
    bf_const_log2(log2, ((1 as libc::c_int) << 6 as libc::c_int) as limb_t,
                  BF_RNDD as libc::c_int as bf_flags_t);
    bf_mul_si(T, log2, e_min - 2 as libc::c_int as libc::c_long,
              ((1 as libc::c_int) << 6 as libc::c_int) as limb_t,
              BF_RNDD as libc::c_int as bf_flags_t);
    ...
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"int bf_exp(bf_t *, const bf_t *, limb_t, bf_flags_t)\x00")).as_ptr());
    }
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        if (*a).expn == 9223372036854775807 as libc::c_long {
            bf_set_nan(r);
 ...
 -> libc::c_int {
    ...
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 58],
                                                &[libc::c_char; 58]>(b"int bf_log_internal(bf_t *, const bf_t *, limb_t, void *)\x00")).as_ptr());
    }
    bf_init(s, T);
    ...
    l =
        prec.wrapping_div((2 as libc::c_int as libc::c_long * K) as
                              libc::c_ulong).wrapping_add(1 as libc::c_int as
                                                              libc::c_ulong)
            as slimb_t;
    ...
    while i >= 1 as libc::c_int as libc::c_long {
        ...
        bf_set_ui(V,
                  (2 as libc::c_int as libc::c_long * i +
                       1 as libc::c_int as libc::c_long) as uint64_t);
    ...
    /* multiplication by 2 for the Taylor expansion and undo the
       argument reduction 2*/
    bf_mul_2exp(r, K + 1 as libc::c_int as libc::c_long,
                ((1 as libc::c_int as limb_t) <<
                     ((1 as libc::c_int) << 6 as libc::c_int) -
                         2 as
                             libc::c_int).wrapping_sub(2 as libc::c_int as
 ...
 -> libc::c_int {
    ...
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"int bf_log(bf_t *, const bf_t *, limb_t, bf_flags_t)\x00")).as_ptr());
    }
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        if (*a).expn == 9223372036854775807 as libc::c_long {
            bf_set_nan(r);
 ...
 -> libc::c_int {
    ...
    prec1 =
        prec.wrapping_add(32 as libc::c_int as
                              libc::c_ulong); /* no overflow/underlow test needed */
    bf_log(T, x, prec1,
...
unsafe extern "C" fn bf_pow_int(mut r: *mut bf_t, mut x: *const bf_t,
 ...
 -> libc::c_int {
    ...
    if y1 < 0 as libc::c_int as libc::c_long { y1 = -y1 }
    /* XXX: proof for the added precision */
    prec1 =
    ...
    ret =
        bf_pow_ui(r, x,
                  if y1 < 0 as libc::c_int as libc::c_long { -y1 } else { y1 }
                      as limb_t, prec1,
                  (BF_RNDN as libc::c_int |
                       (0x3f as libc::c_int) << 5 as libc::c_int) as
                      bf_flags_t);
...
unsafe extern "C" fn check_exact_power2n(mut r: *mut bf_t, mut x: *const bf_t,
    ...
    v =
        get_bits((*x).tab, (*x).len,
                 (*x).len.wrapping_mul(((1 as libc::c_int) <<
                                            6 as libc::c_int) as
                                           libc::c_ulong).wrapping_sub((*x).expn
                                                                           as
                                                                           libc::c_ulong).wrapping_add(e
                                                                                                           as
                                                                                                           libc::c_ulong)
                     as slimb_t);
    if v & 7 as libc::c_int as libc::c_ulong !=
           1 as libc::c_int as libc::c_ulong {
        return FALSE as libc::c_int
    }
    bf_init(s, T);
    ...
    i = 0 as libc::c_int as slimb_t;
    while i < n {
        if i != 0 as libc::c_int as libc::c_long { bf_set(T, r); }
...
pub unsafe extern "C" fn bf_pow(mut r: *mut bf_t, mut x: *const bf_t,
        ...
        if (*y).expn ==
            ...
            if cmp_x_abs_1 == 0 as libc::c_int &&
                ...
                if (*y).expn == 9223372036854775807 as libc::c_long {
                    ...
                    y_is_odd =
                        (y_emin == 0 as libc::c_int as libc::c_long) as
                            libc::c_int;
                    if (*y).sign ==
                           ((*x).expn ==
                                -(9223372036854775807 as libc::c_long) -
    ...
    if (*x).sign != 0 {
        ...
        y_is_odd =
            (y_emin == 0 as libc::c_int as libc::c_long) as libc::c_int;
        r_sign = y_is_odd;
        ...
        if !(ret != 0) {
            if y_is_int != 0 {
                ...
                if y_emin < 0 as libc::c_int as libc::c_long &&
                    ...
                    y = y1_0;
                    current_block = 12991220813362298223;
                } else { current_block = 10289029935050646611; }
            } else { current_block = 10289029935050646611; }
            match current_block {
...
unsafe extern "C" fn bf_sincos(mut s: *mut bf_t, mut c: *mut bf_t,
 ...
 -> libc::c_int {
    ...
    if c != a as *mut bf_t && s != a as *mut bf_t {
        ...
        __assert_fail(b"c != a && s != a\x00" as *const u8 as
                          *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
                      4850 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 52],
                                                &[libc::c_char; 52]>(b"int bf_sincos(bf_t *, bf_t *, const bf_t *, limb_t)\x00")).as_ptr());
    }
    bf_init(s1, T);
    bf_init(s1, U);
    bf_init(s1, r);
    /* XXX: precision analysis */
    K =
        bf_isqrt(prec.wrapping_div(2 as libc::c_int as libc::c_ulong)) as
            slimb_t;
    l =
        prec.wrapping_div((2 as libc::c_int as libc::c_long * K) as
                              libc::c_ulong).wrapping_add(1 as libc::c_int as
            ...
            as slimb_t;
    prec1 =
        prec.wrapping_add((2 as libc::c_int as libc::c_long * K) as
            ...
            if mod_0 == 0 as libc::c_int as libc::c_long ||
                   (*T).expn !=
                       -(9223372036854775807 as libc::c_long) -
                           1 as libc::c_int as libc::c_long &&
                       (*T).expn + prec2 >=
                           prec1 - 1 as libc::c_int as libc::c_long {
                break ;
            }
            /* increase the number of bits until the precision is good enough */
            cancel =
                bf_max(-(*T).expn,
                       (cancel + 1 as libc::c_int as libc::c_long) *
    ...
    bf_mul_2exp(T, -(2 as libc::c_int) as libc::c_long * K,
                ((1 as libc::c_int as limb_t) <<
                     ((1 as libc::c_int) << 6 as libc::c_int) -
                         2 as
                             libc::c_int).wrapping_sub(2 as libc::c_int as
    ...
    */
    ...
    while i >= 1 as libc::c_int as libc::c_long {
        bf_set_ui(U,
                  (2 as libc::c_int as libc::c_long * i -
                       1 as libc::c_int as libc::c_long) as uint64_t);
        bf_mul_ui(U, U, (2 as libc::c_int as libc::c_long * i) as uint64_t,
                  ((1 as libc::c_int as limb_t) <<
                       ((1 as libc::c_int) << 6 as libc::c_int) -
                           2 as
                               libc::c_int).wrapping_sub(2 as libc::c_int as
    ...
    */
    ...
    bf_delete(T);
    if !c.is_null() {
        if mod_0 & 1 as libc::c_int as libc::c_long ==
               0 as libc::c_int as libc::c_long {
        ...
        (*c).sign =
            ((*c).sign as libc::c_long ^ mod_0 >> 1 as libc::c_int) as
                libc::c_int
    }
    if !s.is_null() {
        if mod_0 & 1 as libc::c_int as libc::c_long ==
        ...
        (*s).sign =
            ((*s).sign as libc::c_long ^ mod_0 >> 1 as libc::c_int) as
                libc::c_int
    }
    bf_delete(r);
    return (1 as libc::c_int) << 4 as libc::c_int;
...
pub unsafe extern "C" fn bf_sin(mut r: *mut bf_t, mut a: *const bf_t,
 ...
 -> libc::c_int {
    ...
    if (*a).expn < 0 as libc::c_int as libc::c_long {
        let mut e: slimb_t = 0;
        e =
            sat_add(2 as libc::c_int as libc::c_long * (*a).expn,
                    (*a).expn - 2 as libc::c_int as libc::c_long);
        if e <
               (*a).expn -
                   bf_max(prec.wrapping_add(2 as libc::c_int as libc::c_ulong)
                              as slimb_t,
                          (*a).len.wrapping_mul(((1 as libc::c_int) <<
                                                     6 as libc::c_int) as
                                                    libc::c_ulong).wrapping_add(2
 ...
 -> libc::c_int {
    if r != a as *mut bf_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"int bf_tan(bf_t *, const bf_t *, limb_t, bf_flags_t)\x00")).as_ptr());
    }
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        if (*a).expn == 9223372036854775807 as libc::c_long {
            bf_set_nan(r);
...
pub static mut mp_pow_dec: [limb_t; 20] =
    [1 as libc::c_uint as limb_t, 10 as libc::c_uint as limb_t,
     ...
     1000000000 as libc::c_uint as limb_t, 10000000000 as libc::c_ulong,
     100000000000 as libc::c_ulong, 1000000000000 as libc::c_ulong,
     10000000000000 as libc::c_ulong, 100000000000000 as libc::c_ulong,
     1000000000000000 as libc::c_ulong, 10000000000000000 as libc::c_ulong,
...
static mut mp_pow_div: [FastDivData; 20] =
    [{
     ...
     {
         let mut init =
             FastDivData{m1: 0x999999999999999a as libc::c_ulong,
     ...
     {
         let mut init =
             FastDivData{m1: 0xa36e2eb1c432ca58 as libc::c_ulong,
                         shift1: 1 as libc::c_int as int8_t,
     ...
     {
         let mut init =
             FastDivData{m1: 0xad7f29abcaf48579 as libc::c_ulong,
                         shift1: 1 as libc::c_int as int8_t,
     ...
     {
         let mut init =
             FastDivData{m1: 0xb7cdfd9d7bdbab7e as libc::c_ulong,
                         shift1: 1 as libc::c_int as int8_t,
     ...
     {
         let mut init =
             FastDivData{m1: 0xc25c268497681c27 as libc::c_ulong,
                         shift1: 1 as libc::c_int as int8_t,
     ...
     {
         let mut init =
             FastDivData{m1: 0xcd2b297d889bc2b7 as libc::c_ulong,
                         shift1: 1 as libc::c_int as int8_t,
     ...
     {
         let mut init =
             FastDivData{m1: 0xd83c94fb6d2ac34d as libc::c_ulong,
                         shift1: 1 as libc::c_int as int8_t,
...
pub unsafe extern "C" fn mp_mul1_dec(mut tabr: *mut limb_t,
    ...
    while i < n {
        ...
        t1 =
            (t1 as
                 libc::c_ulong).wrapping_add((0 as libc::c_int +
                                                  (t0 < __t_0) as libc::c_int)
                                                 as libc::c_ulong) as limb_t
                as limb_t;
        ...
        __t_1 =
            (__t0 as
                 u128).wrapping_mul(17014118346046923173 as libc::c_ulong as
                                        u128);
        ...
        __a0 =
            (__a0 as libc::c_ulong).wrapping_sub(__t0) as uint64_t as
                uint64_t;
        __a1 =
            (__a1 as
                 libc::c_ulong).wrapping_sub(__t1.wrapping_add((__a0 > __t_3)
                                                                   as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_ulong))
        ...
        __a0 =
            (__a0 as
                 libc::c_ulong).wrapping_sub(__b.wrapping_mul(2 as libc::c_int
                                                                  as
                                                                  libc::c_ulong))
                as uint64_t as uint64_t;
        __a1 =
        ...
        l =
            (l as
                 libc::c_ulong).wrapping_add((2 as libc::c_int as
                                                  libc::c_ulong).wrapping_add(__t0))
                as limb_t as limb_t;
        let mut __t_5: limb_t = __a0;
        __a0 =
            (__a0 as libc::c_ulong).wrapping_add(__b & __t0) as uint64_t as
                uint64_t;
        __a1 =
            (__a1 as
                 libc::c_ulong).wrapping_add((0 as libc::c_int +
        ...
        __a0 =
            (__a0 as libc::c_ulong).wrapping_add(__b & __a1) as uint64_t as
                uint64_t;
        r = __a0;
...
pub unsafe extern "C" fn mp_add_mul1_dec(mut tabr: *mut limb_t,
 ...
 -> limb_t {
    ...
    while i < n {
        ...
        t0 =
            (t0 as libc::c_ulong).wrapping_add(*tabr.offset(i as isize)) as
                limb_t as limb_t;
        t1 =
            (t1 as
                 libc::c_ulong).wrapping_add((0 as libc::c_int +
                                                  (t0 < __t_1) as libc::c_int)
                                                 as libc::c_ulong) as limb_t
                as limb_t;
        let mut __a0: uint64_t = 0;
        let mut __a1: uint64_t = 0;
        ...
        __a1 =
            (__a1 as
                 libc::c_ulong).wrapping_sub(__t1.wrapping_add((__a0 > __t_4)
                                                                   as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_ulong))
    ...
    if b == 2 as libc::c_int as libc::c_ulong {
        ...
        while i >= 0 as libc::c_int as libc::c_long {
            ...
            *tabr.offset(i as isize) =
            ...
            if t0 & 1 as libc::c_int as libc::c_ulong != 0 { r = base_div2 }
            i -= 1
        }
        ...
        if shift == 0 as libc::c_int {
            ...
            while i >= 0 as libc::c_int as libc::c_long {
                ...
                t0 =
                    (t0 as
                         libc::c_ulong).wrapping_add(*taba.offset(i as isize))
                        as limb_t as limb_t;
                t1 =
                    (t1 as
                         libc::c_ulong).wrapping_add((0 as libc::c_int +
        ...
        while i >= 0 as libc::c_int as libc::c_long {
            ...
            t0 =
                (t0 as libc::c_ulong).wrapping_add(*taba.offset(i as isize))
                    as limb_t as limb_t;
            t1 =
                (t1 as
                     libc::c_ulong).wrapping_add((0 as libc::c_int +
...
unsafe extern "C" fn mp_div_dec(mut s: *mut bf_context_t,
    ...
    while i >= 0 as libc::c_int as libc::c_long {
        if (*taba.offset((i + nb) as isize) >=
            ...
            t0 =
                (t0 as
                     libc::c_ulong).wrapping_add(*taba.offset((i + nb -
                                                                   1 as
                                                                       libc::c_int
                                                                       as
                                                                       libc::c_long)
...
unsafe extern "C" fn mp_shr_dec(mut tab_r: *mut limb_t,
 ...
 -> limb_t {
    ...
    let mut q: limb_t = 0;
    let mut r: limb_t = 0;
    if shift >= 1 as libc::c_int as libc::c_ulong &&
           shift < 19 as libc::c_int as libc::c_ulong {
    } else {
        __assert_fail(b"shift >= 1 && shift < LIMB_DIGITS\x00" as *const u8 as
                          *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
                      5943 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 71],
                                                &[libc::c_char; 71]>(b"limb_t mp_shr_dec(limb_t *, const limb_t *, mp_size_t, limb_t, limb_t)\x00")).as_ptr());
    }
    l = high;
    i = n - 1 as libc::c_int as libc::c_long;
    while i >= 0 as libc::c_int as libc::c_long {
        ...
        *tab_r.offset(i as isize) =
            q.wrapping_add(l.wrapping_mul(mp_pow_dec[(19 as libc::c_int as
                                                          libc::c_ulong).wrapping_sub(shift)
                                                         as usize]));
        l = r;
        i -= 1
    }
 ...
 -> limb_t {
    ...
    if shift >= 1 as libc::c_int as libc::c_ulong &&
        ...
        __assert_fail(b"shift >= 1 && shift < LIMB_DIGITS\x00" as *const u8 as
                      ...
                      (*::std::mem::transmute::<&[u8; 71],
                                                &[libc::c_char; 71]>(b"limb_t mp_shl_dec(limb_t *, const limb_t *, mp_size_t, limb_t, limb_t)\x00")).as_ptr());
    }
    l = low;
    i = 0 as libc::c_int as mp_size_t;
    while i < n {
        ...
        q =
            fast_shr_dec(a,
                         (19 as libc::c_int as
                              libc::c_ulong).wrapping_sub(shift) as
                             libc::c_int);
        r =
...
unsafe extern "C" fn mp_sqrtrem2_dec(mut tabs: *mut limb_t,
    ...
    a =
        (*taba.offset(1 as libc::c_int as isize) as
             dlimb_t).wrapping_mul(10000000000000000000 as libc::c_ulong as
    ...
    __a1 =
        (__a1 as
             libc::c_ulong).wrapping_sub(__t1.wrapping_add((__a0 > __t_1) as
                                                               libc::c_int as
                                                               libc::c_ulong))
            as uint64_t as uint64_t;
    ...
    __a0 =
        (__a0 as
             libc::c_ulong).wrapping_sub(__b.wrapping_mul(2 as libc::c_int as
                                                              libc::c_ulong))
            as uint64_t as uint64_t;
    __a1 =
        (__a1 as
             libc::c_ulong).wrapping_sub((1 as libc::c_int +
                                              (__a0 > __t_2) as libc::c_int)
                                             as libc::c_ulong) as uint64_t as
            uint64_t;
    __t0 = (__a1 as slimb_t >> 1 as libc::c_int) as uint64_t;
    r1 =
        (r1 as
...
unsafe extern "C" fn mp_sqrtrem_rec_dec(mut tabs: *mut limb_t,
    ...
    if qh != 0 {
        mp_sub_dec(taba.offset((2 as libc::c_int as
                                    libc::c_ulong).wrapping_mul(l) as isize),
                   taba.offset((2 as libc::c_int as
                                    libc::c_ulong).wrapping_mul(l) as isize),
    ...
    rh =
        (rh as
             libc::c_ulong).wrapping_sub(mp_sub_ui_dec(taba.offset((2 as
                                                                        libc::c_int
                                                                        as
                                                                        libc::c_ulong).wrapping_mul(l)
                                                                       as
    ...
    if (rh as slimb_t) < 0 as libc::c_int as libc::c_long {
        ...
        rh =
            (rh as
                 libc::c_ulong).wrapping_add(mp_add_mul1_dec(taba, tabs,
                                                             n as mp_size_t,
                                                             2 as libc::c_int
                                                                 as limb_t))
                as limb_t as limb_t;
        rh =
            (rh as
                 libc::c_ulong).wrapping_add(mp_add_ui_dec(taba,
                                                           1 as libc::c_int as
                                                               limb_t,
                                                           n as mp_size_t)) as
                limb_t as limb_t
...
unsafe extern "C" fn clz_dec(mut a: limb_t) -> libc::c_int {
    if a == 0 as libc::c_int as libc::c_ulong { return 19 as libc::c_int }
        ...
        if (*a).expn ==
            ...
            i =
                (*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as
                    slimb_t;
            while i >= 0 as libc::c_int as libc::c_long {
                printf(b"%0*lu\x00" as *const u8 as *const libc::c_char,
                       19 as libc::c_int, *(*a).tab.offset(i as isize));
                i -= 1
            }
            printf(b"e%ld\x00" as *const u8 as *const libc::c_char,
                   (*a).expn);
        }
    }
    printf(b"\n\x00" as *const u8 as *const libc::c_char);
...
unsafe extern "C" fn scan_digit_nz(mut r: *const bfdec_t,
    ...
    pos =
        (bit_pos as limb_t).wrapping_div(19 as libc::c_int as libc::c_ulong)
            as slimb_t;
    shift =
        (bit_pos as limb_t).wrapping_rem(19 as libc::c_int as libc::c_ulong)
            as libc::c_int;
    q =
    ...
    digit1 =
        get_digit((*r).tab, l,
                  l.wrapping_mul(19 as libc::c_int as
                      ...
                      as slimb_t);
    inexact =
        (digit1 | digit0 != 0 as libc::c_int as libc::c_ulong) as libc::c_int;
    add_one = 0 as libc::c_int;
    match rnd_mode {
        1 => { }
        0 => {
        ...
        4 | 6 => {
            add_one =
                (digit1 >= 5 as libc::c_int as libc::c_ulong) as libc::c_int
        }
        5 => { add_one = inexact }
        _ => { abort(); }
    }
 ...
 -> libc::c_int {
        ...
        if prec1 !=
                                                                                          ...
                                                                                          libc::c_ulong)
           {
            ...
            __assert_fail(b"prec1 != BF_PREC_INF\x00" as *const u8 as
                          ...
                          (*::std::mem::transmute::<&[u8; 57],
                                                    &[libc::c_char; 57]>(b"int __bfdec_round(bfdec_t *, limb_t, bf_flags_t, limb_t)\x00")).as_ptr());
        }
        prec =
            prec1.wrapping_sub((e_min - (*r).expn) as libc::c_ulong) as
                slimb_t
    ...
    if prec <= 0 as libc::c_int as libc::c_long {
        if add_one != 0 {
            ...
            *(*r).tab.offset(0 as libc::c_int as isize) =
                (10000000000000000000 as
                     libc::c_ulong).wrapping_div(10 as libc::c_int as
                                                     libc::c_ulong);
            (*r).expn += 1 as libc::c_int as libc::c_long - prec;
            ret |=
                (1 as libc::c_int) << 3 as libc::c_int |
        ...
        if add_one != 0 {
            ...
            carry =
                mp_pow_dec[(bit_pos % 19 as libc::c_int as libc::c_long) as
                               usize];
            carry =
                mp_add_ui_dec((*r).tab.offset(pos as isize), carry,
                              l.wrapping_sub(pos as libc::c_ulong) as
                                  mp_size_t);
            if carry != 0 {
                /* shift right by one digit */
        ...
        if ((*r).expn < e_min) as libc::c_int as libc::c_long != 0 {
            ...
            } else { current_block = 10692295422897365397; }
...
pub unsafe extern "C" fn bfdec_normalize_and_round(mut r: *mut bfdec_t,
 ...
 -> libc::c_int {
    ...
    if l == 0 as libc::c_int as libc::c_ulong {
        ...
        (*r).expn =
            ((*r).expn as
                 libc::c_ulong).wrapping_sub((*r).len.wrapping_sub(l).wrapping_mul(19
                                                                                       as
                                                                                       libc::c_int
                                                                                       as
                                                                                       libc::c_ulong))
        ...
        if (*a).len == 0 as libc::c_int as libc::c_ulong ||
           ...
           not infinite */
            ...
            if bfdec_resize(r, r_len as limb_t) != 0 {
                ...
                (*r).expn = (*a).expn;
                a_offset =
                    (r_len as libc::c_ulong).wrapping_sub((*a).len) as
                        slimb_t;
                i = 0 as libc::c_int as slimb_t;
                while i < a_offset {
                ...
                b_shift =
                    (d % 19 as libc::c_int as libc::c_long) as libc::c_int;
                ...
                match current_block {
                    ...
                    _ => {
                        b_offset =
                            (r_len as
                                 libc::c_ulong).wrapping_sub((*b).len.wrapping_add(((d
                                                                                         +
                                                                                         19
                                                                                             as
                                                                                             libc::c_int
...
unsafe extern "C" fn __bfdec_div(mut r: *mut bfdec_t, mut a: *const bfdec_t,
    ...
    if prec ==
                                                                                      ...
                                                                                      libc::c_ulong)
       {
        ...
        precl =
            prec.wrapping_add(2 as libc::c_int as
                                  libc::c_ulong).wrapping_add(19 as
                                                                  libc::c_int
                                                                  as
                                                                  libc::c_ulong).wrapping_sub(1
                                                                                                  as
    ...
    if !taba.is_null() {
        ...
        if !(bfdec_resize(r,
            ...
            if !(mp_div_dec((*r).ctx, (*r).tab, taba, na as mp_size_t,
                ...
                (*r).expn =
                    (*a).expn - (*b).expn + 19 as libc::c_int as libc::c_long;
                (*r).sign = r_sign;
                ret = bfdec_normalize_and_round(r, prec, flags);
                return ret
            }
    ...
    if r != a as *mut bfdec_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 63],
                                                &[libc::c_char; 63]>(b"int bfdec_sqrt(bfdec_t *, const bfdec_t *, limb_t, bf_flags_t)\x00")).as_ptr());
    }
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        if (*a).expn == 9223372036854775807 as libc::c_long {
            bfdec_set_nan(r);
                                                                                                 ...
                                                                                                 libc::c_ulong)
     {
        ...
        if flags & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint !=
            ...
            prec1 =
                bf_max((floor_div((*a).expn +
                            ...
                            libc::c_ulong).wrapping_add(prec) as slimb_t,
                       1 as libc::c_int as slimb_t)
        ...
        n =
            (2 as libc::c_int as libc::c_long *
                 (prec1 + 2 as libc::c_int as libc::c_long) +
        ...
        if bfdec_resize(r, n as limb_t) != 0 {
           ...
           because mp_sqrtrem2_dec already does it */
                ...
                if n > 1 as libc::c_int as libc::c_long {
                    v =
                        *a1.offset((2 as libc::c_int as libc::c_long * n -
                                        1 as libc::c_int as libc::c_long) as
                                       isize);
                    while v <
                              (10000000000000000000 as
                                   libc::c_ulong).wrapping_div(4 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_ulong)
                          {
    ...
    if (*a).expn >=
        ...
        v =
            fast_shr_dec(*(*a).tab.offset((*a).len.wrapping_sub(1 as
                                                                    ...
                                                                    libc::c_ulong)
                                              as isize),
                         (19 as libc::c_int as libc::c_long - (*a).expn) as
 ...
 -> libc::c_int {
    ...
    if r != a as *mut bfdec_t {
        ...
        __assert_fail(b"r != a\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 53],
                                                &[libc::c_char; 53]>(b"int bfdec_pow_ui(bfdec_t *, const bfdec_t *, limb_t)\x00")).as_ptr());
    }
    if b == 0 as libc::c_int as libc::c_ulong {
...
unsafe extern "C" fn add_mod(mut a: limb_t, mut b: limb_t, mut m: limb_t)
 -> limb_t {
    let mut r: limb_t = 0;
    r = a.wrapping_add(b);
    if r >= m { r = (r as libc::c_ulong).wrapping_sub(m) as limb_t as limb_t }
    return r;
}
...
unsafe extern "C" fn sub_mod(mut a: limb_t, mut b: limb_t, mut m: limb_t)
 -> limb_t {
    let mut r: limb_t = 0;
    r = a.wrapping_sub(b);
    if r > a { r = (r as libc::c_ulong).wrapping_add(m) as limb_t as limb_t }
    return r;
}
...
unsafe extern "C" fn init_mul_mod_fast(mut m: limb_t) -> limb_t {
    ...
    if m < (1 as libc::c_int as limb_t) << 62 as libc::c_int {
        ...
        __assert_fail(b"m < (limb_t)1 << NTT_MOD_LOG2_MAX\x00" as *const u8 as
                          *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
                      7421 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 33],
                                                &[libc::c_char; 33]>(b"limb_t init_mul_mod_fast(limb_t)\x00")).as_ptr());
    }
    if m >= (1 as libc::c_int as limb_t) << 61 as libc::c_int {
    } else {
        __assert_fail(b"m >= (limb_t)1 << NTT_MOD_LOG2_MIN\x00" as *const u8
                          as *const libc::c_char,
                      b"libbf.c\x00" as *const u8 as *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    while nb_blocks != 2 as libc::c_int as libc::c_ulong {
        ...
        while i < nb_blocks {
            ...
            k =
                (k as libc::c_ulong).wrapping_add(fft_per_block) as limb_t as
                    limb_t;
            p =
                (p as
                     libc::c_ulong).wrapping_add((2 as libc::c_int as
                                                      libc::c_ulong).wrapping_mul(fft_per_block))
                    as limb_t as limb_t;
            i = i.wrapping_add(1)
        }
...
unsafe extern "C" fn get_trig(mut s: *mut BFNTTState, mut k: libc::c_int,
    ...
    tab =
        ntt_malloc(s,
                   (::std::mem::size_of::<NTTLimb>() as
                        libc::c_ulong).wrapping_mul(n2).wrapping_mul(2 as
                                                                         libc::c_int
                                                                         as
                                                                         libc::c_ulong))
            as *mut NTTLimb;
    ...
    i = 0 as libc::c_int as limb_t;
    while i < n2 {
        *tab.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(i) as
                        isize) = int_to_ntt_limb(c as slimb_t, m);
        *tab.offset((2 as libc::c_int as
                         libc::c_ulong).wrapping_mul(i).wrapping_add(1 as
                                                                         libc::c_int
                                                                         as
                                                                         libc::c_ulong)
...
unsafe extern "C" fn ntt_fft_partial(mut s: *mut BFNTTState,
    ...
    buf3 =
        ntt_malloc(s,
                   (::std::mem::size_of::<NTTLimb>() as
                        libc::c_ulong).wrapping_mul(n1)) as *mut NTTLimb;
    if !buf3.is_null() {
        if k2 == 0 as libc::c_int {
            ...
            buf2 =
                ntt_malloc(s,
                           (::std::mem::size_of::<NTTLimb>() as
                                libc::c_ulong).wrapping_mul(n1).wrapping_mul(strip_len))
                    as *mut NTTLimb;
            if buf2.is_null() {
                current_block = 7202299292956205343;
            } else {
                ...
                's_71:
                    loop  {
                        ...
                        j =
                            (j as libc::c_ulong).wrapping_add(strip_len) as
                                limb_t as limb_t
                    }
                match current_block {
                    7202299292956205343 => { }
...
unsafe extern "C" fn limb_to_ntt(mut s: *mut BFNTTState,
    ...
    memset(tabr as *mut libc::c_void, 0 as libc::c_int,
           (::std::mem::size_of::<NTTLimb>() as
                libc::c_ulong).wrapping_mul(fft_len).wrapping_mul(nb_mods as
                                                                      libc::c_ulong));
    ...
    n =
        bf_min(fft_len as slimb_t,
               a_len.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as
                                      libc::c_ulong).wrapping_add(dpl as
                                                                      libc::c_ulong).wrapping_sub(1
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_ulong).wrapping_div(dpl
                                                                                                                                      as
                                                                                                                                      libc::c_ulong)
                   as slimb_t);
    i = 0 as libc::c_int as slimb_t;
    while i < n {
        ...
        while j < nb_mods {
            ...
            *tabr.offset((i as
                              libc::c_ulong).wrapping_add((j as
                                                               libc::c_ulong).wrapping_mul(fft_len))
...
unsafe extern "C" fn ntt_to_limb(mut s: *mut BFNTTState,
    ...
    memset(tabr as *mut libc::c_void, 0 as libc::c_int,
           (::std::mem::size_of::<limb_t>() as
                libc::c_ulong).wrapping_mul(r_len));
        ...
        while j < nb_mods {
            y[j as usize] =
                ntt_limb_to_int(*buf.offset((i as
                                                 libc::c_ulong).wrapping_add(fft_len.wrapping_mul(j
                                                                                                      as
                                                                                                      libc::c_ulong))
                                                as isize),
            ...
            if n_bits <= int_bits {
                cost =
                    (((fft_len_log2 + 1 as libc::c_int) as limb_t) <<
                         fft_len_log2).wrapping_mul(nb_mods as libc::c_ulong);
...
unsafe extern "C" fn fft_mul(mut s1: *mut bf_context_t, mut res: *mut bf_t,
    ...
    buf1 =
        ntt_malloc(s,
                   (::std::mem::size_of::<NTTLimb>() as
                        libc::c_ulong).wrapping_mul(fft_len as
                                                        libc::c_ulong).wrapping_mul(nb_mods
                                                                                        as
                                                                                        libc::c_ulong))
            as *mut NTTLimb;
    ...
    match current_block {
        7245201122033322888 => {
            ...
            loop  {
                ...
                if ntt_conv(s,
                            buf1.offset((fft_len * j as libc::c_long) as
