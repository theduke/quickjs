...
pub type ZivFunc = unsafe extern "C" fn(
    _: *mut bf_t,
    _: *const bf_t,
    _: limb_t,
    _: *mut libc::c_void,
...
pub unsafe extern "C" fn bf_get_exp_bits(mut flags: bf_flags_t) -> libc::c_int {
    ...
    if e == 0x3f as libc::c_int {
        return ((1 as libc::c_int) << 6 as libc::c_int) - 3 as libc::c_int + 1 as libc::c_int;
    } else {
...
#[inline]
unsafe extern "C" fn bf_malloc(mut s: *mut bf_context_t, mut size: size_t) -> *mut libc::c_void {
...
unsafe extern "C" fn ceil_log2(mut a: limb_t) -> libc::c_int {
    if a <= 1 as libc::c_int as libc::c_ulong {
        return 0 as libc::c_int;
    } else {
        return ((1 as libc::c_int) << 6 as libc::c_int)
            - clz(a.wrapping_sub(1 as libc::c_int as libc::c_ulong));
    };
}
/* b must be >= 1 */
#[inline]
unsafe extern "C" fn ceil_div(mut a: slimb_t, mut b: slimb_t) -> slimb_t {
    if a >= 0 as libc::c_int as libc::c_long {
        return (a + b - 1 as libc::c_int as libc::c_long) / b;
    } else {
        return a / b;
    };
}
...
unsafe extern "C" fn sat_add(mut a: slimb_t, mut b: slimb_t) -> slimb_t {
    ...
    r = a + b;
    /* overflow ? */
    if (a ^ r) & (b ^ r) < 0 as libc::c_int as libc::c_long {
        r = ((a >> ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as libc::c_ulong
            ^ ((1 as libc::c_int as limb_t)
                << ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)) as slimb_t
    }
    return r;
}
#[no_mangle]
...
pub unsafe extern "C" fn bf_init(mut s: *mut bf_context_t, mut r: *mut bf_t) {
    ...
    (*r).expn = -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long;
    (*r).len = 0 as libc::c_int as limb_t;
    (*r).tab = 0 as *mut limb_t;
}
/* return 0 if OK, -1 if alloc error */
#[no_mangle]
pub unsafe extern "C" fn bf_resize(mut r: *mut bf_t, mut len: limb_t) -> libc::c_int {
    let mut tab: *mut limb_t = 0 as *mut limb_t;
    if len != (*r).len {
        tab = bf_realloc(
            (*r).ctx,
            (*r).tab as *mut libc::c_void,
            len.wrapping_mul(::std::mem::size_of::<limb_t>() as libc::c_ulong),
        ) as *mut limb_t;
        if tab.is_null() && len != 0 as libc::c_int as libc::c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn bf_set_ui(mut r: *mut bf_t, mut a: uint64_t) -> libc::c_int {
    (*r).sign = 0 as libc::c_int;
    if a == 0 as libc::c_int as libc::c_ulong {
        (*r).expn = -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long;
    ...
    /* cannot fail */
        ...
        if bf_resize(r, 1 as libc::c_int as limb_t) != 0 {
            ...
            *(*r).tab.offset(0 as libc::c_int as isize) = a << shift;
            (*r).expn = (((1 as libc::c_int) << 6 as libc::c_int) - shift) as slimb_t
        }
    }
    return 0 as libc::c_int;
}
/* return 0 or BF_ST_MEM_ERROR */
#[no_mangle]
pub unsafe extern "C" fn bf_set_si(mut r: *mut bf_t, mut a: int64_t) -> libc::c_int {
...
pub unsafe extern "C" fn bf_set_nan(mut r: *mut bf_t) {
    bf_resize(r, 0 as libc::c_int as limb_t);
    (*r).expn = 9223372036854775807 as libc::c_long;
    (*r).sign = 0 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn bf_set_zero(mut r: *mut bf_t, mut is_neg: libc::c_int) {
    bf_resize(r, 0 as libc::c_int as limb_t);
    (*r).expn = -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long;
    (*r).sign = is_neg;
}
#[no_mangle]
pub unsafe extern "C" fn bf_set_inf(mut r: *mut bf_t, mut is_neg: libc::c_int) {
    bf_resize(r, 0 as libc::c_int as limb_t);
    (*r).expn = 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long;
    (*r).sign = is_neg;
}
/* return 0 or BF_ST_MEM_ERROR */
#[no_mangle]
pub unsafe extern "C" fn bf_set(mut r: *mut bf_t, mut a: *const bf_t) -> libc::c_int {
    if r == a as *mut bf_t {
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn get_bits(mut tab: *const limb_t, mut len: limb_t, mut pos: slimb_t) -> limb_t {
    ...
    p = (pos & (((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as libc::c_long)
        as libc::c_int;
    if i < len {
        a0 = *tab.offset(i as isize)
    } else {
        a0 = 0 as libc::c_int as limb_t
    }
...
unsafe extern "C" fn get_bit(mut tab: *const limb_t, mut len: limb_t, mut pos: slimb_t) -> limb_t {
    ...
    if i < 0 as libc::c_int as libc::c_long || i as libc::c_ulong >= len {
        return 0 as libc::c_int as limb_t;
    }
    return *tab.offset(i as isize)
        >> (pos & (((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as libc::c_long)
        & 1 as libc::c_int as libc::c_ulong;
}
#[inline]
unsafe extern "C" fn limb_mask(mut start: libc::c_int, mut last: libc::c_int) -> limb_t {
    let mut v: limb_t = 0;
    ...
    if n == (1 as libc::c_int) << 6 as libc::c_int {
        ...
        v = ((1 as libc::c_int as limb_t) << n).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            << start
    }
    return v;
}
unsafe extern "C" fn mp_scan_nz(mut tab: *const limb_t, mut n: mp_size_t) -> limb_t {
    ...
    while i < n {
        if *tab.offset(i as isize) != 0 as libc::c_int as libc::c_ulong {
...
unsafe extern "C" fn scan_bit_nz(mut r: *const bf_t, mut bit_pos: slimb_t) -> limb_t {
    ...
    v = *(*r).tab.offset(pos as isize)
        & limb_mask(
            0 as libc::c_int,
            (bit_pos
                & (((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as libc::c_long)
                as libc::c_int,
        );
    ...
    while pos >= 0 as libc::c_int as libc::c_long {
        if *(*r).tab.offset(pos as isize) != 0 as libc::c_int as libc::c_ulong {
            return 1 as libc::c_int as limb_t;
        }
        pos -= 1
    }
...
unsafe extern "C" fn bf_get_rnd_add(
    ...
    /* faithful rounding does not honor the INEXACT flag */
        ...
        bit0 = scan_bit_nz(
            r,
            l.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                .wrapping_sub(bf_max(
                    0 as libc::c_int as slimb_t,
                    prec + 1 as libc::c_int as libc::c_long,
                ) as libc::c_ulong) as slimb_t,
        )
    }
    /* get the bit at 'prec' */
    bit1 = get_bit(
        ...
        l.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_sub(prec as libc::c_ulong) as slimb_t,
    );
    inexact = (bit1 | bit0 != 0 as libc::c_int as libc::c_ulong) as libc::c_int;
    ...
    match rnd_mode {
                ...
                if bit0 != 0 {
                    ...
                    add_one = get_bit(
                        ...
                        l.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                            .wrapping_sub(
                                (prec - 1 as libc::c_int as libc::c_long) as libc::c_ulong,
                            ) as slimb_t,
                    ) as libc::c_int
                }
            }
        ...
        2 | 3 => {
            if (*r).sign == (rnd_mode == BF_RNDD as libc::c_int) as libc::c_int {
                add_one = inexact
            }
        }
        5 => add_one = inexact,
    ...
    if inexact != 0 {
        *pret |= (1 as libc::c_int) << 4 as libc::c_int
    }
    return add_one;
}
unsafe extern "C" fn bf_set_overflow(
    ...
    if prec
        == ((1 as libc::c_int as limb_t)
            << ((1 as libc::c_int) << 6 as libc::c_int) - 2 as libc::c_int)
        ...
        || rnd_mode == BF_RNDU as libc::c_int && sign == 0 as libc::c_int
    {
        ...
        l = prec
            ...
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
            as slimb_t;
        if bf_resize(r, l as limb_t) != 0 {
            bf_set_nan(r);
            return (1 as libc::c_int) << 5 as libc::c_int;
        }
        *(*r).tab.offset(0 as libc::c_int as isize) = limb_mask(
            (prec.wrapping_neg()
        ...
        e_max =
            ((1 as libc::c_int as limb_t) << bf_get_exp_bits(flags) - 1 as libc::c_int) as slimb_t;
        (*r).expn = e_max;
        (*r).sign = sign
    }
    return (1 as libc::c_int) << 2 as libc::c_int | (1 as libc::c_int) << 4 as libc::c_int;
}
...
unsafe extern "C" fn __bf_round(
    ...
    e_range =
        ((1 as libc::c_int as limb_t) << bf_get_exp_bits(flags) - 1 as libc::c_int) as slimb_t;
    e_min = -e_range + 3 as libc::c_int as libc::c_long;
    e_max = e_range;
    if flags & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint != 0 {
        ...
        if prec1
            != ((1 as libc::c_int as limb_t)
                ...
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
        {
            prec = ((*r).expn as libc::c_ulong).wrapping_add(prec1) as slimb_t
        } else {
            prec = prec1 as slimb_t
        }
    } else if ((*r).expn < e_min) as libc::c_int as libc::c_long != 0
        && flags & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint != 0
    {
    ...
    /* round to prec bits */
    rnd_mode = (flags & 0x7 as libc::c_int as libc::c_uint) as libc::c_int; /* cannot fail */
    ...
    if prec <= 0 as libc::c_int as libc::c_long {
        if add_one != 0 {
            ...
            *(*r).tab.offset(0 as libc::c_int as isize) = (1 as libc::c_int as limb_t)
                << ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int;
            (*r).expn += 1 as libc::c_int as libc::c_long - prec;
            ret |= (1 as libc::c_int) << 3 as libc::c_int | (1 as libc::c_int) << 4 as libc::c_int;
            return ret;
        }
    } else {
        if add_one != 0 {
            ...
            bit_pos = l
                ...
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                .wrapping_sub((prec - 1 as libc::c_int as libc::c_long) as libc::c_ulong)
                as slimb_t;
            pos = bit_pos >> 6 as libc::c_int;
            carry = (1 as libc::c_int as limb_t)
                << (bit_pos
                    & (((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int)
                        as libc::c_long);
            i = pos;
            while (i as libc::c_ulong) < l {
            ...
            if carry != 0 {
                ...
                v = 1 as libc::c_int as limb_t;
                i = l.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
                while i >= pos {
                    a = *(*r).tab.offset(i as isize);
                    *(*r).tab.offset(i as isize) = a >> 1 as libc::c_int
                        | v << ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int;
                    v = a;
                    i -= 1
                }
                (*r).expn += 1
        ...
        match current_block {
            ...
            _ => {
                ...
                while *(*r).tab.offset(i as isize) == 0 as libc::c_int as libc::c_ulong {
                    i += 1
                } /* cannot fail */
                if i > 0 as libc::c_int as libc::c_long {
...
pub unsafe extern "C" fn bf_normalize_and_round(
    ...
    if l == 0 as libc::c_int as libc::c_ulong {
        /* zero */
        (*r).expn = -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long; /* cannot fail */
        bf_resize(r, 0 as libc::c_int as limb_t);
        ret = 0 as libc::c_int
    } else {
        (*r).expn = ((*r).expn as libc::c_ulong).wrapping_sub(
            (*r).len
                .wrapping_sub(l)
                .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong),
        ...
        if shift != 0 as libc::c_int {
            ...
            while (i as libc::c_ulong) < l {
                ...
                *(*r).tab.offset(i as isize) =
                    a << shift | v >> ((1 as libc::c_int) << 6 as libc::c_int) - shift;
                v = a;
                i += 1
            }
            (*r).expn -= shift as libc::c_long
        }
...
pub unsafe extern "C" fn bf_can_round(
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        || (*a).expn == 9223372036854775807 as libc::c_long
    {
        return FALSE as libc::c_int;
    }
    if rnd_mode as libc::c_uint == BF_RNDF as libc::c_int as libc::c_uint {
        return (k >= prec + 1 as libc::c_int as libc::c_long) as libc::c_int;
    }
    if (*a).expn == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long {
        return FALSE as libc::c_int;
    }
    is_rndn = (rnd_mode as libc::c_uint == BF_RNDN as libc::c_int as libc::c_uint
        || rnd_mode as libc::c_uint == BF_RNDNA as libc::c_int as libc::c_uint)
        as libc::c_int;
    if k < prec + 2 as libc::c_int as libc::c_long {
        return FALSE as libc::c_int;
    }
    bit_pos = (*a)
        .len
...
pub unsafe extern "C" fn mp_print_str(
    ...
    i = n.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
    while i >= 0 as libc::c_int as libc::c_long {
        if i as libc::c_ulong != n.wrapping_sub(1 as libc::c_int as libc::c_ulong) {
            printf(b"_\x00" as *const u8 as *const libc::c_char);
        }
        printf(
            b"%016lx\x00" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn bf_print_str(mut str: *const libc::c_char, mut a: *const bf_t) {
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long {
            ...
            == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        {
            ...
            i = (*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
            while i >= 0 as libc::c_int as libc::c_long {
                printf(
                    b"%016lx\x00" as *const u8 as *const libc::c_char,
            ...
            printf(b"p%ld\x00" as *const u8 as *const libc::c_char, (*a).expn);
        }
    }
    printf(b"\n\x00" as *const u8 as *const libc::c_char);
}
...
#[no_mangle]
pub unsafe extern "C" fn bf_cmpu(mut a: *const bf_t, mut b: *const bf_t) -> libc::c_int {
    let mut i: slimb_t = 0;
    ...
    i = len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
    while i >= 0 as libc::c_int as libc::c_long {
        v1 = get_limbz(
            a,
            (*a).len.wrapping_sub(len).wrapping_add(i as libc::c_ulong),
        );
        v2 = get_limbz(
            b,
            (*b).len.wrapping_sub(len).wrapping_add(i as libc::c_ulong),
        );
        if v1 != v2 {
            if v1 < v2 {
                return -(1 as libc::c_int);
...
#[no_mangle]
pub unsafe extern "C" fn bf_cmp_full(mut a: *const bf_t, mut b: *const bf_t) -> libc::c_int {
    let mut res: libc::c_int = 0;
    if (*a).expn == 9223372036854775807 as libc::c_long
        || (*b).expn == 9223372036854775807 as libc::c_long
    {
        if (*a).expn == (*b).expn {
            res = 0 as libc::c_int
        } else if (*a).expn == 9223372036854775807 as libc::c_long {
            res = 1 as libc::c_int
        } else {
            res = -(1 as libc::c_int)
        }
...
-0 == +0 */
#[no_mangle]
pub unsafe extern "C" fn bf_cmp(mut a: *const bf_t, mut b: *const bf_t) -> libc::c_int {
    let mut res: libc::c_int = 0;
    if (*a).expn == 9223372036854775807 as libc::c_long
        || (*b).expn == 9223372036854775807 as libc::c_long
    {
...
unsafe extern "C" fn count_cancelled_bits(mut a: *const bf_t, mut b: *const bf_t) -> limb_t {
    ...
    b_offset = (*b)
        ...
        .wrapping_add((*a).expn as libc::c_ulong)
        .wrapping_sub((*b).expn as libc::c_ulong) as slimb_t;
    ...
    /* first search the equals bits */
    {
        ...
        n += ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long;
        bit_offset -= ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long
    }
    ...
    if p > 0 as libc::c_int {
        ...
        p1 = (bf_min(clz(v1 & mask) as slimb_t, clz(!v2 & mask) as slimb_t)
            - (((1 as libc::c_int) << 6 as libc::c_int) - p) as libc::c_long)
            as libc::c_int;
        n += p1 as libc::c_long;
        if p1 != p {
    ...
    match current_block {
        5948590327928692120 => {
            ...
            loop {
                ...
                v2 = get_bits((*b).tab, (*b).len, bit_offset + b_offset);
                //        printf("v1=" FMT_LIMB " v2=" FMT_LIMB "\n", v1, v2);
                if v1 != 0 as libc::c_int as libc::c_ulong
                    || v2 != -(1 as libc::c_int) as libc::c_ulong
                {
                    /* different: count the matching bits */
                    p1 = bf_min(clz(v1) as slimb_t, clz(!v2) as slimb_t) as libc::c_int;
                    n += p1 as libc::c_long;
                    break;
                } else {
                    n += ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long;
...
unsafe extern "C" fn bf_add_internal(
    ...
    if cmp_res == 0 as libc::c_int
        && is_sub != 0
        && (*a).expn < 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
    {
        /* zero result */
        bf_set_zero(
            r,
            (flags & 0x7 as libc::c_int as libc::c_uint == BF_RNDD as libc::c_int as libc::c_uint)
                as libc::c_int,
        );
        ret = 0 as libc::c_int
    } else {
            ...
            || (*b).len == 0 as libc::c_int as libc::c_ulong
        {
            ...
            subtraction */
            if is_sub != 0 {
                if d <= 1 as libc::c_int as libc::c_long {
                    cancelled_bits = count_cancelled_bits(a, b) as slimb_t
                } else {
                    cancelled_bits = 1 as libc::c_int as slimb_t
                }
            } else {
                cancelled_bits = 0 as libc::c_int as slimb_t
            }
            /* add two extra bits for rounding */
            precl = (cancelled_bits as libc::c_ulong)
                .wrapping_add(prec)
            ...
            tot_len = bf_max(
                (*a).len as slimb_t,
                (*b).len.wrapping_add(
                    ((d + ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long
                        - 1 as libc::c_int as libc::c_long)
                        / ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long)
                        as libc::c_ulong,
                ) as slimb_t,
            ) as limb_t;
            ...
            if bf_resize(r, r_len) != 0 {
                ...
                b_bit_offset = (*b)
                    ...
                    .wrapping_sub(r_len)
                    .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_add(d as libc::c_ulong) as slimb_t;
                ...
                while i < 0 as libc::c_int as libc::c_long {
                    ...
                    ap = a_offset + i;
                    bp =
                        b_bit_offset + i * ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long;
                    inflag = FALSE as libc::c_int;
                    if ap >= 0 as libc::c_int as libc::c_long && (ap as libc::c_ulong) < (*a).len {
                        v1 = *(*a).tab.offset(ap as isize);
                        inflag = TRUE as libc::c_int
                    } else {
                        v1 = 0 as libc::c_int as limb_t
                    }
                    if bp + ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long
                    ...
                    if inflag == 0 {
                        ...
                        i = 0 as libc::c_int as slimb_t;
                        if ap < 0 as libc::c_int as libc::c_long {
                            i = bf_min(i, -a_offset)
                        }
                    ...
                    u = (u as libc::c_ulong).wrapping_add(carry) as limb_t as limb_t;
                    carry = (u < carry) as libc::c_int as libc::c_ulong | carry1;
                    z |= u
                }
                /* and the result */
                i = 0 as libc::c_int as slimb_t;
                while (i as libc::c_ulong) < r_len {
                ...
                let ref mut fresh1 = *(*r).tab.offset(0 as libc::c_int as isize);
                *fresh1 |= (z != 0 as libc::c_int as libc::c_ulong) as libc::c_int as libc::c_ulong;
                /* carry is only possible in add case */
                if is_sub == 0 && carry != 0 {
                    if bf_resize(r, r_len.wrapping_add(1 as libc::c_int as libc::c_ulong)) != 0 {
                        current_block = 17777247491025708018;
                    } else {
                        *(*r).tab.offset(r_len as isize) = 1 as libc::c_int as limb_t;
                        (*r).expn += ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long;
                        current_block = 6887627722379705880;
                    }
                } else {
                    current_block = 6887627722379705880;
...
pub unsafe extern "C" fn mp_add(
    ...
    while (i as libc::c_ulong) < n {
        ...
        a = a.wrapping_add(k);
        k = (a < k) as libc::c_int as libc::c_ulong | k1;
...
pub unsafe extern "C" fn mp_sub(
    ...
    while (i as libc::c_long) < n {
        ...
        k1 = (a > v) as libc::c_int as limb_t;
        v = a.wrapping_sub(k);
        k = (v > a) as libc::c_int as libc::c_ulong | k1;
...
unsafe extern "C" fn mp_shr(
    ...
    while i >= 0 as libc::c_int as libc::c_long {
        ...
        *tab_r.offset(i as isize) =
            a >> shift | l << ((1 as libc::c_int) << 6 as libc::c_int) - shift;
        l = a;
        i -= 1
    }
    return l
        & ((1 as libc::c_int as limb_t) << shift).wrapping_sub(1 as libc::c_int as libc::c_ulong);
}
...
pub unsafe extern "C" fn mp_mul(
    ...
    if (bf_min(op1_size as slimb_t, op2_size as slimb_t) >= 100 as libc::c_int as libc::c_long)
...
unsafe extern "C" fn mp_sub_mul1(
    ...
    while i < n {
        ...
        *tabr.offset(i as isize) = t as limb_t;
        l = (t >> ((1 as libc::c_int) << 6 as libc::c_int)).wrapping_neg() as limb_t;
        i = i.wrapping_add(1)
    }
    return l;
}
...
unsafe extern "C" fn udiv1norm_init(mut d: limb_t) -> limb_t {
    ...
    return ((a1 as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int) | a0 as u128)
        .wrapping_div(d as u128) as limb_t;
}
...
unsafe extern "C" fn udiv1norm(
    ...
    let mut ah: limb_t = 0;
    let mut a: dlimb_t = 0;
    n1m = (a0 as slimb_t >> ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as limb_t;
    n_adj = a0.wrapping_add(n1m & d);
    a = (d_inv as dlimb_t)
        .wrapping_mul(a1.wrapping_sub(n1m) as u128)
        .wrapping_add(n_adj as u128);
    q = (a >> ((1 as libc::c_int) << 6 as libc::c_int)).wrapping_add(a1 as u128) as limb_t;
    /* compute a - q * r and update q so that the remainder is\
    between 0 and d - 1 */
    a = (a1 as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int) | a0 as u128;
    a = a
        .wrapping_sub((q as dlimb_t).wrapping_mul(d as u128))
        .wrapping_sub(d as u128);
    ah = (a >> ((1 as libc::c_int) << 6 as libc::c_int)) as limb_t;
    q = (q as libc::c_ulong).wrapping_add((1 as libc::c_int as libc::c_ulong).wrapping_add(ah))
        as limb_t as limb_t;
...
unsafe extern "C" fn mp_div1norm(
    ...
    if n >= 3 as libc::c_int as libc::c_ulong {
        ...
        i = n.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
        while i >= 0 as libc::c_int as libc::c_long {
            a1 = (r as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int)
...
unsafe extern "C" fn mp_divnorm(
    ...
    let mut i: slimb_t = 0;
    let mut j: slimb_t = 0;
    b1 = *tabb.offset(nb.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize);
    if nb == 1 as libc::c_int as libc::c_ulong {
        *taba.offset(0 as libc::c_int as isize) =
            mp_div1norm(tabq, taba, na, b1, 0 as libc::c_int as limb_t);
        return 0 as libc::c_int;
    }
    n = na.wrapping_sub(nb);
    if bf_min(n as slimb_t, nb as slimb_t) >= 50 as libc::c_int as libc::c_long {
        return mp_divnorm_large(s, tabq, taba, na, tabb, nb);
    }
    if n >= 3 as libc::c_int as libc::c_ulong {
        b1_inv = udiv1norm_init(b1)
    } else {
        b1_inv = 0 as libc::c_int as limb_t
    }
    /* first iteration: the quotient is only 0 or 1 */
    q = 1 as libc::c_int as limb_t;
    j = nb.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
    while j >= 0 as libc::c_int as libc::c_long {
        if *taba.offset(n.wrapping_add(j as libc::c_ulong) as isize) != *tabb.offset(j as isize) {
            if *taba.offset(n.wrapping_add(j as libc::c_ulong) as isize) < *tabb.offset(j as isize)
            {
    ...
    *tabq.offset(n as isize) = q;
    ...
    i = n.wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
    while i >= 0 as libc::c_int as libc::c_long {
        if (*taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize) >= b1) as libc::c_int
            as libc::c_long
            != 0
        {
            q = -(1 as libc::c_int) as limb_t
            ...
            q = udiv1norm(
                &mut dummy_r,
                *taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize),
                *taba.offset(
                    (i as libc::c_ulong)
                        .wrapping_add(nb)
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            ...
            al = (*taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize) as dlimb_t)
        ...
        v = *taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize);
        a = v.wrapping_sub(r);
        c = (a > v) as libc::c_int as limb_t;
        *taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize) = a;
        if c != 0 as libc::c_int as libc::c_ulong {
            ...
            /* negative result */
            {
                ...
                let ref mut fresh2 = *taba.offset((i as libc::c_ulong).wrapping_add(nb) as isize);
...
pub unsafe extern "C" fn mp_recip(
    ...
    if n <= 2 as libc::c_int as libc::c_ulong {
        ...
        tabu = bf_malloc(
            s,
            (::std::mem::size_of::<limb_t>() as libc::c_ulong).wrapping_mul(
        ...
        tabt = bf_malloc(
            ...
            (::std::mem::size_of::<limb_t>() as libc::c_ulong)
                .wrapping_mul(n.wrapping_add(2 as libc::c_int as libc::c_ulong)),
        ) as *mut limb_t;
        if tabt.is_null() || tabu.is_null() {
            current_block = 14207563356106830746;
        } else {
            i = 0 as libc::c_int as mp_size_t;
            while (i as libc::c_ulong) < (2 as libc::c_int as libc::c_ulong).wrapping_mul(n) {
                *tabu.offset(i as isize) = 0 as libc::c_int as limb_t;
                i += 1
            }
            *tabu.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(n) as isize) =
                1 as libc::c_int as limb_t;
            if mp_divnorm(
                s,
                tabt,
            ...
            ) != 0
            {
                ...
                i = 0 as libc::c_int as mp_size_t;
                while (i as libc::c_ulong) < n.wrapping_add(1 as libc::c_int as libc::c_ulong) {
                    *tabr.offset(i as isize) = *tabt.offset(i as isize);
                    i += 1
                }
                if mp_scan_nz(tabu, n as mp_size_t) == 0 as libc::c_int as libc::c_ulong {
                    /* only happens for a=B^n/2 */
                    mp_sub_ui(
                        tabr,
                        1 as libc::c_int as limb_t,
                        n.wrapping_add(1 as libc::c_int as libc::c_ulong) as mp_size_t,
                    );
                }
        ...
        l = n
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(2 as libc::c_int as libc::c_ulong) as mp_size_t;
        h = n.wrapping_sub(l as libc::c_ulong) as mp_size_t;
        ...
        */
        tabt = bf_malloc(
            s,
            (::std::mem::size_of::<limb_t>() as libc::c_ulong).wrapping_mul(
                n.wrapping_add(h as libc::c_ulong)
                    .wrapping_add(1 as libc::c_int as libc::c_ulong),
            ),
        ) as *mut limb_t;
        tabu = bf_malloc(
            s,
            (::std::mem::size_of::<limb_t>() as libc::c_ulong).wrapping_mul(
                n.wrapping_add((2 as libc::c_int as libc::c_long * h) as libc::c_ulong)
        ...
        if tabt.is_null() || tabu.is_null() {
            ...
            ) != 0
            {
                ...
                while *tabt.offset(n.wrapping_add(h as libc::c_ulong) as isize)
                    != 0 as libc::c_int as libc::c_ulong
                {
                    mp_sub_ui(
                        tabxh,
                    ...
                    c = mp_sub(tabt, tabt, taba, n as mp_size_t, 0 as libc::c_int as limb_t);
                    mp_sub_ui(
                        tabt.offset(n as isize),
                        c,
                        h + 1 as libc::c_int as libc::c_long,
                    );
                }
                ...
                let ref mut fresh3 = *tabt.offset(n.wrapping_add(h as libc::c_ulong) as isize);
                *fresh3 = (*fresh3).wrapping_add(1);
                ...
                ) != 0
                {
                    ...
                    mp_add(
                        ...
                        tabr.offset(l as isize),
                        tabu.offset((2 as libc::c_int as libc::c_long * h) as isize),
                        h as limb_t,
                        0 as libc::c_int as limb_t,
                    );
                    current_block = 6450636197030046351;
            ...
            /* Q=A*B^-1 */
            {
                if !(mp_mul(
                    ...
                    taba.offset(na as isize)
                        .offset(-(n.wrapping_add(1 as libc::c_int as libc::c_ulong) as isize)),
                    n.wrapping_add(1 as libc::c_int as libc::c_ulong),
                ) != 0)
                {
                    i = 0 as libc::c_int as limb_t;
                    while i < nq.wrapping_add(1 as libc::c_int as libc::c_ulong) {
                        *tabq.offset(i as isize) =
                            *tabt.offset(
                                i.wrapping_add((2 as libc::c_int as libc::c_ulong).wrapping_mul(
                                    n.wrapping_add(1 as libc::c_int as libc::c_ulong),
                                ))
                                .wrapping_sub(nq.wrapping_add(1 as libc::c_int as libc::c_ulong))
                                    as isize,
                            );
                        i = i.wrapping_add(1)
                    }
                    ...
                    tabt = bf_malloc(
                        s,
                        (::std::mem::size_of::<limb_t>() as libc::c_ulong)
                            .wrapping_mul(na.wrapping_add(1 as libc::c_int as libc::c_ulong)),
                    ) as *mut limb_t;
                    if !tabt.is_null() {
                        if !(mp_mul(
                            s,
                            tabt,
                            tabq,
                            nq.wrapping_add(1 as libc::c_int as libc::c_ulong),
                            tabb,
                            nb,
                        ) != 0)
                        {
                            ...
                            mp_sub(
                                ...
                                taba,
                                tabt,
                                nb.wrapping_add(1 as libc::c_int as libc::c_ulong) as mp_size_t,
                                0 as libc::c_int as limb_t,
                            );
                            bf_free(s, tabt as *mut libc::c_void);
                            /* the approximated quotient is smaller than than the exact one,
                            hence we may have to increment it */
                            while !(*taba.offset(nb as isize) == 0 as libc::c_int as libc::c_ulong
                                && mp_cmp(taba, tabb, nb as mp_size_t) < 0 as libc::c_int)
                            {
                                let ref mut fresh4 = *taba.offset(nb as isize);
                                *fresh4 = (*fresh4 as libc::c_ulong).wrapping_sub(mp_sub(
                                    taba,
                                    taba,
                                    tabb,
                                    nb as mp_size_t,
...
pub unsafe extern "C" fn bf_mul(
    ...
    if (*b).len == 0 as libc::c_int as libc::c_ulong {
            ...
            || (*b).expn == 9223372036854775807 as libc::c_long
        {
            ...
            == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
            || (*b).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        {
            if (*a).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
                && (*b).expn
                    == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        ...
        a_len = (*a).len;
        b_len = (*b).len;
        if flags & 0x7 as libc::c_int as libc::c_uint == BF_RNDF as libc::c_int as libc::c_uint {
        ...
        if b_len >= 100 as libc::c_int as libc::c_ulong {
...
pub unsafe extern "C" fn bf_mul_2exp(
    ...
    e_max = ((1 as libc::c_int as limb_t)
        << ((1 as libc::c_int) << 6 as libc::c_int) - 3 as libc::c_int + 1 as libc::c_int)
        .wrapping_sub(1 as libc::c_int as libc::c_ulong) as slimb_t;
    e = bf_max(e, -e_max);
    e = bf_min(e, e_max);
    (*r).expn += e;
...
pub unsafe extern "C" fn bf_get_exp_min(mut a: *const bf_t) -> slimb_t {
    ...
    i = 0 as libc::c_int as slimb_t;
    while (i as libc::c_ulong) < (*a).len {
        v = *(*a).tab.offset(i as isize);
        if v != 0 as libc::c_int as libc::c_ulong {
            k = ctz(v);
            return ((*a).expn as libc::c_ulong)
                .wrapping_sub(
                    (*a).len
                        .wrapping_sub(i as libc::c_ulong)
                        .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong),
                )
                .wrapping_add(k as libc::c_ulong) as slimb_t;
        }
        i += 1
    }
...
unsafe extern "C" fn bf_tdivremu(
    ...
    if bf_cmpu(a, b) < 0 as libc::c_int {
        ...
        bf_div(
            ...
            b,
            bf_max(
                (*a).expn - (*b).expn + 1 as libc::c_int as libc::c_long,
                2 as libc::c_int as slimb_t,
            ) as limb_t,
...
unsafe extern "C" fn __bf_div(
    ...
    taba = bf_malloc(
        s,
        na.wrapping_add(1 as libc::c_int as libc::c_ulong)
        ...
        if !(bf_resize(r, n.wrapping_add(1 as libc::c_int as libc::c_ulong)) != 0) {
            if !(mp_divnorm(s, (*r).tab, taba, na, (*b).tab, nb) != 0) {
                ...
                if mp_scan_nz(taba, nb as mp_size_t) != 0 {
                    let ref mut fresh5 = *(*r).tab.offset(0 as libc::c_int as isize);
                    *fresh5 |= 1 as libc::c_int as libc::c_ulong
                }
...
pub unsafe extern "C" fn bf_divrem(
    ...
    is_rndn =
        (rnd_mode == BF_RNDN as libc::c_int || rnd_mode == BF_RNDNA as libc::c_int) as libc::c_int;
    match rnd_mode {
        2 => is_ceil = q_sign,
                        ...
                        && (rnd_mode == BF_RNDNA as libc::c_int
                            || get_bit(
                                ...
                                (*q).len
                                    ...
                                    .wrapping_sub((*q).expn as libc::c_ulong)
                                    as slimb_t,
                            ) != 0)
                {
...
unsafe extern "C" fn mp_sqrtrem1(mut pr: *mut limb_t, mut a: limb_t) -> limb_t {
    ...
    s1 = sqrt_table[(a >> ((1 as libc::c_int) << 6 as libc::c_int) - 8 as libc::c_int)
        .wrapping_sub(64 as libc::c_int as libc::c_ulong) as usize] as limb_t;
    r1 = (a >> ((1 as libc::c_int) << 6 as libc::c_int) - 16 as libc::c_int)
        .wrapping_sub(s1.wrapping_mul(s1));
    if r1 > (2 as libc::c_int as libc::c_ulong).wrapping_mul(s1) {
        r1 = (r1 as libc::c_ulong).wrapping_sub(
            (2 as libc::c_int as libc::c_ulong)
                .wrapping_mul(s1)
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
        ) as limb_t as limb_t;
    ...
    num = r1 << 8 as libc::c_int
        | a >> ((1 as libc::c_int) << 6 as libc::c_int) - 32 as libc::c_int + 8 as libc::c_int
            & 0xff as libc::c_int as libc::c_ulong; /* q <= 2^8 */
    q = num.wrapping_div((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1));
    u = num.wrapping_rem((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1));
    s = (s1 << 8 as libc::c_int).wrapping_add(q);
    r = u << 8 as libc::c_int
        | a >> ((1 as libc::c_int) << 6 as libc::c_int) - 32 as libc::c_int
            & 0xff as libc::c_int as libc::c_ulong;
    r = (r as libc::c_ulong).wrapping_sub(q.wrapping_mul(q)) as limb_t as limb_t;
    if (r as slimb_t) < 0 as libc::c_int as libc::c_long {
        s = s.wrapping_sub(1);
        r = (r as libc::c_ulong).wrapping_add(
            (2 as libc::c_int as libc::c_ulong)
                .wrapping_mul(s)
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
        ) as limb_t as limb_t
    ...
    num = r1 << 16 as libc::c_int
        | a >> ((1 as libc::c_int) << 6 as libc::c_int) - 64 as libc::c_int + 16 as libc::c_int
            & 0xffff as libc::c_int as libc::c_ulong; /* q <= 2^16 */
    q = num.wrapping_div((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1));
    u = num.wrapping_rem((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1));
    s = (s1 << 16 as libc::c_int).wrapping_add(q);
    r = u << 16 as libc::c_int
...
unsafe extern "C" fn mp_sqrtrem2(mut tabs: *mut limb_t, mut taba: *mut limb_t) -> limb_t {
    ...
    q = num.wrapping_div((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1) as u128) as limb_t;
    u = num.wrapping_rem((2 as libc::c_int as libc::c_ulong).wrapping_mul(s1) as u128) as limb_t;
    s = (s1 << l).wrapping_add(q);
    r = (u as dlimb_t) << l
        | (a0 & ((1 as libc::c_int as limb_t) << l).wrapping_sub(1 as libc::c_int as libc::c_ulong))
            as u128;
    if (q >> l != 0 as libc::c_int as libc::c_ulong) as libc::c_int as libc::c_long != 0 {
        r = (r as u128)
            .wrapping_sub((1 as libc::c_int as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int))
        ...
        < 0 as libc::c_int as libc::c_long
    {
        ...
        r = (r as u128).wrapping_add(
            (2 as libc::c_int as u128)
                .wrapping_mul(s as dlimb_t)
                .wrapping_add(1 as libc::c_int as u128),
        ) as dlimb_t as dlimb_t
    }
...
unsafe extern "C" fn mp_sqrtrem_rec(
    ...
    l = n.wrapping_div(2 as libc::c_int as libc::c_ulong);
    h = n.wrapping_sub(l);
    if mp_sqrtrem_rec(
        s,
        tabs.offset(l as isize),
        taba.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(l) as isize),
        h,
        tmp_buf,
        &mut qh,
    ) != 0
    ...
    qh = (qh as libc::c_ulong).wrapping_add(*tmp_buf.offset(l as isize)) as limb_t as limb_t;
    i = 0 as libc::c_int as limb_t;
    while i < l {
    ...
    ql = mp_shr(
        ...
        l as mp_size_t,
        1 as libc::c_int,
        qh & 1 as libc::c_int as libc::c_ulong,
    );
    ...
    if qh != 0 {
        ...
        c = mp_sub(
            ...
            taba,
            taba.offset(n as isize),
            (2 as libc::c_int as libc::c_ulong).wrapping_mul(l) as mp_size_t,
            0 as libc::c_int as limb_t,
        )
    }
    rh = (rh as libc::c_ulong).wrapping_sub(mp_sub_ui(
        taba.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(l) as isize),
        c,
        n.wrapping_sub((2 as libc::c_int as libc::c_ulong).wrapping_mul(l)) as mp_size_t,
    )) as limb_t as limb_t;
    if (rh as slimb_t) < 0 as libc::c_int as libc::c_long {
        mp_sub_ui(tabs, 1 as libc::c_int as limb_t, n as mp_size_t);
        rh = (rh as libc::c_ulong).wrapping_add(mp_add_mul1(
            taba,
            tabs,
            n,
            2 as libc::c_int as limb_t,
        )) as limb_t as limb_t;
        rh = (rh as libc::c_ulong).wrapping_add(mp_add_ui(taba, 1 as libc::c_int as limb_t, n))
            as limb_t as limb_t
    }
    *prh = rh;
    return 0 as libc::c_int;
...
pub unsafe extern "C" fn mp_sqrtrem(
    ...
    n2 = n
        ...
        .wrapping_add(1 as libc::c_int as libc::c_ulong) as mp_size_t;
    if n2 as libc::c_ulong
        <= (::std::mem::size_of::<[limb_t; 8]>() as libc::c_ulong)
            .wrapping_div(::std::mem::size_of::<limb_t>() as libc::c_ulong)
    {
        tmp_buf = tmp_buf1.as_mut_ptr()
    } else {
        tmp_buf = bf_malloc(
            s,
            (::std::mem::size_of::<limb_t>() as libc::c_ulong).wrapping_mul(n2 as libc::c_ulong),
        ) as *mut limb_t;
        if tmp_buf.is_null() {
            return -(1 as libc::c_int);
        }
...
pub unsafe extern "C" fn bf_sqrtrem(
    ...
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        ...
        bf_sqrt(
            r,
            a,
            (((*a).expn + 1 as libc::c_int as libc::c_long) / 2 as libc::c_int as libc::c_long)
                as limb_t,
            BF_RNDZ as libc::c_int as bf_flags_t,
        );
        ...
        if bf_is_nan(rem) != 0 {
            ret = (1 as libc::c_int) << 5 as libc::c_int
        } else if (*rem).len != 0 as libc::c_int as libc::c_ulong {
...
pub unsafe extern "C" fn bf_sqrt(
    ...
    if (*a).len == 0 as libc::c_int as libc::c_ulong {
        ...
        n = (2 as libc::c_int as libc::c_ulong)
            .wrapping_mul(prec.wrapping_add(2 as libc::c_int as libc::c_ulong))
            .wrapping_add(
            ...
            if a1.is_null() {
                ...
                if (*a).expn & 1 as libc::c_int as libc::c_long != 0 {
                    res = mp_shr(
                        a1,
                        a1,
                        2 as libc::c_int as libc::c_long * n,
                        1 as libc::c_int,
                        0 as libc::c_int as limb_t,
                    )
                } else {
                    res = 0 as libc::c_int as limb_t
                }
                if mp_sqrtrem(s, (*r).tab, a1, n as limb_t) != 0 {
                    ...
                    if res == 0 {
                        res = mp_scan_nz(a1, n + 1 as libc::c_int as libc::c_long)
                    }
                    bf_free(s, a1 as *mut libc::c_void);
                    if res == 0 {
                        res = mp_scan_nz(
                            (*a).tab,
                            (*a).len.wrapping_sub(n1 as libc::c_ulong) as mp_size_t,
                        )
                    }
                    if res != 0 as libc::c_int as libc::c_ulong {
                        let ref mut fresh6 = *(*r).tab.offset(0 as libc::c_int as isize);
                        *fresh6 |= 1 as libc::c_int as libc::c_ulong
                    }
                    (*r).sign = 0 as libc::c_int;
                    (*r).expn = (*a).expn + 1 as libc::c_int as libc::c_long >> 1 as libc::c_int;
...
unsafe extern "C" fn bf_pow_ui(
    ...
    while i >= 0 as libc::c_int {
        ...
        if b >> i & 1 as libc::c_int as libc::c_ulong != 0 {
...
unsafe extern "C" fn bf_pow_ui_ui(
    ...
    let mut ret: libc::c_int = 0;
    if a1 == 10 as libc::c_int as libc::c_ulong && b <= 19 as libc::c_int as libc::c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn bf_rint(mut r: *mut bf_t, mut rnd_mode: libc::c_int) -> libc::c_int {
    return bf_round(
        r,
        0 as libc::c_int as limb_t,
        (rnd_mode | (1 as libc::c_int) << 4 as libc::c_int) as bf_flags_t,
    ); /* minus zero is considered as positive */
}
#[inline]
unsafe extern "C" fn bf_logic_op1(mut a: limb_t, mut b: limb_t, mut op: libc::c_int) -> limb_t {
    match op {
        0 => return a | b,
        1 => return a ^ b,
        2 | _ => return a & b,
...
unsafe extern "C" fn bf_logic_op(
    ...
    if (*b1).expn <= 0 as libc::c_int as libc::c_long {
        ...
        12039483399334584727 => {
            ...
            match current_block {
                ...
                _ => {
                    ...
                    if op == 2 as libc::c_int && r_sign == 0 as libc::c_int as libc::c_ulong {
                        /* no need to compute extra zeros for and */
                        if a_sign == 0 as libc::c_int as libc::c_ulong
                            && b_sign == 0 as libc::c_int as libc::c_ulong
                        {
                            l = bf_min((*a).expn, (*b).expn)
                        } else if a_sign == 0 as libc::c_int as libc::c_ulong {
                            l = (*a).expn
                        } else {
                            l = (*b).expn
                        }
                    ...
                    l = (bf_max(l, 1 as libc::c_int as slimb_t)
                        + ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long
                        - 1 as libc::c_int as libc::c_long)
                        / ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long; /* cannot fail */
                    if bf_resize(r, l as limb_t) != 0 {
                        current_block = 12427457426373845059;
                    } else {
                        a_bit_offset = (*a)
                            .len
                            .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                            .wrapping_sub((*a).expn as libc::c_ulong)
                            as slimb_t;
                        b_bit_offset = (*b)
                            .len
                            .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                            .wrapping_sub((*b).expn as libc::c_ulong)
                            as slimb_t;
                        ...
                        while i < l {
                            v1 = get_bits(
                                ...
                                (*a).len,
                                a_bit_offset
                                    + i * ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long,
                            ) ^ v1_mask;
                            v2 = get_bits(
                                (*b).tab,
                                (*b).len,
                        ...
                        (*r).expn = l * ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long;
...
pub unsafe extern "C" fn bf_get_float64(
    ...
    /* quiet nan */
        ...
        if bf_is_finite(b) != 0 {
            ret = bf_round(
                b,
                53 as libc::c_int as limb_t,
                rnd_mode as libc::c_uint
                    | ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint
                    | bf_set_exp_bits(11 as libc::c_int),
            )
        }
        if (*b).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long {
            ...
            == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        {
            ...
            e = ((*b).expn + 1023 as libc::c_int as libc::c_long - 1 as libc::c_int as libc::c_long)
                as libc::c_int;
            ...
            if e <= 0 as libc::c_int {
                ...
                m = m << 1 as libc::c_int >> 12 as libc::c_int
            }
        }
        u.u =
            m | (e as uint64_t) << 52 as libc::c_int | ((*b).sign as uint64_t) << 63 as libc::c_int;
        bf_delete(b);
    }
    *pres = u.d;
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn bf_set_float64(mut a: *mut bf_t, mut d: libc::c_double) -> libc::c_int {
    let mut current_block: u64;
    let mut u: Float64Union = Float64Union { d: 0. };
    let mut m: uint64_t = 0;
    let mut shift: libc::c_int = 0;
    ...
    e = (u.u >> 52 as libc::c_int
        & (((1 as libc::c_int) << 11 as libc::c_int) - 1 as libc::c_int) as libc::c_ulong)
        as libc::c_int;
    m = u.u
    ...
    if e == ((1 as libc::c_int) << 11 as libc::c_int) - 1 as libc::c_int {
        ...
        if e == 0 as libc::c_int {
            ...
            m = m << 11 as libc::c_int | (1 as libc::c_int as uint64_t) << 63 as libc::c_int;
            current_block = 15442955482004205486;
        }
        match current_block {
            9828876828309294594 => {}
            _ => {
                (*a).expn = (e - 1023 as libc::c_int + 1 as libc::c_int) as slimb_t;
...
pub unsafe extern "C" fn bf_get_int32(
    ...
    if (*a).expn >= 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long {
        ...
        if flags & (1 as libc::c_int) << 0 as libc::c_int != 0 {
            ...
            == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        {
            v = (2147483647 as libc::c_int as uint32_t).wrapping_add((*a).sign as libc::c_uint)
        } else {
            v = 2147483647 as libc::c_int as uint32_t
        }
    } else if (*a).expn <= 0 as libc::c_int as libc::c_long {
        v = 0 as libc::c_int as uint32_t;
        ret = 0 as libc::c_int
    } else if (*a).expn <= 31 as libc::c_int as libc::c_long {
        v = (*(*a)
            .tab
            .offset((*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
            >> ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long - (*a).expn)
            as uint32_t;
        if (*a).sign != 0 {
            v = v.wrapping_neg()
        }
        ...
        if (*a).sign != 0 {
            ...
            if (*a).expn == 32 as libc::c_int as libc::c_long
                && *(*a)
                    .tab
                    .offset((*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
        ...
        v = get_bits(
            ...
            (*a).len
                .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                .wrapping_sub((*a).expn as libc::c_ulong) as slimb_t,
        ) as uint32_t;
        if (*a).sign != 0 {
            v = v.wrapping_neg()
        }
...
pub unsafe extern "C" fn bf_get_int64(
    ...
    if (*a).expn >= 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long {
        ...
        if flags & (1 as libc::c_int) << 0 as libc::c_int != 0 {
            ...
            == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        {
            v = (9223372036854775807 as libc::c_long as uint64_t)
                .wrapping_add((*a).sign as libc::c_ulong)
        } else {
            v = 9223372036854775807 as libc::c_long as uint64_t
        }
    } else if (*a).expn <= 0 as libc::c_int as libc::c_long {
        v = 0 as libc::c_int as uint64_t;
        ret = 0 as libc::c_int
    } else if (*a).expn <= 63 as libc::c_int as libc::c_long {
        v = *(*a)
            .tab
            .offset((*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
            >> ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long - (*a).expn;
        ...
        if (*a).sign != 0 {
            ...
            v = (9223372036854775807 as libc::c_long as uint64_t)
                .wrapping_add(1 as libc::c_int as libc::c_ulong);
            if (*a).expn == 64 as libc::c_int as libc::c_long {
                v1 = *(*a)
                    .tab
                    .offset((*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize);
                if v1 == v {
...
is an overflow and 0 otherwise. */
#[no_mangle]
pub unsafe extern "C" fn bf_get_uint64(mut pres: *mut uint64_t, mut a: *const bf_t) -> libc::c_int {
    let mut v: uint64_t = 0;
    let mut ret: libc::c_int = 0;
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long {
        ...
        ret = (1 as libc::c_int) << 0 as libc::c_int;
        current_block_10 = 17407779659766490442;
    } else if (*a).expn <= 64 as libc::c_int as libc::c_long {
        v = *(*a)
            .tab
            .offset((*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize)
            >> ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long - (*a).expn;
    ...
    match current_block_10 {
        8344853031916340450 => {
            v = 18446744073709551615 as libc::c_ulong;
            ret = (1 as libc::c_int) << 0 as libc::c_int
        }
        _ => {}
    }
...
unsafe extern "C" fn get_limb_radix(mut radix: libc::c_int) -> limb_t {
    ...
    k = digits_per_limb_table[(radix - 2 as libc::c_int) as usize] as libc::c_int;
    radixl = radix as limb_t;
    i = 1 as libc::c_int;
    while i < k {
        radixl = (radixl as libc::c_ulong).wrapping_mul(radix as libc::c_ulong) as limb_t as limb_t;
        i += 1
    }
    return radixl;
}
...
unsafe extern "C" fn bf_integer_from_radix_rec(
    ...
    if n == 1 as libc::c_int as libc::c_ulong {
        ...
        let mut n1: limb_t = 0;
        let mut n2: limb_t = 0;
        n2 = (n0.wrapping_mul(2 as libc::c_int as libc::c_ulong) >> level + 1 as libc::c_int)
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(2 as libc::c_int as libc::c_ulong);
        ...
        bf_init((*r).ctx, T);
        ret = bf_integer_from_radix_rec(T, tab, n2, level + 1 as libc::c_int, n0, radix, pow_tab);
        if ret == 0 {
            ret = bf_add(
                r,
                r,
...
unsafe extern "C" fn bf_integer_from_radix(
    ...
    pow_tab = bf_malloc(
        s,
        (::std::mem::size_of::<bf_t>() as libc::c_ulong).wrapping_mul(pow_tab_len as libc::c_ulong),
    ) as *mut bf_t;
    if pow_tab.is_null() {
        return -(1 as libc::c_int);
    }
    ...
    ret = bf_integer_from_radix_rec(r, tab, n, 0 as libc::c_int, n, radixl, pow_tab);
    i = 0 as libc::c_int;
    while i < pow_tab_len {
...
pub unsafe extern "C" fn bf_mul_pow_radix(
    ...
    let mut B: *mut bf_t = &mut B_s;
    if (*T).len == 0 as libc::c_int as libc::c_ulong {
        return bf_set(r, T);
    } else {
        if expn == 0 as libc::c_int as libc::c_long {
            ret = bf_set(r, T);
            ret |= bf_round(r, prec, flags);
            return ret;
        }
    ...
    if e < 0 as libc::c_int as libc::c_long {
        e = -e;
            ...
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
    {
        ...
        loop {
            prec1 = prec.wrapping_add(ziv_extra_bits as libc::c_ulong) as slimb_t;
            /* XXX: correct overflow/underflow handling */
            /* XXX: rigorous error analysis needed */
            extra_bits = (ceil_log2(e as limb_t) * 2 as libc::c_int + 1 as libc::c_int) as slimb_t;
            ret = bf_pow_ui_ui(
                B,
                radix,
                e as limb_t,
                (prec1 + extra_bits) as limb_t,
                (BF_RNDN as libc::c_int | (0x3f as libc::c_int) << 5 as libc::c_int) as bf_flags_t,
            );
            ...
            if expn_sign != 0 {
                ret |= bf_div(
                    ...
                    B,
                    (prec1 + extra_bits) as limb_t,
                    (BF_RNDN as libc::c_int | (0x3f as libc::c_int) << 5 as libc::c_int)
                        as bf_flags_t,
                )
            } else {
                ret |= bf_mul(
            ...
            if ret & (1 as libc::c_int) << 4 as libc::c_int != 0
                && bf_can_round(
                    r,
                    prec as slimb_t,
                    (flags & 0x7 as libc::c_int as libc::c_uint) as bf_rnd_t,
                    prec1,
                ) == 0
                && overflow == 0
            {
                /* and more precision and retry */
                ziv_extra_bits = ziv_extra_bits + ziv_extra_bits / 2 as libc::c_int as libc::c_long
            } else {
                /* XXX: need to use __bf_round() to pass the inexact
                flag for the subnormal case */
                ret = bf_round(r, prec, flags) | ret & (1 as libc::c_int) << 4 as libc::c_int;
                break;
            }
        }
    }
...
unsafe extern "C" fn bf_add_limb(
    mut a: *mut bf_t,
    mut ppos: *mut slimb_t,
    mut v: limb_t,
) -> libc::c_int {
    let mut pos: slimb_t = 0;
    pos = *ppos;
    if (pos < 0 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
        let mut new_size: limb_t = 0;
        let mut d: limb_t = 0;
        let mut new_tab: *mut limb_t = 0 as *mut limb_t;
        new_size = bf_max(
            (*a).len.wrapping_add(1 as libc::c_int as libc::c_ulong) as slimb_t,
            (*a).len
                .wrapping_mul(3 as libc::c_int as libc::c_ulong)
                .wrapping_div(2 as libc::c_int as libc::c_ulong) as slimb_t,
        ) as limb_t;
        new_tab = bf_realloc(
            (*a).ctx,
            (*a).tab as *mut libc::c_void,
            (::std::mem::size_of::<limb_t>() as libc::c_ulong).wrapping_mul(new_size),
        ) as *mut limb_t;
        if new_tab.is_null() {
            return -(1 as libc::c_int);
        }
...
unsafe extern "C" fn bf_atof_internal(
    ...
    *pexponent = 0 as libc::c_int as slimb_t;
    ...
    if flags & ((1 as libc::c_int) << 18 as libc::c_int) as libc::c_uint == 0
        ...
        && strcasestart(p, b"nan\x00" as *const u8 as *const libc::c_char, &mut p) != 0
    {
        bf_set_nan(r);
        ret = 0 as libc::c_int
    } else {
        ...
        if *p.offset(0 as libc::c_int as isize) as libc::c_int == '0' as i32 {
            if (*p.offset(1 as libc::c_int as isize) as libc::c_int == 'x' as i32
                ...
                && flags & ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_uint == 0
            {
                radix = 16 as libc::c_int;
                p = p.offset(2 as libc::c_int as isize);
                current_block = 2569451025026770673;
            } else if (*p.offset(1 as libc::c_int as isize) as libc::c_int == 'o' as i32
                || *p.offset(1 as libc::c_int as isize) as libc::c_int == 'O' as i32)
                && radix == 0 as libc::c_int
                && flags & ((1 as libc::c_int) << 17 as libc::c_int) as libc::c_uint != 0
            {
                p = p.offset(2 as libc::c_int as isize);
                radix = 8 as libc::c_int;
                current_block = 2569451025026770673;
            } else if (*p.offset(1 as libc::c_int as isize) as libc::c_int == 'b' as i32
        ...
        } else if flags & ((1 as libc::c_int) << 18 as libc::c_int) as libc::c_uint == 0
            && radix <= 16 as libc::c_int
            && strcasestart(p, b"inf\x00" as *const u8 as *const libc::c_char, &mut p) != 0
        {
            bf_set_inf(r, is_neg);
            ret = 0 as libc::c_int;
            current_block = 11118440404757757489;
        ...
        match current_block {
            ...
            _ => {
                ...
                if radix_bits != 0 {
                    ...
                    radix_bits = 0 as libc::c_int;
                    digits_per_limb =
                        digits_per_limb_table[(radix - 2 as libc::c_int) as usize] as libc::c_int;
                    shift = digits_per_limb
                }
                ...
                loop {
                    ...
                    if *p as libc::c_int == '.' as i32
                        && (p > p_start
                            || to_digit(*p.offset(1 as libc::c_int as isize) as libc::c_int)
                                < radix)
                    {
                        if has_decpt != 0 {
                    ...
                    if radix_bits != 0 {
                        ...
                        if shift <= 0 as libc::c_int {
                            ...
                            if shift < 0 as libc::c_int {
                                cur_limb = c << ((1 as libc::c_int) << 6 as libc::c_int) + shift
                            } else {
                                cur_limb = 0 as libc::c_int as limb_t
                            }
                        ...
                        cur_limb = cur_limb
                            .wrapping_mul(radix as libc::c_ulong)
                            .wrapping_add(c);
                        shift -= 1;
                        if !(shift == 0 as libc::c_int) {
                            continue;
                        ...
                        if shift != digits_per_limb {
                            if radix_bits == 0 as libc::c_int {
                                while shift != 0 as libc::c_int {
                                    cur_limb = (cur_limb as libc::c_ulong)
                                        .wrapping_mul(radix as libc::c_ulong)
                                        as limb_t
                                        as limb_t;
                                    shift -= 1
                            ...
                            _ => {
                                ...
                                if p == p_start {
                                    ...
                                    if (radix == 10 as libc::c_int
                                        ...
                                        && p > p_start
                                    {
                                        is_bin_exp = (*p as libc::c_int == 'p' as i32
                                            || *p as libc::c_int == 'P' as i32)
                                            as libc::c_int;
                                        p = p.offset(1);
                                        ...
                                        loop {
                                                ...
                                                != 0
                                            {
                                                ...
                                                p = p.offset(1);
                                                expn = expn * 10 as libc::c_int as libc::c_long
                                                    + c_0 as libc::c_long
                                            }
                                        }
                                        match current_block {
                                    ...
                                    match current_block {
                                        ...
                                        _ => {
                                            if is_dec != 0 {
                                                ...
                                                /* XXX: may overflow */
                                                if is_bin_exp == 0 {
                                                    expn *= radix_bits as libc::c_long
                                                } /* number of limbs */
                                                (*a).expn =
                                                    expn + int_len * radix_bits as libc::c_long;
                                                (*a).sign = is_neg;
                                                ret = bf_normalize_and_round(a, prec, flags)
                                            } else {
                                                let mut l: limb_t = 0;
                                                pos += 1;
                                                l = (*a).len.wrapping_sub(pos as libc::c_ulong);
                                                if l == 0 as libc::c_int as libc::c_ulong {
                                                    bf_set_zero(r, is_neg);
                                                    ret = 0 as libc::c_int
                                                } else {
                                                    ...
                                                    let mut T: *mut bf_t = &mut T_s;
                                                    expn = (expn as libc::c_ulong).wrapping_sub(
                                                        l.wrapping_mul(
                                                            digits_per_limb as libc::c_ulong,
                                                        )
                                                        .wrapping_sub(int_len as libc::c_ulong),
                                                    )
                                                        as slimb_t
                                                        as slimb_t;
                                                    bf_init((*r).ctx, T);
...
static mut inv_log2_radix: [[uint32_t; 3]; 35] = [
    ...
    [
        0x50c24e60 as libc::c_int as uint32_t,
        0xd4d4f4a7 as libc::c_uint,
    ...
    [
        0x3184648d as libc::c_int as uint32_t,
        0xb8153e7a as libc::c_uint,
        0x7fc2d2e1 as libc::c_int as uint32_t,
    ],
    [
        0x2d983275 as libc::c_int as uint32_t,
        0x9d5369c4 as libc::c_uint,
        0x4dec1661 as libc::c_int as uint32_t,
    ],
    [
        0x2aaaaaaa as libc::c_int as uint32_t,
        0xaaaaaaaa as libc::c_uint,
        0xaaaaaaab as libc::c_uint,
    ],
    [
        0x28612730 as libc::c_int as uint32_t,
        0x6a6a7a53 as libc::c_int as uint32_t,
        0x810fabde as libc::c_uint,
    ],
    [
    ...
    [
        0x25001383 as libc::c_int as uint32_t,
        0xbac8a744 as libc::c_uint,
        0x385a3349 as libc::c_int as uint32_t,
    ],
    [
        0x23b46706 as libc::c_int as uint32_t,
        0x82c0c709 as libc::c_uint,
        0x3f891718 as libc::c_int as uint32_t,
    ],
    [
        0x229729f1 as libc::c_int as uint32_t,
        0xb2c83ded as libc::c_uint,
        0x15fba800 as libc::c_int as uint32_t,
    ],
    [
        0x219e7ffd as libc::c_int as uint32_t,
        0xa5ad572a as libc::c_uint,
        0xe169744b as libc::c_uint,
    ],
    [
        0x20c33b88 as libc::c_int as uint32_t,
        0xda7c29aa as libc::c_uint,
    ...
    [
        0x1f50b57e as libc::c_int as uint32_t,
        0xac5884b3 as libc::c_uint,
        0x70e28eee as libc::c_int as uint32_t,
    ],
    [
        0x1eb22cc6 as libc::c_int as uint32_t,
        0x8aa6e26f as libc::c_uint,
        0x6d1a2a2 as libc::c_int as uint32_t,
    ],
    [
        0x1e21e118 as libc::c_int as uint32_t,
        0xc5daab1 as libc::c_int as uint32_t,
        0x81b4f4bf as libc::c_uint,
    ],
    [
        0x1d9dcd21 as libc::c_int as uint32_t,
        0x439834e3 as libc::c_int as uint32_t,
        0x81667575 as libc::c_uint,
    ],
    [
        0x1d244c78 as libc::c_int as uint32_t,
        0x367a0d64 as libc::c_int as uint32_t,
        0xc8204d6d as libc::c_uint,
    ],
    [
        0x1cb40589 as libc::c_int as uint32_t,
        0xac173e0c as libc::c_uint,
        0x3b7b16ba as libc::c_int as uint32_t,
    ],
    [
        0x1c4bd95b as libc::c_int as uint32_t,
        0xa8d72b0d as libc::c_uint,
        0x5879f25a as libc::c_int as uint32_t,
    ],
    [
        0x1bead768 as libc::c_int as uint32_t,
        0x98f8ce4c as libc::c_uint,
    ...
    [
        ...
        0x2eb06f14 as libc::c_int as uint32_t,
        0x8c89719c as libc::c_uint,
    ],
    [
        0x1aeb6f75 as libc::c_int as uint32_t,
        0x9c46fc37 as libc::c_uint,
    ...
    [
        0x1a593062 as libc::c_int as uint32_t,
        0xb38d8c56 as libc::c_uint,
    ...
    [
        0x19d630dc as libc::c_int as uint32_t,
        0xcc7ddef9 as libc::c_uint,
        0x5aadd61b as libc::c_int as uint32_t,
    ],
    [
        0x19999999 as libc::c_int as uint32_t,
        0x99999999 as libc::c_uint,
        0x9999999a as libc::c_uint,
    ],
    [
        0x195fec80 as libc::c_int as uint32_t,
        0x8a609430 as libc::c_uint,
    ...
    [
        0x18f46acf as libc::c_int as uint32_t,
        0x8c06e318 as libc::c_uint,
        0x4d2aeb2c as libc::c_int as uint32_t,
    ],
    [
        0x18c23246 as libc::c_int as uint32_t,
        0xdc0a9f3d as libc::c_uint,
...
static mut log2_radix: [limb_t; 35] = [
    ...
    0x82cc7edf592262d0 as libc::c_ulong,
    0x8570068e7ef5a1e8 as libc::c_ulong,
    0x87ef05ae409a0289 as libc::c_ulong,
    0x8a4d3c25e68dc57f as libc::c_ulong,
    0x8c8ddd448f8b845a as libc::c_ulong,
    0x8eb3a9f01975077f as libc::c_ulong,
    0x90c10500d63aa659 as libc::c_ulong,
    0x92b803473f7ad0f4 as libc::c_ulong,
    0x949a784bcd1b8afe as libc::c_ulong,
    0x966a008e4788cbcd as libc::c_ulong,
    0x982809d5be7072dc as libc::c_ulong,
    0x99d5d9fd5010b366 as libc::c_ulong,
    0x9b74948f5532da4b as libc::c_ulong,
    0x9d053f6d26089673 as libc::c_ulong,
    0x9e88c6b3626a72aa as libc::c_ulong,
    0xa000000000000000 as libc::c_ulong,
    0xa16bad3758efd873 as libc::c_ulong,
    0xa2cc7edf592262d0 as libc::c_ulong,
    0xa4231623369e78e6 as libc::c_ulong,
    0xa570068e7ef5a1e8 as libc::c_ulong,
];
...
pub unsafe extern "C" fn bf_mul_log2_radix(
    ...
    is_ceil = is_ceil1;
    a = a1 as limb_t;
    if a1 < 0 as libc::c_int as libc::c_long {
        a = a.wrapping_neg();
        is_neg = 1 as libc::c_int
    } else {
        is_neg = 0 as libc::c_int
        ...
        == 0 as libc::c_int as libc::c_uint
    {
        ...
        if is_inv != 0 {
            if is_ceil != 0 {
                a = (a as libc::c_ulong)
                    .wrapping_add((radix_bits - 1 as libc::c_int) as libc::c_ulong)
                    as limb_t as limb_t
            }
            a = a.wrapping_div(radix_bits as libc::c_ulong)
        } else {
            a = a.wrapping_mul(radix_bits as libc::c_ulong)
        }
    } else {
        ...
        let mut t: dlimb_t = 0;
        if is_inv != 0 {
            tab = inv_log2_radix[radix.wrapping_sub(2 as libc::c_int as libc::c_uint) as usize]
                .as_ptr();
            b1 = (*tab.offset(0 as libc::c_int as isize) as limb_t) << 32 as libc::c_int
                | *tab.offset(1 as libc::c_int as isize) as libc::c_ulong;
            b0 = (*tab.offset(2 as libc::c_int as isize) as limb_t) << 32 as libc::c_int;
            t = (b0 as dlimb_t).wrapping_mul(a as dlimb_t);
            t = (b1 as dlimb_t)
                .wrapping_mul(a as dlimb_t)
                .wrapping_add(t >> ((1 as libc::c_int) << 6 as libc::c_int));
            a = (t >> ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as limb_t
        } else {
            b0 = log2_radix[radix.wrapping_sub(2 as libc::c_int as libc::c_uint) as usize];
            t = (b0 as dlimb_t).wrapping_mul(a as dlimb_t);
            a = (t >> ((1 as libc::c_int) << 6 as libc::c_int) - 3 as libc::c_int) as limb_t
        }
        /* a = floor(result) and 'result' cannot be an integer */
        a = (a as libc::c_ulong).wrapping_add(is_ceil as libc::c_ulong) as limb_t as limb_t
    }
    if is_neg != 0 {
        a = a.wrapping_neg()
    }
    ...
    if n == 1 as libc::c_int as libc::c_ulong {
        *out.offset(0 as libc::c_int as isize) = get_bits(
        ...
        t = (get_bits(
            (*a).tab,
            (*a).len,
            pos + ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long,
        ) as dlimb_t)
            << ((1 as libc::c_int) << 6 as libc::c_int)
            | get_bits((*a).tab, (*a).len, pos) as u128;
        if (radixl == 10000000000000000000 as libc::c_ulong) as libc::c_int as libc::c_long != 0 {
            /* use division by a constant when possible */
            *out.offset(0 as libc::c_int as isize) =
                t.wrapping_rem(10000000000000000000 as libc::c_ulong as u128) as limb_t;
            *out.offset(1 as libc::c_int as isize) =
                t.wrapping_div(10000000000000000000 as libc::c_ulong as u128) as limb_t
        } else {
            *out.offset(0 as libc::c_int as isize) = t.wrapping_rem(radixl as u128) as limb_t;
            *out.offset(1 as libc::c_int as isize) = t.wrapping_div(radixl as u128) as limb_t
        }
    } else {
        let mut Q: bf_t = bf_t {
            ctx: 0 as *mut bf_context_t,
        ...
        n2 = (n0.wrapping_mul(2 as libc::c_int as libc::c_ulong) >> level + 1 as libc::c_int)
            ...
            .wrapping_div(2 as libc::c_int as libc::c_ulong);
        n1 = n.wrapping_sub(n2);
        B = &mut *pow_tab.offset((2 as libc::c_int * level) as isize) as *mut bf_t;
        B_inv = &mut *pow_tab.offset((2 as libc::c_int * level + 1 as libc::c_int) as isize)
            as *mut bf_t;
        ret = 0 as libc::c_int;
        if (*B).len == 0 as libc::c_int as libc::c_ulong {
            /* compute BASE^n2 */
            ...
            ret |= bf_div(
                ...
                &mut R,
                B,
                n2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(radixl_bits as libc::c_ulong)
                    .wrapping_add(2 as libc::c_int as libc::c_ulong),
                BF_RNDN as libc::c_int as bf_flags_t,
            )
        }
        //        printf("%d: n1=% " PRId64 " n2=%" PRId64 "\n", level, n1, n2);
        q_prec = n1.wrapping_mul(radixl_bits as libc::c_ulong);
        ret |= bf_mul(
            &mut Q,
            a,
            B_inv,
        ...
        if ret & (1 as libc::c_int) << 5 as libc::c_int != 0 {
            ...
            loop {
                if !(R.sign != 0 && R.len != 0 as libc::c_int as libc::c_ulong) {
...
unsafe extern "C" fn bf_convert_to_radix(
    ...
    if is_fixed_exponent != 0 {
        ...
        E = 1 as libc::c_int as libc::c_long
            + bf_mul_log2_radix(
                (*a).expn - 1 as libc::c_int as libc::c_long,
    ...
    {
        e = P.wrapping_sub(E as libc::c_ulong) as slimb_t;
...
unsafe extern "C" fn limb_to_a(
    ...
    if radix == 10 as libc::c_int as libc::c_uint {
        ...
        while i >= 0 as libc::c_int {
            digit = n.wrapping_rem(10 as libc::c_int as libc::c_ulong) as libc::c_int;
        ...
        i = len - 1 as libc::c_int;
        while i >= 0 as libc::c_int {
            digit = n.wrapping_rem(radix as libc::c_ulong) as libc::c_int;
            n = n.wrapping_div(radix as libc::c_ulong);
...
unsafe extern "C" fn limb_to_a2(
    ...
    mask = (((1 as libc::c_int) << radix_bits) - 1 as libc::c_int) as libc::c_uint;
    i = len - 1 as libc::c_int;
    while i >= 0 as libc::c_int {
        digit = (n & mask as libc::c_ulong) as libc::c_int;
        n >>= radix_bits;
        if digit < 10 as libc::c_int {
            digit += '0' as i32
        } else {
...
unsafe extern "C" fn output_digits(
    ...
    if is_dec != 0 {
        ...
        a = a1 as *mut bf_t;
        radix_bits = ceil_log2(radix as limb_t);
        digits_per_limb = ((1 as libc::c_int) << 6 as libc::c_int) / radix_bits;
        ...
        let mut n: limb_t = 0;
        let mut radixl: limb_t = 0;
        digits_per_limb = digits_per_limb_table[(radix - 2 as libc::c_int) as usize] as libc::c_int;
        radixl = get_limb_radix(radix);
        a = &mut a_s;
        bf_init((*a1).ctx, a);
        n = n_digits
            .wrapping_add(digits_per_limb as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(digits_per_limb as libc::c_ulong);
        if bf_resize(a, n) != 0 {
            dbuf_set_error(s);
            ...
            pos = n as slimb_t;
            pos_incr = 1 as libc::c_int as slimb_t;
            first_buf_pos = ((pos * digits_per_limb as libc::c_long) as libc::c_ulong)
                .wrapping_sub(n_digits) as libc::c_int;
            current_block = 5689316957504528238;
        }
    }
    match current_block {
            ...
            while i < n_digits {
                if buf_pos == digits_per_limb {
                    ...
                    if radix_bits == 0 as libc::c_int {
                        ...
                        limb_to_a(buf.as_mut_ptr(), v, radix as libc::c_uint, digits_per_limb);
                    } else {
...
unsafe extern "C" fn bf_ftoa_internal(
    ...
    if (*a2).expn == 9223372036854775807 as libc::c_long {
        ...
        if (*a2).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long {
            if flags & ((1 as libc::c_int) << 22 as libc::c_int) as libc::c_uint != 0 {
                dbuf_putstr(s, b"Infinity\x00" as *const u8 as *const libc::c_char);
            } else {
                dbuf_putstr(s, b"Inf\x00" as *const u8 as *const libc::c_char);
            }
            current_block = 17418136423408909163;
        } else {
            ...
            fmt =
                (flags & ((3 as libc::c_int) << 16 as libc::c_int) as libc::c_uint) as libc::c_int;
            bf_init(ctx, a1);
                ...
                if is_dec != 0 || radix_bits != 0 as libc::c_int {
                    if bf_set(a1, a2) != 0 {
                        ...
                        if is_dec != 0 {
                            ...
                            a1,
                            prec.wrapping_mul(radix_bits as libc::c_ulong),
                            flags & 0x7 as libc::c_int as libc::c_uint
                                | ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint,
                        ) & (1 as libc::c_int) << 5 as libc::c_int
                            != 0
                        ...
                        match current_block {
                            7361972997577608855 => {}
                            _ => {
                                if flags & ((1 as libc::c_int) << 21 as libc::c_int) as libc::c_uint
                                    != 0
                                {
                                    if radix == 16 as libc::c_int {
                                        ...
                                        dbuf_putstr(
                                            s,
                                            b"0o\x00" as *const u8 as *const libc::c_char,
                                        );
                                    } else if radix == 2 as libc::c_int {
                                        dbuf_putstr(
                                            s,
                                            b"0b\x00" as *const u8 as *const libc::c_char,
                                        );
                                    }
                                }
                                if (*a1).expn
                                    == -(9223372036854775807 as libc::c_long)
                                        - 1 as libc::c_int as libc::c_long
                                {
                                    dbuf_putstr(s, b"0\x00" as *const u8 as *const libc::c_char);
                                    if prec > 0 as libc::c_int as libc::c_ulong {
                                        dbuf_putstr(
                                            s,
                                            b".\x00" as *const u8 as *const libc::c_char,
                                        );
                                        i = 0 as libc::c_int as slimb_t;
                                        while (i as libc::c_ulong) < prec {
                                            dbuf_putc(s, '0' as i32 as uint8_t);
                                            i += 1
                                        }
                                    }
                                } else {
                                    n_digits = prec.wrapping_add(n as libc::c_ulong) as slimb_t;
                                    if n <= 0 as libc::c_int as libc::c_long {
                                        ...
                                        if n_digits > 0 as libc::c_int as libc::c_long {
                                            output_digits(
                                                s,
                                                a1,
                                                radix,
                    ...
                    n = 1 as libc::c_int as libc::c_long
                        + bf_mul_log2_radix(
                            bf_max((*a).expn, 0 as libc::c_int as slimb_t),
                            radix as libc::c_uint,
                            TRUE as libc::c_int,
                            TRUE as libc::c_int,
                        );
                    n_digits = (n as libc::c_ulong).wrapping_add(prec) as slimb_t;
                    n1 = n;
                    ...
                    ) != 0
                    {
                        ...
                        pos = start;
                        while
                            pos.wrapping_add(1 as libc::c_int as libc::c_ulong) < (*s).size
                                && *(*s).buf.offset(pos as isize) as libc::c_int == '0' as i32
                                && *(*s)
                                    .buf
                                    .offset(pos.wrapping_add(1 as libc::c_int as libc::c_ulong)
                ...
                if is_dec != 0 {
                    if bf_set(a1, a2) != 0 {
                        ...
                        if fmt == (0 as libc::c_int) << 16 as libc::c_int {
                            ...
                            /* prec is ignored */
                            n_digits = (*a1).len.wrapping_mul(19 as libc::c_int as libc::c_ulong)
                                as slimb_t;
                            prec = n_digits as limb_t;
                            /* remove the trailing zero digits */
                            while n_digits > 1 as libc::c_int as libc::c_long
                                && get_digit(
                                    (*a1).tab,
                                    (*a1).len,
                                    prec.wrapping_sub(n_digits as libc::c_ulong) as slimb_t,
                                ) == 0 as libc::c_int as libc::c_ulong
                            {
                                n_digits -= 1
                            }
                            n_max = n_digits + 4 as libc::c_int as libc::c_long;
                            current_block = 16789764818708874114;
                        }
                        match current_block {
                            7361972997577608855 => {}
                    ...
                    if bf_set(a1, a2) != 0 {
                        ...
                        if fmt == (0 as libc::c_int) << 16 as libc::c_int {
                            ...
                            prec_bits = prec
                                .wrapping_mul(radix_bits as libc::c_ulong)
                            ...
                            /* remove the trailing zero digits */
                            digit_mask = ((1 as libc::c_int as limb_t) << radix_bits)
                                .wrapping_sub(1 as libc::c_int as libc::c_ulong);
                            while n_digits > 1 as libc::c_int as libc::c_long
                                && get_bits(
                                    (*a1).tab,
                                    (*a1).len,
                                    pos_0 - n_digits * radix_bits as libc::c_long,
                                ) & digit_mask
                                    == 0 as libc::c_int as libc::c_ulong
                            {
                                n_digits -= 1
                    ...
                    if fmt == (0 as libc::c_int) << 16 as libc::c_int {
                        ...
                        if fmt == (3 as libc::c_int) << 16 as libc::c_int {
                            ...
                            loop {
                                ...
                                n_digits = (n_digits_min + n_digits_max)
                                    / 2 as libc::c_int as libc::c_long;
                                if bf_convert_to_radix(
                                    a1,
                                    &mut n,
                                ...
                                ) != 0
                                {
                                    ...
                                    ret = bf_mul_pow_radix(
                                        ...
                                        prec,
                                        flags & !(0x7 as libc::c_int) as libc::c_uint
                                            | BF_RNDN as libc::c_int as libc::c_uint,
                                    );
                                    if ret & (1 as libc::c_int) << 5 as libc::c_int != 0 {
                                        bf_delete(b);
                                        current_block = 7361972997577608855;
                                        break;
                                    } else if bf_cmpu(b, a_0) == 0 as libc::c_int {
                                        n_digits_max = n_digits
                                    } else {
                                        n_digits_min = n_digits + 1 as libc::c_int as libc::c_long
                                    }
                                }
                            }
                            match current_block {
                ...
                match current_block {
                    ...
                    _ => {
                        if (*a1).expn
                            ...
                            && flags & ((1 as libc::c_int) << 20 as libc::c_int) as libc::c_uint
                                == 0
                        {
                            /* just output zero */
                            dbuf_putstr(s, b"0\x00" as *const u8 as *const libc::c_char);
                            ...
                            {
                                if radix == 16 as libc::c_int {
                                    dbuf_putstr(s, b"0x\x00" as *const u8 as *const libc::c_char);
                                } else if radix == 8 as libc::c_int {
                                    dbuf_putstr(s, b"0o\x00" as *const u8 as *const libc::c_char);
                                } else if radix == 2 as libc::c_int {
                                    dbuf_putstr(s, b"0b\x00" as *const u8 as *const libc::c_char);
                                }
                            }
                            if (*a1).expn
                                == -(9223372036854775807 as libc::c_long)
                            ...
                            if flags & ((1 as libc::c_int) << 20 as libc::c_int) as libc::c_uint
                                != 0
                                || n <= -(6 as libc::c_int) as libc::c_long
                                || n > n_max
                            {
                                let mut fmt_0: *const libc::c_char = 0 as *const libc::c_char;
                                ...
                                if radix_bits != 0 as libc::c_int && radix <= 16 as libc::c_int {
                                    if flags
                                        & ((1 as libc::c_int) << 22 as libc::c_int) as libc::c_uint
                                        != 0
                                    {
                                        fmt_0 = b"p%+ld\x00" as *const u8 as *const libc::c_char
                                    } else {
                                        fmt_0 = b"p%ld\x00" as *const u8 as *const libc::c_char
                                    }
                                    dbuf_printf(
                                    ...
                                    if flags
                                        ...
                                        != 0
                                    {
                                        fmt_0 = b"%c%+ld\x00" as *const u8 as *const libc::c_char
                                    } else {
                                        fmt_0 = b"%c%ld\x00" as *const u8 as *const libc::c_char
                                    }
                                    dbuf_printf(
    ...
    match current_block {
        17418136423408909163 => {
            ...
            if !(dbuf_error(s) != 0) {
                if !plen.is_null() {
                    *plen = (*s).size.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                }
...
pub unsafe extern "C" fn bf_ftoa(
    ...
    return bf_ftoa_internal(plen, a, radix, prec, flags, FALSE as libc::c_int);
}
/* **************************************************************/
...
unsafe extern "C" fn bf_const_log2_rec(
    ...
    if n2.wrapping_sub(n1) == 1 as libc::c_int as libc::c_ulong {
        ...
        (*Q).expn += 2 as libc::c_int as libc::c_long;
        bf_set(T, P);
    } else {
        let mut m: limb_t = 0;
...
unsafe extern "C" fn bf_const_log2_internal(mut T: *mut bf_t, mut prec: limb_t) {
    ...
    let mut Q: *mut bf_t = &mut Q_s;
    w = prec.wrapping_add(15 as libc::c_int as libc::c_ulong);
    N = w
        .wrapping_div(3 as libc::c_int as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
    bf_init((*T).ctx, P);
    bf_init((*T).ctx, Q);
    bf_const_log2_rec(T, P, Q, 0 as libc::c_int as limb_t, N, FALSE as libc::c_int);
...
unsafe extern "C" fn chud_bs(
    ...
    mut a: int64_t,
    mut b: int64_t,
    mut need_g: libc::c_int,
    mut prec: limb_t,
) {
    let mut s: *mut bf_context_t = (*P).ctx;
    let mut c: int64_t = 0;
    if a == b - 1 as libc::c_int as libc::c_long {
        ...
        bf_set_ui(
            G,
            (2 as libc::c_int as libc::c_long * b - 1 as libc::c_int as libc::c_long) as uint64_t,
        );
        bf_mul_ui(
            G,
            G,
            (6 as libc::c_int as libc::c_long * b - 1 as libc::c_int as libc::c_long) as uint64_t,
            prec,
            BF_RNDN as libc::c_int as bf_flags_t,
        );
        bf_mul_ui(
            G,
            G,
            (6 as libc::c_int as libc::c_long * b - 5 as libc::c_int as libc::c_long) as uint64_t,
            prec,
            BF_RNDN as libc::c_int as bf_flags_t,
        );
        ...
        (*P).sign = (b & 1 as libc::c_int as libc::c_long) as libc::c_int;
        ...
        bf_mul_ui(
            Q,
            Q,
            (640320 as libc::c_int as uint64_t)
                .wrapping_mul(640320 as libc::c_int as libc::c_ulong)
                .wrapping_mul(640320 as libc::c_int as libc::c_ulong)
                .wrapping_div(24 as libc::c_int as libc::c_ulong),
            prec,
            BF_RNDN as libc::c_int as bf_flags_t,
        );
        bf_delete(&mut T0);
        ...
        bf_init(s, &mut Q2);
        bf_init(s, &mut G2);
        c = (a + b) / 2 as libc::c_int as libc::c_long;
        ...
        if need_g == 0 {
            bf_set_ui(G, 0 as libc::c_int as uint64_t);
        }
...
unsafe extern "C" fn bf_const_pi_internal(mut Q: *mut bf_t, mut prec: limb_t) {
    ...
    n = prec
        .wrapping_div(47 as libc::c_int as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong) as int64_t;
    /* XXX: precision analysis */
    prec1 = prec.wrapping_add(32 as libc::c_int as libc::c_ulong) as int64_t;
    bf_init(s, &mut P);
    bf_init(s, &mut G);
    chud_bs(
        &mut P,
    ...
    bf_mul_ui(
        &mut G,
        Q,
        13591409 as libc::c_int as uint64_t,
        prec1 as limb_t,
        BF_RNDN as libc::c_int as bf_flags_t,
    );
    bf_add(
    ...
    bf_mul_ui(
        &mut G,
        &mut G,
        (640320 as libc::c_int as uint64_t).wrapping_div(12 as libc::c_int as libc::c_ulong),
        prec1 as limb_t,
        BF_RNDF as libc::c_int as bf_flags_t,
    );
...
unsafe extern "C" fn bf_const_get(
    ...
    loop {
        ...
        if (*c).prec < prec1 {
            if (*c).val.len == 0 as libc::c_int as libc::c_ulong {
        ...
        /* and more precision and retry */
        ziv_extra_bits = ziv_extra_bits
            .wrapping_add(ziv_extra_bits.wrapping_div(2 as libc::c_int as libc::c_ulong))
    }
    ...
    if rnd_mode == BF_RNDF as libc::c_int {
        ...
        loop {
            ...
            if ret & (1 as libc::c_int) << 4 as libc::c_int == 0 {
                ...
                ziv_extra_bits = ziv_extra_bits * 2 as libc::c_int as libc::c_long
            }
        }
    }
    if (*r).len == 0 as libc::c_int as libc::c_ulong {
...
unsafe extern "C" fn bf_exp_internal(
    ...
    */
    bf_init(s, T);
    if (*a).expn <= -(1 as libc::c_int) as libc::c_long {
        /* 0 <= abs(a) <= 0.5 */
        if (*a).sign != 0 {
            n = -(1 as libc::c_int) as slimb_t
        } else {
    ...
    K = bf_isqrt(
        prec.wrapping_add(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(2 as libc::c_int as libc::c_ulong),
    ) as slimb_t;
    l = prec
        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
        .wrapping_div(K as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong) as slimb_t;
    /* XXX: precision analysis ? */
    prec1 = prec
        .wrapping_add(
            (K + 2 as libc::c_int as libc::c_long * l + 18 as libc::c_int as libc::c_long)
                as libc::c_ulong,
        )
        .wrapping_add(K as libc::c_ulong)
        .wrapping_add(8 as libc::c_int as libc::c_ulong) as slimb_t;
    if (*a).expn > 0 as libc::c_int as libc::c_long {
        prec1 += (*a).expn
    }
    ...
    */
    ...
    bf_mul_2exp(
        ...
        ((1 as libc::c_int as limb_t)
            ...
            .wrapping_sub(2 as libc::c_int as libc::c_ulong)
            .wrapping_add(1 as libc::c_int as libc::c_ulong),
        (BF_RNDZ as libc::c_int | (0x3f as libc::c_int) << 5 as libc::c_int) as bf_flags_t,
    );
...
unsafe extern "C" fn check_exp_underflow_overflow(
    ...
    let mut e_min: slimb_t = 0;
    let mut e_max: slimb_t = 0;
    if (*a_high).expn <= 0 as libc::c_int as libc::c_long {
        return 0 as libc::c_int;
    }
    e_max = ((1 as libc::c_int as limb_t) << bf_get_exp_bits(flags) - 1 as libc::c_int) as slimb_t;
    e_min = -e_max + 3 as libc::c_int as libc::c_long;
    if flags & ((1 as libc::c_int) << 3 as libc::c_int) as libc::c_uint != 0 {
        e_min = (e_min as libc::c_ulong)
            .wrapping_sub(prec.wrapping_sub(1 as libc::c_int as libc::c_ulong))
            as slimb_t as slimb_t
    }
    bf_init(s, T);
    bf_init(s, log2);
    ...
    bf_mul_si(
        T,
        log2,
        e_min - 2 as libc::c_int as libc::c_long,
        ((1 as libc::c_int) << 6 as libc::c_int) as limb_t,
        BF_RNDD as libc::c_int as bf_flags_t,
    );
    if bf_cmp_lt(a_high, T) != 0 {
        let mut rnd_mode: libc::c_int = (flags & 0x7 as libc::c_int as libc::c_uint) as libc::c_int;
        /* underflow */
        bf_delete(T);
        bf_delete(log2);
        ...
        return (1 as libc::c_int) << 3 as libc::c_int | (1 as libc::c_int) << 4 as libc::c_int;
    }
    bf_delete(log2);
    bf_delete(T);
    return 0 as libc::c_int;
...
pub unsafe extern "C" fn bf_exp(
    ...
    if (*a).expn < 0 as libc::c_int as libc::c_long
        && -(*a).expn as libc::c_ulong >= prec.wrapping_add(2 as libc::c_int as libc::c_ulong)
    {
        /* small argument case: result = 1 + epsilon * sign(x) */
        bf_set_ui(r, 1 as libc::c_int as uint64_t);
        return bf_add_epsilon(
            r,
            r,
            prec.wrapping_add(2 as libc::c_int as libc::c_ulong)
                .wrapping_neg() as slimb_t,
            (*a).sign,
            prec,
            flags as libc::c_int,
        );
...
unsafe extern "C" fn bf_log_internal(
    ...
    l = prec
        .wrapping_div((2 as libc::c_int as libc::c_long * K) as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong) as slimb_t;
    /* precision of the intermediate computations */
    prec1 = prec
        .wrapping_add(K as libc::c_ulong)
        .wrapping_add((2 as libc::c_int as libc::c_long * l) as libc::c_ulong)
        .wrapping_add(32 as libc::c_int as libc::c_ulong) as slimb_t;
    bf_init(s, U);
    bf_init(s, V);
    ...
    */
    ...
    while i >= 1 as libc::c_int as libc::c_long {
        ...
        bf_set_ui(
            V,
            (2 as libc::c_int as libc::c_long * i + 1 as libc::c_int as libc::c_long) as uint64_t,
        );
        bf_div(
            U,
            U,
...
unsafe extern "C" fn bf_pow_generic(
    ...
    prec1 = prec.wrapping_add(32 as libc::c_int as libc::c_ulong); /* no overflow/underlow test needed */
    bf_log(
        T,
        x,
        prec1,
        (BF_RNDF as libc::c_int | (0x3f as libc::c_int) << 5 as libc::c_int) as bf_flags_t,
    );
    bf_mul(
        T,
        T,
    ...
    if bf_is_nan(T) != 0 {
        ...
        bf_exp_internal(r, T, prec1, 0 as *mut libc::c_void);
    }
    bf_delete(T);
    return (1 as libc::c_int) << 4 as libc::c_int;
}
...
unsafe extern "C" fn bf_pow_int(
    ...
    if y1 < 0 as libc::c_int as libc::c_long {
        y1 = -y1
    }
    /* XXX: proof for the added precision */
    prec1 = prec
        .wrapping_add((ceil_log2(y1 as limb_t) * 2 as libc::c_int) as libc::c_ulong)
...
unsafe extern "C" fn check_exact_power2n(
    ...
    if n > (((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int) as libc::c_long {
        if e != 0 as libc::c_int as libc::c_long {
            return FALSE as libc::c_int;
        }
        er = 0 as libc::c_int as slimb_t
    } else {
        if e as libc::c_ulong
            & ((1 as libc::c_int as limb_t) << n).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            != 0 as libc::c_int as libc::c_ulong
        {
            return FALSE as libc::c_int;
        }
    ...
    v = get_bits(
        ...
        (*x).len
            .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
            .wrapping_sub((*x).expn as libc::c_ulong)
            .wrapping_add(e as libc::c_ulong) as slimb_t,
    );
    if v & 7 as libc::c_int as libc::c_ulong != 1 as libc::c_int as libc::c_ulong {
        return FALSE as libc::c_int;
    }
    bf_init(s, T);
    bf_set(T, x);
...
pub unsafe extern "C" fn bf_pow(
    ...
    if (*x).len == 0 as libc::c_int as libc::c_ulong
        || (*y).len == 0 as libc::c_int as libc::c_ulong
    {
        if (*y).expn == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long {
            /* pow(x, 0) = 1 */
            bf_set_ui(r, 1 as libc::c_int as uint64_t);
        } else if (*x).expn == 9223372036854775807 as libc::c_long {
            bf_set_nan(r);
        } else {
                    ...
                    >= 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
            {
                ...
                && ((*x).sign == 0 || (*y).expn != 9223372036854775807 as libc::c_long))
            {
                if (*y).expn == 9223372036854775807 as libc::c_long {
                    bf_set_nan(r);
                } else if (*y).expn
                    == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
                {
                    if (*y).sign == (cmp_x_abs_1 > 0 as libc::c_int) as libc::c_int {
                        bf_set_zero(r, 0 as libc::c_int);
                    } else {
                        bf_set_inf(r, 0 as libc::c_int);
                    }
                    ...
                    y_is_odd = (y_emin == 0 as libc::c_int as libc::c_long) as libc::c_int;
                    if (*y).sign
                        == ((*x).expn
                            == -(9223372036854775807 as libc::c_long)
                                - 1 as libc::c_int as libc::c_long)
    ...
    bf_set(T, x);
    y_emin = bf_get_exp_min(y);
    y_is_int = (y_emin >= 0 as libc::c_int as libc::c_long) as libc::c_int;
    rnd_mode = (flags & 0x7 as libc::c_int as libc::c_uint) as libc::c_int;
    if (*x).sign != 0 {
        if y_is_int == 0 {
            bf_set_nan(r);
        ...
        is changed */
        if r_sign != 0 && (rnd_mode == BF_RNDD as libc::c_int || rnd_mode == BF_RNDU as libc::c_int)
        {
            flags ^= 1 as libc::c_int as libc::c_uint
        }
        bf_neg(T);
    } else {
        r_sign = 0 as libc::c_int
    }
    bf_set_ui(r, 1 as libc::c_int as uint64_t);
    if bf_cmp_eq(T, r) != 0 {
        ...
        let mut precl: limb_t = ((1 as libc::c_int) << 6 as libc::c_int) as limb_t;
        bf_init(s, al);
        bf_init(s, ah);
        ...
        if !(ret != 0) {
            if y_is_int != 0 {
                ...
                if y_emin < 0 as libc::c_int as libc::c_long
            ...
            match current_block {
                12991220813362298223 => {
                    ...
                    if T_bits == 1 as libc::c_int as libc::c_long {
                        /* pow(2^b, y) = 2^(b*y) */
                        bf_mul_si(
                            T,
                            y,
                            (*T).expn - 1 as libc::c_int as libc::c_long,
                            ((1 as libc::c_int) << 6 as libc::c_int) as limb_t,
                            BF_RNDZ as libc::c_int as bf_flags_t,
                        );
                            ...
                            .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    {
                        ...
                        if (*y).expn <= 31 as libc::c_int as libc::c_long {
                            current_block = 2616667235040759262;
                        } else if (*y).sign != 0 {
                            current_block = 10289029935050646611;
                        } else if rnd_mode == BF_RNDF as libc::c_int {
                            ...
                            */
                            bf_mul_si(
                                r,
                                y,
                                T_bits - 1 as libc::c_int as libc::c_long,
                                ((1 as libc::c_int) << 6 as libc::c_int) as limb_t,
                                BF_RNDZ as libc::c_int as bf_flags_t,
                            );
                            bf_get_limb(&mut e, r, 0 as libc::c_int);
                            if prec < e as libc::c_ulong {
                                current_block = 10289029935050646611;
                            } else {
                                current_block = 2616667235040759262;
                            }
...
unsafe extern "C" fn bf_sincos(
    ...
    bf_init(s1, r);
    /* XXX: precision analysis */
    K = bf_isqrt(prec.wrapping_div(2 as libc::c_int as libc::c_ulong)) as slimb_t;
    l = prec
        .wrapping_div((2 as libc::c_int as libc::c_long * K) as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong) as slimb_t;
    prec1 = prec
        .wrapping_add((2 as libc::c_int as libc::c_long * K) as libc::c_ulong)
    ...
    if (*a).expn <= -(1 as libc::c_int) as libc::c_long {
        ...
        loop {
            ...
            bf_const_pi(U, prec2 as limb_t, BF_RNDF as libc::c_int as bf_flags_t);
            bf_mul_2exp(
                U,
                -(1 as libc::c_int) as slimb_t,
                ((1 as libc::c_int as limb_t)
            ...
            if mod_0 == 0 as libc::c_int as libc::c_long
                || (*T).expn
                    != -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
                    && (*T).expn + prec2 >= prec1 - 1 as libc::c_int as libc::c_long
            {
                break;
            }
            ...
            cancel = bf_max(
                -(*T).expn,
                (cancel + 1 as libc::c_int as libc::c_long) * 3 as libc::c_int as libc::c_long
                    / 2 as libc::c_int as libc::c_long,
            )
        }
        mod_0 &= 3 as libc::c_int as libc::c_long
    }
    is_neg = (*T).sign;
    ...
    bf_mul_2exp(
        T,
        -(2 as libc::c_int) as libc::c_long * K,
        ((1 as libc::c_int as limb_t)
            << ((1 as libc::c_int) << 6 as libc::c_int) - 2 as libc::c_int)
            .wrapping_sub(2 as libc::c_int as libc::c_ulong)
            .wrapping_add(1 as libc::c_int as libc::c_ulong),
    ...
    */
    ...
    while i >= 1 as libc::c_int as libc::c_long {
        ...
        bf_mul_ui(
            U,
            U,
            (2 as libc::c_int as libc::c_long * i) as uint64_t,
            ((1 as libc::c_int as limb_t)
                << ((1 as libc::c_int) << 6 as libc::c_int) - 2 as libc::c_int)
                .wrapping_sub(2 as libc::c_int as libc::c_ulong)
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
    ...
    */
    ...
    bf_delete(T);
    if !c.is_null() {
        if mod_0 & 1 as libc::c_int as libc::c_long == 0 as libc::c_int as libc::c_long {
            bf_add_si(
                c,
                r,
                1 as libc::c_int as int64_t,
        ...
        (*c).sign = ((*c).sign as libc::c_long ^ mod_0 >> 1 as libc::c_int) as libc::c_int
    }
    if !s.is_null() {
        if mod_0 & 1 as libc::c_int as libc::c_long == 0 as libc::c_int as libc::c_long {
        ...
        (*s).sign = ((*s).sign as libc::c_long ^ mod_0 >> 1 as libc::c_int) as libc::c_int
    }
    bf_delete(r);
    return (1 as libc::c_int) << 4 as libc::c_int;
}
...
pub unsafe extern "C" fn bf_cos(
    ...
    if (*a).expn < 0 as libc::c_int as libc::c_long {
        let mut e: slimb_t = 0;
        e = 2 as libc::c_int as libc::c_long * (*a).expn - 1 as libc::c_int as libc::c_long;
        if (e as libc::c_ulong)
            < prec
                .wrapping_add(2 as libc::c_int as libc::c_ulong)
                .wrapping_neg()
        {
            bf_set_ui(r, 1 as libc::c_int as uint64_t);
            return bf_add_epsilon(r, r, e, 1 as libc::c_int, prec, flags as libc::c_int);
        }
    }
    return bf_ziv_rounding(
        r,
...
pub unsafe extern "C" fn bf_sin(
    ...
    if (*a).expn < 0 as libc::c_int as libc::c_long {
        let mut e: slimb_t = 0;
        e = sat_add(
            2 as libc::c_int as libc::c_long * (*a).expn,
            (*a).expn - 2 as libc::c_int as libc::c_long,
        );
        if e < (*a).expn
            - bf_max(
                prec.wrapping_add(2 as libc::c_int as libc::c_ulong) as slimb_t,
                (*a).len
                    .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_add(2 as libc::c_int as libc::c_ulong) as slimb_t,
            )
        {
            bf_set(r, a);
            return bf_add_epsilon(
...
unsafe extern "C" fn bf_tan_internal(
    ...
    let mut prec1: limb_t = 0;
    /* XXX: precision analysis */
    prec1 = prec.wrapping_add(8 as libc::c_int as libc::c_ulong);
    bf_init(s, T);
...
pub unsafe extern "C" fn bf_tan(
    ...
    if (*a).expn < 0 as libc::c_int as libc::c_long {
        ...
        {
            bf_set(r, a);
            return bf_add_epsilon(r, r, e, (*a).sign, prec, flags as libc::c_int);
        }
    }
    return bf_ziv_rounding(
        r,
...
unsafe extern "C" fn bf_atan_internal(
    ...
    bf_init(s, T); /* a >= 1 */
    cmp_1 = ((*a).expn >= 1 as libc::c_int as libc::c_long) as libc::c_int;
    if cmp_1 != 0 {
        bf_set_ui(T, 1 as libc::c_int as uint64_t);
        bf_div(
            T,
    ...
    */
    ...
    if cmp_1 > 0 as libc::c_int {
        ...
        bf_neg(r);
        i += (1 as libc::c_int - 2 as libc::c_int * (*a).sign) as libc::c_long
    }
    ...
    if i != 0 as libc::c_int as libc::c_long {
        ...
        (*T).sign = (i < 0 as libc::c_int as libc::c_long) as libc::c_int;
        bf_add(
            r,
            T,
            r,
...
unsafe extern "C" fn bf_atan2_internal(
    ...
    let mut ret: libc::c_int = 0;
    if (*y).expn == 9223372036854775807 as libc::c_long
        || (*x).expn == 9223372036854775807 as libc::c_long
    {
        bf_set_nan(r);
        return 0 as libc::c_int;
    }
    ...
    bf_init(s, T);
    prec1 = prec.wrapping_add(32 as libc::c_int as libc::c_ulong);
    if (*y).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        && (*x).expn == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
    {
        bf_set_ui(T, 1 as libc::c_int as uint64_t);
        (*T).sign = (*y).sign ^ (*x).sign
    } else if (*y).expn == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
        && (*x).expn == -(9223372036854775807 as libc::c_long) - 1 as libc::c_int as libc::c_long
    {
        bf_set_zero(T, (*y).sign ^ (*x).sign);
    } else {
        bf_div(T, y, x, prec1, BF_RNDF as libc::c_int as bf_flags_t);
    }
...
unsafe extern "C" fn bf_asin_internal(
    ...
    if (*a).expn >= 0 as libc::c_int as libc::c_long {
        prec2 = ((1 as libc::c_int as limb_t)
            << ((1 as libc::c_int) << 6 as libc::c_int) - 2 as libc::c_int)
            .wrapping_sub(2 as libc::c_int as libc::c_ulong)
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
    } else {
...
pub static mut mp_pow_dec: [limb_t; 20] = [
    1 as libc::c_uint as limb_t,
    10 as libc::c_uint as limb_t,
    100 as libc::c_uint as limb_t,
    1000 as libc::c_uint as limb_t,
    10000 as libc::c_uint as limb_t,
    100000 as libc::c_uint as limb_t,
    1000000 as libc::c_uint as limb_t,
    10000000 as libc::c_uint as limb_t,
    100000000 as libc::c_uint as limb_t,
    1000000000 as libc::c_uint as limb_t,
    10000000000 as libc::c_ulong,
    100000000000 as libc::c_ulong,
    1000000000000 as libc::c_ulong,
    10000000000000 as libc::c_ulong,
    100000000000000 as libc::c_ulong,
    1000000000000000 as libc::c_ulong,
    10000000000000000 as libc::c_ulong,
    100000000000000000 as libc::c_ulong,
    1000000000000000000 as libc::c_ulong,
...
static mut mp_pow_div: [FastDivData; 20] = [
    {
        let mut init = FastDivData {
            m1: 0x1 as libc::c_int as limb_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x999999999999999a as libc::c_ulong,
    ...
    {
        let mut init = FastDivData {
            m1: 0x47ae147ae147ae15 as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x624dd2f1a9fbe77 as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xa36e2eb1c432ca58 as libc::c_ulong,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x4f8b588e368f0847 as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xc6f7a0b5ed8d36c as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xad7f29abcaf48579 as libc::c_ulong,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x5798ee2308c39dfa as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x12e0be826d694b2f as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xb7cdfd9d7bdbab7e as libc::c_ulong,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x5fd7fe17964955fe as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x19799812dea11198 as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xc25c268497681c27 as libc::c_ulong,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x6849b86a12b9b01f as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x203af9ee756159b3 as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xcd2b297d889bc2b7 as libc::c_ulong,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x70ef54646d496893 as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0x2725dd1d243aba0f as libc::c_long as limb_t,
            shift1: 1 as libc::c_int as int8_t,
    ...
    {
        let mut init = FastDivData {
            m1: 0xd83c94fb6d2ac34d as libc::c_ulong,
            shift1: 1 as libc::c_int as int8_t,
...
#[inline]
unsafe extern "C" fn fast_shr_dec(mut a: limb_t, mut shift: libc::c_int) -> limb_t {
...
pub unsafe extern "C" fn mp_add_dec(
    ...
    let mut base: limb_t = 10000000000000000000 as libc::c_ulong;
    let mut i: mp_size_t = 0;
    let mut k: limb_t = 0;
    let mut a: limb_t = 0;
    let mut v: limb_t = 0;
    ...
    while i < n {
        ...
        k = (a <= v) as libc::c_int as limb_t;
        if k == 0 {
            a = (a as libc::c_ulong).wrapping_add(base) as limb_t as limb_t
        }
        *res.offset(i as isize) = a;
        i += 1
    }
...
pub unsafe extern "C" fn mp_mul1_dec(
    ...
    while i < n {
        ...
        t0 = (t0 as libc::c_ulong).wrapping_add(l) as limb_t as limb_t;
        t1 = (t1 as libc::c_ulong)
            .wrapping_add((0 as libc::c_int + (t0 < __t_0) as libc::c_int) as libc::c_ulong)
            as limb_t as limb_t;
        let mut __a0: uint64_t = 0;
        let mut __a1: uint64_t = 0;
        let mut __t0: uint64_t = 0;
        let mut __t1: uint64_t = 0;
        let mut __b: uint64_t = 10000000000000000000 as libc::c_ulong;
        __a0 = t0;
        __a1 = t1;
        __t0 = __a1;
        __t0 = shld(__t0, __a0, 1 as libc::c_int as libc::c_long);
        let mut __t_1: u128 = 0;
        __t_1 = (__t0 as u128).wrapping_mul(17014118346046923173 as libc::c_ulong as u128);
        ...
        __a0 = (__a0 as libc::c_ulong).wrapping_sub(__t0) as uint64_t as uint64_t;
        __a1 = (__a1 as libc::c_ulong)
            .wrapping_sub(__t1.wrapping_add((__a0 > __t_3) as libc::c_int as libc::c_ulong))
            as uint64_t as uint64_t;
        let mut __t_4: limb_t = __a0;
        __a0 = (__a0 as libc::c_ulong)
            .wrapping_sub(__b.wrapping_mul(2 as libc::c_int as libc::c_ulong))
            as uint64_t as uint64_t;
        __a1 = (__a1 as libc::c_ulong)
            .wrapping_sub((1 as libc::c_int + (__a0 > __t_4) as libc::c_int) as libc::c_ulong)
            as uint64_t as uint64_t;
        __t0 = (__a1 as slimb_t >> 1 as libc::c_int) as uint64_t;
        l = (l as libc::c_ulong)
            .wrapping_add((2 as libc::c_int as libc::c_ulong).wrapping_add(__t0))
            as limb_t as limb_t;
        let mut __t_5: limb_t = __a0;
        __a0 = (__a0 as libc::c_ulong).wrapping_add(__b & __t0) as uint64_t as uint64_t;
        __a1 = (__a1 as libc::c_ulong)
            .wrapping_add((0 as libc::c_int + (__a0 < __t_5) as libc::c_int) as libc::c_ulong)
            as uint64_t as uint64_t;
        l = (l as libc::c_ulong).wrapping_add(__a1) as limb_t as limb_t;
        __a0 = (__a0 as libc::c_ulong).wrapping_add(__b & __a1) as uint64_t as uint64_t;
        r = __a0;
...
pub unsafe extern "C" fn mp_add_mul1_dec(
    ...
    while i < n {
        ...
        t0 = (t0 as libc::c_ulong).wrapping_add(*tabr.offset(i as isize)) as limb_t as limb_t;
        t1 = (t1 as libc::c_ulong)
            .wrapping_add((0 as libc::c_int + (t0 < __t_1) as libc::c_int) as libc::c_ulong)
            as limb_t as limb_t;
        let mut __a0: uint64_t = 0;
        let mut __a1: uint64_t = 0;
        let mut __t0: uint64_t = 0;
        ...
        __t0 = shld(__t0, __a0, 1 as libc::c_int as libc::c_long);
        let mut __t_2: u128 = 0;
        __t_2 = (__t0 as u128).wrapping_mul(17014118346046923173 as libc::c_ulong as u128);
        ...
        __a0 = (__a0 as libc::c_ulong).wrapping_sub(__t0) as uint64_t as uint64_t;
        __a1 = (__a1 as libc::c_ulong)
            .wrapping_sub(__t1.wrapping_add((__a0 > __t_4) as libc::c_int as libc::c_ulong))
            as uint64_t as uint64_t;
        let mut __t_5: limb_t = __a0;
        __a0 = (__a0 as libc::c_ulong)
            .wrapping_sub(__b.wrapping_mul(2 as libc::c_int as libc::c_ulong))
            as uint64_t as uint64_t;
        __a1 = (__a1 as libc::c_ulong)
            .wrapping_sub((1 as libc::c_int + (__a0 > __t_5) as libc::c_int) as libc::c_ulong)
            as uint64_t as uint64_t;
        __t0 = (__a1 as slimb_t >> 1 as libc::c_int) as uint64_t;
        l = (l as libc::c_ulong)
            .wrapping_add((2 as libc::c_int as libc::c_ulong).wrapping_add(__t0))
        ...
        __a0 = (__a0 as libc::c_ulong).wrapping_add(__b & __t0) as uint64_t as uint64_t;
        __a1 = (__a1 as libc::c_ulong)
            .wrapping_add((0 as libc::c_int + (__a0 < __t_6) as libc::c_int) as libc::c_ulong)
            as uint64_t as uint64_t;
        l = (l as libc::c_ulong).wrapping_add(__a1) as limb_t as limb_t;
        __a0 = (__a0 as libc::c_ulong).wrapping_add(__b & __a1) as uint64_t as uint64_t;
        r = __a0;
...
pub unsafe extern "C" fn mp_sub_mul1_dec(
    ...
    while i < n {
        ...
        l = (l as libc::c_ulong).wrapping_add(c) as limb_t as limb_t;
...
pub unsafe extern "C" fn mp_div1_dec(
    ...
    let mut q: limb_t = 0;
    let mut shift: libc::c_int = 0;
    if b == 2 as libc::c_int as libc::c_ulong {
        ...
        while i >= 0 as libc::c_int as libc::c_long {
            ...
            *tabr.offset(i as isize) = (t0 >> 1 as libc::c_int).wrapping_add(r);
            r = 0 as libc::c_int as limb_t;
            if t0 & 1 as libc::c_int as libc::c_ulong != 0 {
                r = base_div2
            }
            i -= 1
        }
        if r != 0 {
            r = 1 as libc::c_int as limb_t
        }
        ...
        if shift == 0 as libc::c_int {
            ...
            while i >= 0 as libc::c_int as libc::c_long {
                ...
                t1 = (__t >> 64 as libc::c_int) as limb_t;
                let mut __t_0: limb_t = t0;
                t0 = (t0 as libc::c_ulong).wrapping_add(*taba.offset(i as isize)) as limb_t
                    as limb_t;
                t1 = (t1 as libc::c_ulong)
                    .wrapping_add((0 as libc::c_int + (t0 < __t_0) as libc::c_int) as libc::c_ulong)
                    as limb_t as limb_t;
            ...
            while i >= 0 as libc::c_int as libc::c_long {
                ...
                t0 = (t0 as libc::c_ulong).wrapping_add(*taba.offset(i as isize)) as limb_t
                    as limb_t;
                t1 = (t1 as libc::c_ulong)
                    .wrapping_add((0 as libc::c_int + (t0 < __t_2) as libc::c_int) as libc::c_ulong)
                    as limb_t as limb_t;
                t1 = t1 << shift | t0 >> ((1 as libc::c_int) << 6 as libc::c_int) - shift;
                t0 <<= shift;
        ...
        while i >= 0 as libc::c_int as libc::c_long {
            ...
            t0 = (t0 as libc::c_ulong).wrapping_add(*taba.offset(i as isize)) as limb_t as limb_t;
            t1 = (t1 as libc::c_ulong)
                .wrapping_add((0 as libc::c_int + (t0 < __t_4) as libc::c_int) as libc::c_ulong)
                as limb_t as limb_t;
...
unsafe extern "C" fn mp_div_dec(
    ...
    if r >= (10000000000000000000 as libc::c_ulong).wrapping_div(2 as libc::c_int as libc::c_ulong)
    {
        ...
        *tabq.offset(i as isize) = q;
        ...
        mult = base.wrapping_div(r.wrapping_add(1 as libc::c_int as libc::c_ulong));
        if (nb <= 16 as libc::c_int as libc::c_long) as libc::c_int as libc::c_long != 0 {
            tabb = static_tabb.as_mut_ptr()
        } else {
            tabb = bf_malloc(
                s,
                (::std::mem::size_of::<limb_t>() as libc::c_ulong)
                    .wrapping_mul(nb as libc::c_ulong),
            ) as *mut limb_t;
            if tabb.is_null() {
                return -(1 as libc::c_int);
            }
        ...
        *taba.offset(na as isize) = mp_mul1_dec(taba, taba, na, mult, 0 as libc::c_int as limb_t)
    }
    while i >= 0 as libc::c_int as libc::c_long {
        if (*taba.offset((i + nb) as isize)
            >= *tabb.offset((nb - 1 as libc::c_int as libc::c_long) as isize))
            as libc::c_int as libc::c_long
            != 0
        {
            /* XXX: check if it is really possible */
            q = base.wrapping_sub(1 as libc::c_int as libc::c_ulong)
        } else {
            let mut __t: u128 = 0;
            ...
            t1 = (__t >> 64 as libc::c_int) as limb_t;
            let mut __t_0: limb_t = t0;
            t0 = (t0 as libc::c_ulong)
                .wrapping_add(*taba.offset((i + nb - 1 as libc::c_int as libc::c_long) as isize))
                as limb_t as limb_t;
            t1 = (t1 as libc::c_ulong)
                .wrapping_add((0 as libc::c_int + (t0 < __t_0) as libc::c_int) as libc::c_ulong)
                as limb_t as limb_t;
            let mut __t_1: u128 = 0;
            let mut __b: limb_t = *tabb.offset((nb - 1 as libc::c_int as libc::c_long) as isize);
    ...
    if mult != 1 as libc::c_int as libc::c_ulong {
        mp_div1_dec(taba, taba, nb, mult, 0 as libc::c_int as limb_t);
        if (tabb != static_tabb.as_mut_ptr()) as libc::c_int as libc::c_long != 0 {
...
unsafe extern "C" fn mp_shr_dec(
    ...
    while i >= 0 as libc::c_int as libc::c_long {
        ...
        *tab_r.offset(i as isize) = q.wrapping_add(l.wrapping_mul(
            mp_pow_dec[(19 as libc::c_int as libc::c_ulong).wrapping_sub(shift) as usize],
        ));
        l = r;
        i -= 1
    }
...
unsafe extern "C" fn mp_shl_dec(
    ...
    while i < n {
        ...
        q = fast_shr_dec(
            a,
            (19 as libc::c_int as libc::c_ulong).wrapping_sub(shift) as libc::c_int,
        );
        r = a.wrapping_sub(q.wrapping_mul(
            mp_pow_dec[(19 as libc::c_int as libc::c_ulong).wrapping_sub(shift) as usize],
        ));
...
unsafe extern "C" fn mp_sqrtrem2_dec(mut tabs: *mut limb_t, mut taba: *mut limb_t) -> limb_t {
    ...
    a = (*taba.offset(1 as libc::c_int as isize) as dlimb_t)
        .wrapping_mul(10000000000000000000 as libc::c_ulong as u128)
        .wrapping_add(*taba.offset(0 as libc::c_int as isize) as u128);
    k = clz((a >> ((1 as libc::c_int) << 6 as libc::c_int)) as limb_t) & !(1 as libc::c_int);
    b = a << k;
    taba1[0 as libc::c_int as usize] = b as limb_t;
    taba1[1 as libc::c_int as usize] = (b >> ((1 as libc::c_int) << 6 as libc::c_int)) as limb_t;
    ...
    __t0 = shld(__t0, __a0, 1 as libc::c_int as libc::c_long);
    let mut __t: u128 = 0;
    __t = (__t0 as u128).wrapping_mul(17014118346046923173 as libc::c_ulong as u128);
    ...
    __a0 = (__a0 as libc::c_ulong).wrapping_sub(__t0) as uint64_t as uint64_t;
    __a1 = (__a1 as libc::c_ulong)
        .wrapping_sub(__t1.wrapping_add((__a0 > __t_1) as libc::c_int as libc::c_ulong))
        as uint64_t as uint64_t;
    let mut __t_2: limb_t = __a0;
    __a0 = (__a0 as libc::c_ulong).wrapping_sub(__b.wrapping_mul(2 as libc::c_int as libc::c_ulong))
        as uint64_t as uint64_t;
    __a1 = (__a1 as libc::c_ulong)
        .wrapping_sub((1 as libc::c_int + (__a0 > __t_2) as libc::c_int) as libc::c_ulong)
        as uint64_t as uint64_t;
    __t0 = (__a1 as slimb_t >> 1 as libc::c_int) as uint64_t;
    r1 = (r1 as libc::c_ulong).wrapping_add((2 as libc::c_int as libc::c_ulong).wrapping_add(__t0))
        as limb_t as limb_t;
    let mut __t_3: limb_t = __a0;
    __a0 = (__a0 as libc::c_ulong).wrapping_add(__b & __t0) as uint64_t as uint64_t;
    __a1 = (__a1 as libc::c_ulong)
        .wrapping_add((0 as libc::c_int + (__a0 < __t_3) as libc::c_int) as libc::c_ulong)
        as uint64_t as uint64_t;
    r1 = (r1 as libc::c_ulong).wrapping_add(__a1) as limb_t as limb_t;
    __a0 = (__a0 as libc::c_ulong).wrapping_add(__b & __a1) as uint64_t as uint64_t;
    r0 = __a0;
...
unsafe extern "C" fn mp_sqrtrem_rec_dec(
    ...
    rh = (rh as libc::c_ulong).wrapping_sub(mp_sub_ui_dec(
        taba.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(l) as isize),
        c,
        n.wrapping_sub((2 as libc::c_int as libc::c_ulong).wrapping_mul(l)) as mp_size_t,
    )) as limb_t as limb_t;
    if (rh as slimb_t) < 0 as libc::c_int as libc::c_long {
        ...
        rh = (rh as libc::c_ulong).wrapping_add(mp_add_mul1_dec(
            taba,
            tabs,
            n as mp_size_t,
            2 as libc::c_int as limb_t,
        )) as limb_t as limb_t;
        rh = (rh as libc::c_ulong).wrapping_add(mp_add_ui_dec(
            taba,
            1 as libc::c_int as limb_t,
            n as mp_size_t,
        )) as limb_t as limb_t
...
unsafe extern "C" fn clz_dec(mut a: limb_t) -> libc::c_int {
    ...
    match ((1 as libc::c_int) << 6 as libc::c_int) - 1 as libc::c_int - clz(a) {
        ...
        3 => {
            /* 8-15 */
            if a < 10 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 1 as libc::c_int;
            } else {
        ...
        6 => {
            /* 64-127 */
            if a < 100 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 2 as libc::c_int;
            } else {
        ...
        9 => {
            /* 512-1023 */
            if a < 1000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 3 as libc::c_int;
            } else {
        ...
        13 => {
            /* 8192-16383 */
            if a < 10000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 4 as libc::c_int;
            } else {
        ...
        16 => {
            /* 65536-131071 */
            if a < 100000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 5 as libc::c_int;
            } else {
        ...
        19 => {
            /* 524288-1048575 */
            if a < 1000000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 6 as libc::c_int;
            } else {
        ...
        23 => {
            /* 8388608-16777215 */
            if a < 10000000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 7 as libc::c_int;
            } else {
        ...
        26 => {
            /* 67108864-134217727 */
            if a < 100000000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 8 as libc::c_int;
            } else {
        ...
        29 => {
            ...
            if a < 1000000000 as libc::c_int as libc::c_ulong {
                return 19 as libc::c_int - 9 as libc::c_int;
            } else {
        ...
        33 => {
            ...
            if a < 10000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 10 as libc::c_int;
            } else {
        ...
        36 => {
            ...
            if a < 100000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 11 as libc::c_int;
            } else {
        ...
        39 => {
            ...
            if a < 1000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 12 as libc::c_int;
            } else {
        ...
        43 => {
            ...
            if a < 10000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 13 as libc::c_int;
            } else {
        ...
        46 => {
            ...
            if a < 100000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 14 as libc::c_int;
            } else {
        ...
        49 => {
            ...
            if a < 1000000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 15 as libc::c_int;
            } else {
        ...
        53 => {
            ...
            if a < 10000000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 16 as libc::c_int;
            } else {
        ...
        56 => {
            ...
            if a < 100000000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 17 as libc::c_int;
            } else {
        ...
        59 => {
            ...
            if a < 1000000000000000000 as libc::c_long as libc::c_ulong {
                return 19 as libc::c_int - 18 as libc::c_int;
            } else {
                return 19 as libc::c_int - 19 as libc::c_int;
            }
        }
...
pub unsafe extern "C" fn bfdec_print_str(mut str: *const libc::c_char, mut a: *const bfdec_t) {
    ...
    if (*a).expn == 9223372036854775807 as libc::c_long {
            ...
            == 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
        {
            ...
            while i >= 0 as libc::c_int as libc::c_long {
                printf(
                    b"%0*lu\x00" as *const u8 as *const libc::c_char,
                    19 as libc::c_int,
                    *(*a).tab.offset(i as isize),
                );
                i -= 1
            }
            printf(b"e%ld\x00" as *const u8 as *const libc::c_char, (*a).expn);
        }
    }
    printf(b"\n\x00" as *const u8 as *const libc::c_char);
}
...
unsafe extern "C" fn scan_digit_nz(mut r: *const bfdec_t, mut bit_pos: slimb_t) -> limb_t {
    ...
    let mut q: limb_t = 0;
    let mut shift: libc::c_int = 0;
    if bit_pos < 0 as libc::c_int as libc::c_long {
        return 0 as libc::c_int as limb_t;
    }
    pos = (bit_pos as limb_t).wrapping_div(19 as libc::c_int as libc::c_ulong) as slimb_t;
    shift = (bit_pos as limb_t).wrapping_rem(19 as libc::c_int as libc::c_ulong) as libc::c_int;
    q = fast_shr_dec(*(*r).tab.offset(pos as isize), shift + 1 as libc::c_int);
    v = (*(*r).tab.offset(pos as isize))
        .wrapping_sub(q.wrapping_mul(mp_pow_dec[(shift + 1 as libc::c_int) as usize]));
    if v != 0 as libc::c_int as libc::c_ulong {
        return 1 as libc::c_int as limb_t;
    }
    pos -= 1;
...
unsafe extern "C" fn get_digit(
    ...
    shift = (pos - i * 19 as libc::c_int as libc::c_long) as libc::c_int;
    return fast_shr_dec(*tab.offset(i as isize), shift)
...
unsafe extern "C" fn bfdec_get_rnd_add(
    ...
    /* faithful rounding does not honor the INEXACT flag */
        ...
        digit0 = scan_digit_nz(
            r,
            l.wrapping_mul(19 as libc::c_int as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                .wrapping_sub(bf_max(
                    0 as libc::c_int as slimb_t,
                    prec + 1 as libc::c_int as libc::c_long,
    ...
    inexact = (digit1 | digit0 != 0 as libc::c_int as libc::c_ulong) as libc::c_int;
    add_one = 0 as libc::c_int;
    match rnd_mode {
        1 => {}
        0 => {
            if digit1 == 5 as libc::c_int as libc::c_ulong {
                if digit0 != 0 {
                    add_one = 1 as libc::c_int
                } else {
                    /* round to even */
            ...
            } else if digit1 > 5 as libc::c_int as libc::c_ulong {
                add_one = 1 as libc::c_int
            }
        }
        2 | 3 => {
        ...
        4 | 6 => add_one = (digit1 >= 5 as libc::c_int as libc::c_ulong) as libc::c_int,
        5 => add_one = inexact,
        _ => {
            abort();
        }
...
unsafe extern "C" fn __bfdec_round(
    ...
    /* round to prec bits */
    rnd_mode = (flags & 0x7 as libc::c_int as libc::c_uint) as libc::c_int; /* cannot fail because r is non zero */
    ret = 0 as libc::c_int;
    add_one = bfdec_get_rnd_add(&mut ret, r, l, prec, rnd_mode);
    if prec <= 0 as libc::c_int as libc::c_long {
        if add_one != 0 {
            bfdec_resize(r, 1 as libc::c_int as limb_t);
            *(*r).tab.offset(0 as libc::c_int as isize) = (10000000000000000000 as libc::c_ulong)
        ...
        if add_one != 0 {
            ...
            /* add one starting at digit 'prec - 1' */
            bit_pos = l
                .wrapping_mul(19 as libc::c_int as libc::c_ulong)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                .wrapping_sub((prec - 1 as libc::c_int as libc::c_long) as libc::c_ulong)
                as slimb_t;
            pos = bit_pos / 19 as libc::c_int as libc::c_long;
            carry = mp_pow_dec[(bit_pos % 19 as libc::c_int as libc::c_long) as usize];
            carry = mp_add_ui_dec(
                (*r).tab.offset(pos as isize),
                carry,
                l.wrapping_sub(pos as libc::c_ulong) as mp_size_t,
            );
            if carry != 0 {
                /* shift right by one digit */
                mp_shr_dec(
        ...
        match current_block {
            ...
            _ => {
                ...
                if i >= 0 as libc::c_int as libc::c_long {
                    shift = smod(bit_pos, 19 as libc::c_int as slimb_t) as libc::c_int;
                    if shift != 0 as libc::c_int {
                        *(*r).tab.offset(i as isize) =
...
#[no_mangle]
pub unsafe extern "C" fn bfdec_set_ui(mut r: *mut bfdec_t, mut v: uint64_t) -> libc::c_int {
    let mut current_block: u64;
    if v >= 10000000000000000000 as libc::c_ulong {
        if bfdec_resize(r, 2 as libc::c_int as limb_t) != 0 {
            current_block = 13411379657240756855;
        } else {
            *(*r).tab.offset(0 as libc::c_int as isize) =
                v.wrapping_rem(10000000000000000000 as libc::c_ulong);
            *(*r).tab.offset(1 as libc::c_int as isize) =
                v.wrapping_div(10000000000000000000 as libc::c_ulong);
...
#[no_mangle]
pub unsafe extern "C" fn bfdec_set_si(mut r: *mut bfdec_t, mut v: int64_t) -> libc::c_int {
    let mut ret: libc::c_int = 0;
        ...
        && (*a).expn < 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long
    {
            ...
            || (*b).len == 0 as libc::c_int as libc::c_ulong
        {
            ...
            r_len = bf_max(
                (*a).len as slimb_t,
                (*b).len.wrapping_add(
                    ((d + 19 as libc::c_int as libc::c_long - 1 as libc::c_int as libc::c_long)
                        / 19 as libc::c_int as libc::c_long) as libc::c_ulong,
                ) as slimb_t,
            );
            if bfdec_resize(r, r_len as limb_t) != 0 {
                ...
                (*r).sign = a_sign;
                (*r).expn = (*a).expn;
                a_offset = (r_len as libc::c_ulong).wrapping_sub((*a).len) as slimb_t;
                i = 0 as libc::c_int as slimb_t;
                while i < a_offset {
                ...
                b_shift = (d % 19 as libc::c_int as libc::c_long) as libc::c_int;
                if b_shift == 0 as libc::c_int {
                    b1_len = (*b).len as mp_size_t;
                    b1_tab = (*b).tab;
                    current_block = 2516253395664191498;
                } else {
                    b1_len = (*b).len.wrapping_add(1 as libc::c_int as libc::c_ulong) as mp_size_t;
                    b1_tab = bf_malloc(
                        s,
                        (::std::mem::size_of::<limb_t>() as libc::c_ulong)
                            .wrapping_mul(b1_len as libc::c_ulong),
                    ) as *mut limb_t;
                    if b1_tab.is_null() {
                        current_block = 5503229294326981584;
                    } else {
                        *b1_tab.offset(0 as libc::c_int as isize) = mp_shr_dec(
                            b1_tab.offset(1 as libc::c_int as isize),
                            (*b).tab,
                            (*b).len as mp_size_t,
                            b_shift as limb_t,
                            0 as libc::c_int as limb_t,
                        )
                        .wrapping_mul(mp_pow_dec[(19 as libc::c_int - b_shift) as usize]);
                        current_block = 2516253395664191498;
                    }
                }
                match current_block {
                    5503229294326981584 => {}
                    _ => {
                        b_offset = (r_len as libc::c_ulong).wrapping_sub((*b).len.wrapping_add(
                            ((d + 19 as libc::c_int as libc::c_long
                                - 1 as libc::c_int as libc::c_long)
                        ...
                        if is_sub != 0 {
                            ...
                            if carry != 0 as libc::c_int as libc::c_ulong {
                                if bfdec_resize(
                                    r,
                                    (r_len + 1 as libc::c_int as libc::c_long) as limb_t,
                                ) != 0
                                {
                                    if b_shift != 0 as libc::c_int {
                                    ...
                                    *(*r).tab.offset(r_len as isize) = 1 as libc::c_int as limb_t;
                                    (*r).expn += 19 as libc::c_int as libc::c_long;
                                    current_block = 13484060386966298149;
                                }
                            } else {
                                current_block = 13484060386966298149;
...
unsafe extern "C" fn __bfdec_div(
            ...
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
    {
        ...
        result */
        /* XXX: check */
        precl = nb.wrapping_add(1 as libc::c_int as libc::c_ulong)
    } else if flags & ((1 as libc::c_int) << 4 as libc::c_int) as libc::c_uint != 0 {
        /* number of digits after the decimal point */
        /* XXX: check (2 extra digits for rounding + 2 digits) */
        precl = ((bf_max((*a).expn - (*b).expn, 0 as libc::c_int as slimb_t)
            + 2 as libc::c_int as libc::c_long) as libc::c_ulong)
            .wrapping_add(prec)
            .wrapping_add(2 as libc::c_int as libc::c_ulong)
            .wrapping_add(19 as libc::c_int as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(19 as libc::c_int as libc::c_ulong)
    } else {
    ...
    if !taba.is_null() {
        ...
        if !(bfdec_resize(r, n.wrapping_add(1 as libc::c_int as libc::c_ulong)) != 0) {
            ...
            ) != 0)
            {
                ...
                i = 0 as libc::c_int as limb_t;
                while i < nb {
                    if *taba.offset(i as isize) != 0 as libc::c_int as libc::c_ulong {
                        break;
                    }
                    i = i.wrapping_add(1)
                }
                ...
                if i != nb {
                            ...
                            .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    {
                        ...
                        let ref mut fresh9 = *(*r).tab.offset(0 as libc::c_int as isize);
                        *fresh9 |= 1 as libc::c_int as libc::c_ulong
                    }
                }
                (*r).expn = (*a).expn - (*b).expn + 19 as libc::c_int as libc::c_long;
                (*r).sign = r_sign;
                ret = bfdec_normalize_and_round(r, prec, flags);
                return ret;
            }
...
unsafe extern "C" fn bfdec_tdivremu(
    ...
    if bfdec_cmpu(a, b) < 0 as libc::c_int {
        ...
        bfdec_div(
            ...
            b,
            0 as libc::c_int as limb_t,
            (BF_RNDZ as libc::c_int | (1 as libc::c_int) << 4 as libc::c_int) as bf_flags_t,
        );
        bfdec_mul(
            r,
            q,
...
/* convert to integer (infinite precision) */
#[no_mangle]
pub unsafe extern "C" fn bfdec_rint(mut r: *mut bfdec_t, mut rnd_mode: libc::c_int) -> libc::c_int {
    return bfdec_round(
        r,
        0 as libc::c_int as limb_t,
        (rnd_mode | (1 as libc::c_int) << 4 as libc::c_int) as bf_flags_t,
...
pub unsafe extern "C" fn bfdec_sqrt(
                ...
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
    {
        ...
        /* convert the mantissa to an integer with at least 2 *
        prec + 4 digits */
        n = (2 as libc::c_int as libc::c_long * (prec1 + 2 as libc::c_int as libc::c_long)
            + (2 as libc::c_int * 19 as libc::c_int) as libc::c_long
            - 1 as libc::c_int as libc::c_long)
            / (2 as libc::c_int * 19 as libc::c_int) as libc::c_long;
        if bfdec_resize(r, n as limb_t) != 0 {
            ...
            if a1.is_null() {
                ...
                if n > 1 as libc::c_int as libc::c_long {
                    v = *a1.offset(
                        (2 as libc::c_int as libc::c_long * n - 1 as libc::c_int as libc::c_long)
                            as isize,
                    );
                    while v
                        < (10000000000000000000 as libc::c_ulong)
                    ...
                    {
                        k += 1;
                        v = (v as libc::c_ulong).wrapping_mul(4 as libc::c_int as libc::c_ulong)
                            as limb_t as limb_t
                    }
                    if k != 0 as libc::c_int {
                        mp_mul1_dec(
                            ...
                            a1,
                            2 as libc::c_int as libc::c_long * n,
                            ((1 as libc::c_int) << 2 as libc::c_int * k) as limb_t,
                            0 as libc::c_int as limb_t,
                        );
                    }
                }
                if mp_sqrtrem_dec(s, (*r).tab, a1, n as limb_t) != 0 {
                    ...
                    if res != 0 as libc::c_int as libc::c_ulong {
                        let ref mut fresh10 = *(*r).tab.offset(0 as libc::c_int as isize);
...
#[no_mangle]
pub unsafe extern "C" fn bfdec_get_int32(
    mut pres: *mut libc::c_int,
    mut a: *const bfdec_t,
) -> libc::c_int {
    let mut v: uint32_t = 0;
    ...
    if (*a).expn >= 9223372036854775807 as libc::c_long - 1 as libc::c_int as libc::c_long {
        ...
        v = 0 as libc::c_int as uint32_t;
        ret = 0 as libc::c_int
    } else if (*a).expn <= 9 as libc::c_int as libc::c_long {
        v = fast_shr_dec(
            *(*a)
                .tab
                .offset((*a).len.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize),
            (19 as libc::c_int as libc::c_long - (*a).expn) as libc::c_int,
        ) as uint32_t;
        if (*a).sign != 0 {
            v = v.wrapping_neg()
        }
        ret = 0 as libc::c_int
    } else if (*a).expn == 10 as libc::c_int as libc::c_long {
        let mut v1: uint64_t = 0;
        ...
        v_max = (2147483647 as libc::c_int as uint32_t).wrapping_add((*a).sign as libc::c_uint);
        if v1 > v_max as libc::c_ulong {
            v = v_max;
            ret = (1 as libc::c_int) << 2 as libc::c_int
        } else {
            v = v1 as uint32_t;
...
unsafe extern "C" fn add_mod(mut a: limb_t, mut b: limb_t, mut m: limb_t) -> limb_t {
    ...
    r = a.wrapping_add(b);
    if r >= m {
        r = (r as libc::c_ulong).wrapping_sub(m) as limb_t as limb_t
    }
    return r;
}
...
unsafe extern "C" fn sub_mod(mut a: limb_t, mut b: limb_t, mut m: limb_t) -> limb_t {
    ...
    r = a.wrapping_sub(b);
    if r > a {
        r = (r as libc::c_ulong).wrapping_add(m) as limb_t as limb_t
    }
    return r;
}
...
unsafe extern "C" fn mod_fast(mut r: dlimb_t, mut m: limb_t, mut m_inv: limb_t) -> limb_t {
    ...
    q = ((a1 as dlimb_t).wrapping_mul(m_inv as u128) >> ((1 as libc::c_int) << 6 as libc::c_int))
        as limb_t;
    r = r
        .wrapping_sub((q as dlimb_t).wrapping_mul(m as u128))
        .wrapping_sub(m.wrapping_mul(2 as libc::c_int as libc::c_ulong) as u128);
    ...
    r0 = r as limb_t;
    r1 = (r >> ((1 as libc::c_int) << 6 as libc::c_int)) as limb_t;
    r0 = (r0 as libc::c_ulong).wrapping_add(m & r1) as limb_t as limb_t;
    return r0;
}
...
unsafe extern "C" fn mul_mod_fast2(
    ...
    let mut r: limb_t = 0;
    let mut q: limb_t = 0;
    q = ((a as dlimb_t).wrapping_mul(b_inv as dlimb_t) >> ((1 as libc::c_int) << 6 as libc::c_int))
        as limb_t;
...
unsafe extern "C" fn init_mul_mod_fast2(mut b: limb_t, mut m: limb_t) -> limb_t {
    return ((b as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int)).wrapping_div(m as u128)
        as limb_t;
}
unsafe extern "C" fn ntt_malloc(mut s: *mut BFNTTState, mut size: size_t) -> *mut libc::c_void {
    return bf_malloc((*s).ctx, size);
}
unsafe extern "C" fn ntt_free(mut s: *mut BFNTTState, mut ptr: *mut libc::c_void) {
    bf_free((*s).ctx, ptr);
}
#[inline]
unsafe extern "C" fn ntt_limb_to_int(mut a: NTTLimb, mut m: limb_t) -> limb_t {
    if a >= m {
        a = (a as libc::c_ulong).wrapping_sub(m) as NTTLimb as NTTLimb
    }
    return a;
}
#[inline]
...
unsafe extern "C" fn ntt_fft(
    ...
    m2 = (2 as libc::c_int as libc::c_ulong).wrapping_mul(m);
    n = (1 as libc::c_int as limb_t) << fft_len_log2;
    nb_blocks = n;
    fft_per_block = 1 as libc::c_int as limb_t;
    stride_in = n.wrapping_div(2 as libc::c_int as libc::c_ulong);
    tab_in = in_buf;
    tab_out = tmp_buf;
    l = fft_len_log2;
    while nb_blocks != 2 as libc::c_int as libc::c_ulong {
        ...
        while i < nb_blocks {
            ...
            k = (k as libc::c_ulong).wrapping_add(fft_per_block) as limb_t as limb_t;
            p = (p as libc::c_ulong)
                .wrapping_add((2 as libc::c_int as libc::c_ulong).wrapping_mul(fft_per_block))
                as limb_t as limb_t;
            i = i.wrapping_add(1)
        }
...
unsafe extern "C" fn ntt_vec_mul(
    ...
    norm = (*s).ntt_len_inv[m_idx as usize][k_tot as usize][0 as libc::c_int as usize];
    norm_inv = (*s).ntt_len_inv[m_idx as usize][k_tot as usize][1 as libc::c_int as usize];
    n = (1 as libc::c_int as limb_t) << fft_len_log2;
    i = 0 as libc::c_int as limb_t;
    while i < n {
        ...
        if a >= m {
            a = (a as libc::c_ulong).wrapping_sub(m) as limb_t as limb_t
        }
...
unsafe extern "C" fn get_trig(
    ...
    i = 0 as libc::c_int as limb_t;
    while i < n2 {
        *tab.offset((2 as libc::c_int as libc::c_ulong).wrapping_mul(i) as isize) =
            int_to_ntt_limb(c as slimb_t, m);
        *tab.offset(
            (2 as libc::c_int as libc::c_ulong)
                .wrapping_mul(i)
...
unsafe extern "C" fn ntt_fft_partial(
    ...
    buf3 = ntt_malloc(
        s,
        (::std::mem::size_of::<NTTLimb>() as libc::c_ulong).wrapping_mul(n1),
    ) as *mut NTTLimb;
    if !buf3.is_null() {
        if k2 == 0 as libc::c_int {
            if ntt_fft(s, buf1, buf1, buf3, k1, inverse, m_idx as libc::c_int) != 0 {
            ...
            if buf2.is_null() {
                ...
                's_71: loop {
                    ...
                    j = (j as libc::c_ulong).wrapping_add(strip_len) as limb_t as limb_t
                }
                match current_block {
                    7202299292956205343 => {}
                    _ => {
...
unsafe extern "C" fn ntt_conv(
    ...
    if k <= 19 as libc::c_int {
        ...
        k1 = bf_min(
            (k / 2 as libc::c_int) as slimb_t,
            19 as libc::c_int as slimb_t,
        ) as libc::c_int
    }
    k2 = k - k1;
...
unsafe extern "C" fn limb_to_ntt(
    ...
    n = bf_min(
        ...
        a_len
            .wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
            .wrapping_add(dpl as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(dpl as libc::c_ulong) as slimb_t,
    );
    i = 0 as libc::c_int as slimb_t;
    while i < n {
        a0 = get_bits(taba, a_len, i * dpl as libc::c_long);
        if dpl <= (1 as libc::c_int) << 6 as libc::c_int {
            ...
            a1 = get_bits(
                taba,
                a_len,
                i * dpl as libc::c_long + ((1 as libc::c_int) << 6 as libc::c_int) as libc::c_long,
            );
            if dpl <= ((1 as libc::c_int) << 6 as libc::c_int) + 61 as libc::c_int {
                a = a0 as u128
                    | ((a1 & base_mask1) as dlimb_t) << ((1 as libc::c_int) << 6 as libc::c_int)
            } else {
                if dpl > 2 as libc::c_int * ((1 as libc::c_int) << 6 as libc::c_int) {
                    a2 = get_bits(
                        taba,
                        a_len,
                        i * dpl as libc::c_long
                            + (((1 as libc::c_int) << 6 as libc::c_int) * 2 as libc::c_int)
                                as libc::c_long,
                    ) & base_mask1
                } else {
                    a1 &= base_mask1;
                    a2 = 0 as libc::c_int as limb_t
                }
                //            printf("a=0x%016lx%016lx%016lx\n", a2, a1, a0);
                a = (a0
                    >> ((1 as libc::c_int) << 6 as libc::c_int) - 62 as libc::c_int
                        + 61 as libc::c_int) as u128
                    | (a1 as dlimb_t) << 62 as libc::c_int - 61 as libc::c_int
                    | (a2 as dlimb_t)
                        << ((1 as libc::c_int) << 6 as libc::c_int) + 62 as libc::c_int
        ...
        while j < nb_mods {
            ...
            *tabr.offset(
                (i as libc::c_ulong).wrapping_add((j as libc::c_ulong).wrapping_mul(fft_len))
                    as isize,
...
unsafe extern "C" fn ntt_to_limb(
    ...
    let mut t: dlimb_t = 0;
    j = 5 as libc::c_int * (5 as libc::c_int - 1 as libc::c_int) / 2 as libc::c_int
    ...
    n_limb1 = (dpl as libc::c_uint)
        .wrapping_sub(1 as libc::c_int as libc::c_uint)
        .wrapping_div(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_uint)
        as libc::c_int;
    j = 0 as libc::c_int;
    ...
    while i < len {
        ...
        while j < nb_mods {
            y[j as usize] = ntt_limb_to_int(
                *buf.offset(
                    (i as libc::c_ulong).wrapping_add(fft_len.wrapping_mul(j as libc::c_ulong))
                        as isize,
                ),
        ...
        u[0 as libc::c_int as usize] = y[(nb_mods - 1 as libc::c_int) as usize];
        l = 1 as libc::c_int;
        ...
        if shift == 0 as libc::c_int {
            ...
            while j < nb_mods {
                carry[(j - (n_limb1 + 1 as libc::c_int)) as usize] = u[j as usize];
                j += 1
            }
        } else {
            j = n_limb1;
...
unsafe extern "C" fn ntt_static_init(mut s1: *mut bf_context_t) -> libc::c_int {
    ...
    s = bf_malloc(s1, ::std::mem::size_of::<BFNTTState>() as libc::c_ulong) as *mut BFNTTState;
    if s.is_null() {
        return -(1 as libc::c_int);
    }
    ...
    while j < 5 as libc::c_int {
        ...
        while i <= 51 as libc::c_int {
            (*s).ntt_len_inv[j as usize][i as usize][0 as libc::c_int as usize] = c_inv;
            (*s).ntt_len_inv[j as usize][i as usize][1 as libc::c_int as usize] =
        ...
        while inverse < 2 as libc::c_int {
            ...
            i = 0 as libc::c_int;
            while i < 51 as libc::c_int {
                (*s).ntt_proot_pow[j as usize][inverse as usize]
                    [(51 as libc::c_int - i) as usize] = c;
                (*s).ntt_proot_pow_inv[j as usize][inverse as usize]
                    [(51 as libc::c_int - i) as usize] = init_mul_mod_fast2(c, m);
...
pub unsafe extern "C" fn bf_get_fft_size(
    ...
    while nb_mods <= 5 as libc::c_int {
        ...
        dpl = bf_min(
            ((int_bits - 4 as libc::c_int) / 2 as libc::c_int) as slimb_t,
            (2 as libc::c_int * ((1 as libc::c_int) << 6 as libc::c_int)
                + 2 as libc::c_int * 61 as libc::c_int
                - 62 as libc::c_int) as slimb_t,
        ) as libc::c_int;
        loop {
            fft_len_log2 = ceil_log2(
                len.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
                    .wrapping_add(dpl as libc::c_ulong)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    .wrapping_div(dpl as libc::c_ulong),
            );
            if fft_len_log2 > 51 as libc::c_int {
                break;
            }
            n_bits = fft_len_log2 + 2 as libc::c_int * dpl;
            if n_bits <= int_bits {
                cost = (((fft_len_log2 + 1 as libc::c_int) as limb_t) << fft_len_log2)
    ...
    if dpl_found > ((1 as libc::c_int) << 6 as libc::c_int) + 61 as libc::c_int
        && ((((1 as libc::c_int) << 6 as libc::c_int) + 61 as libc::c_int) as limb_t)
            << fft_len_log2_found
            >= len.wrapping_mul(((1 as libc::c_int) << 6 as libc::c_int) as libc::c_ulong)
    {
        dpl_found = ((1 as libc::c_int) << 6 as libc::c_int) + 61 as libc::c_int
    }
...
unsafe extern "C" fn fft_mul(
    ...
    if mul_flags & ((1 as libc::c_int) << 0 as libc::c_int | (1 as libc::c_int) << 1 as libc::c_int)
        == 0 as libc::c_int
    {
    ...
    buf1 = ntt_malloc(
        s,
        (::std::mem::size_of::<NTTLimb>() as libc::c_ulong)
            .wrapping_mul(fft_len as libc::c_ulong)
            .wrapping_mul(nb_mods as libc::c_ulong),
    ) as *mut NTTLimb;
    if buf1.is_null() {
        return -(1 as libc::c_int);
        ...
        7245201122033322888 => {
            ...
            loop {
                ...
                if reduced_mem != 0 {
                    ...
                    ptr = buf2.offset((fft_len * j as libc::c_long) as isize)
                }
                if ntt_conv(
                    s,
                    buf1.offset((fft_len * j as libc::c_long) as isize),
                    ptr,
                    fft_len_log2,
                    fft_len_log2,
                    (j + 5 as libc::c_int - nb_mods) as limb_t,
                ) != 0
                {
                    current_block = 11742859648667696368;
                    break;
