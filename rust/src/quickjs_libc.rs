...
extern "C" {
    ...
    #[no_mangle]
    fn execve(__path: *const libc::c_char, __argv: *const *mut libc::c_char,
    ...
    #[no_mangle]
    fn JS_NewAtomLen(ctx: *mut JSContext, str: *const libc::c_char,
                     len: size_t) -> JSAtom;
    #[no_mangle]
    ...
    #[no_mangle]
    fn JS_DefinePropertyValue(ctx: *mut JSContext, this_obj: JSValue,
                              prop: JSAtom, val: JSValue, flags: libc::c_int)
     -> libc::c_int;
    #[no_mangle]
...
pub unsafe extern "C" fn js_module_set_import_meta(mut ctx: *mut JSContext,
 ...
 -> libc::c_int {
    ...
    if func_val.tag as int32_t == JS_TAG_MODULE as libc::c_int {
        ...
        __assert_fail(b"JS_VALUE_GET_TAG(func_val) == JS_TAG_MODULE\x00" as
                          *const u8 as *const libc::c_char,
                      b"quickjs-libc.c\x00" as *const u8 as
                          *const libc::c_char,
                      523 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 62],
                                                &[libc::c_char; 62]>(b"int js_module_set_import_meta(JSContext *, JSValue, int, int)\x00")).as_ptr());
    }
    ...
    if strchr(module_name, ':' as i32).is_null() {
        ...
        if use_realpath != 0 {
            ...
            pstrcat(buf.as_mut_ptr(),
                    ::std::mem::size_of::<[libc::c_char; 4112]>() as
                        libc::c_ulong as libc::c_int, module_name);
        }
    } else {
        pstrcpy(buf.as_mut_ptr(),
                ::std::mem::size_of::<[libc::c_char; 4112]>() as libc::c_ulong
...
/* _WIN32 */
unsafe extern "C" fn js_std_setenv(mut ctx: *mut JSContext,
                                   mut this_val: JSValue,
                                   mut argc: libc::c_int,
                                   mut argv: *mut JSValue) -> JSValue {
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
...
unsafe extern "C" fn js_std_unsetenv(mut ctx: *mut JSContext,
                                     mut this_val: JSValue,
                                     mut argc: libc::c_int,
                                     mut argv: *mut JSValue) -> JSValue {
    let mut name: *const libc::c_char = 0 as *const libc::c_char;
...
/* return an object containing the list of the available environment
   variables. */
unsafe extern "C" fn js_std_getenviron(mut ctx: *mut JSContext,
                                       mut this_val: JSValue,
                                       mut argc: libc::c_int,
                                       mut argv: *mut JSValue) -> JSValue {
    let mut current_block: u64;
...
unsafe extern "C" fn get_bool_option(mut ctx: *mut JSContext,
                                     mut pbool: *mut BOOL, mut obj: JSValue,
...
unsafe extern "C" fn js_std_file_seek(mut ctx: *mut JSContext,
    ...
    if ret < 0 as libc::c_int { ret = -*__errno_location() }
    ...
    if magic != 0 {
        ret =
            fwrite(buf.offset(pos as isize) as *const libc::c_void,
                   1 as libc::c_int as libc::c_ulong, len, f)
    } else {
        ret =
            ...
            if full_flag == 0 &&
                ...
                loop 
                    ...
                    if http_get_header_line(f, buf,
                        ...
                        current_block =
                            10762102765549496082; /* remove the trailing CRLF */
                        break ;
                    }
                    if !(strcmp(buf,
                                b"\r\n\x00" as *const u8 as
                    ...
                    _ => {
                        ...
                        if dbuf_error(data_buf) != 0 {
                            ...
                            if JS_IsException(response) != 0 {
                                current_block = 3690914394173635162;
                            } else { current_block = 11561494241259596775; }
                        }
                    }
                }
            }
...
static mut js_std_funcs: [JSCFunctionListEntry; 23] =
    [JSCFunctionListEntry{name: 0 as *const libc::c_char,
                          prop_flags: 0,
                          def_type: 0,
                          magic: 0,
                          u:
                              C2RustUnnamed_2{func:
                                                  C2RustUnnamed_6{length: 0,
                                                                  cproto: 0,
                                                                  cfunc:
...
unsafe extern "C" fn js_std_init(mut ctx: *mut JSContext,
    ...
    JS_SetModuleExportList(ctx, m, js_std_funcs.as_ptr(),
                           (::std::mem::size_of::<[JSCFunctionListEntry; 23]>()
                                as
                                libc::c_ulong).wrapping_div(::std::mem::size_of::<JSCFunctionListEntry>()
                                                                as
                                                                libc::c_ulong)
    ...
    JS_SetModuleExport(ctx, m, b"in\x00" as *const u8 as *const libc::c_char,
                       js_new_std_file(ctx, stdin, FALSE as libc::c_int,
                                       FALSE as libc::c_int));
    JS_SetModuleExport(ctx, m, b"out\x00" as *const u8 as *const libc::c_char,
                       js_new_std_file(ctx, stdout, FALSE as libc::c_int,
                                       FALSE as libc::c_int));
    JS_SetModuleExport(ctx, m, b"err\x00" as *const u8 as *const libc::c_char,
                       js_new_std_file(ctx, stderr, FALSE as libc::c_int,
                                       FALSE as libc::c_int));
    return 0 as libc::c_int;
}
#[no_mangle]
...
unsafe extern "C" fn js_os_ttyGetWinSize(mut ctx: *mut JSContext,
    ...
    if ioctl(fd, 0x5413 as libc::c_int as libc::c_ulong,
             &mut ws as *mut winsize) == 0 as libc::c_int &&
...
unsafe extern "C" fn js_os_ttySetRaw(mut ctx: *mut JSContext,
    ...
    oldtty = tty;
    tty.c_iflag &=
        !(0o1 as libc::c_int | 0o2 as libc::c_int | 0o10 as libc::c_int |
              0o40 as libc::c_int | 0o100 as libc::c_int |
              0o200 as libc::c_int | 0o400 as libc::c_int |
              0o2000 as libc::c_int) as libc::c_uint;
    tty.c_oflag |= 0o1 as libc::c_int as libc::c_uint;
    tty.c_lflag &=
        !(0o10 as libc::c_int | 0o100 as libc::c_int | 0o2 as libc::c_int |
              0o100000 as libc::c_int) as libc::c_uint;
    tty.c_cflag &=
        !(0o60 as libc::c_int | 0o400 as libc::c_int) as libc::c_uint;
...
unsafe extern "C" fn get_time_ms() -> int64_t {
    ...
    return (ts.tv_sec as
                uint64_t).wrapping_mul(1000 as libc::c_int as
                                           libc::c_ulong).wrapping_add((ts.tv_nsec
                                                                            /
                                                                            1000000
                                                                                as
                                                                                libc::c_int
...
unsafe extern "C" fn js_os_poll(mut ctx: *mut JSContext) -> libc::c_int {
    ...
    if (*ts).recv_pipe.is_null() &&
           (os_pending_signals != 0 as libc::c_int as libc::c_ulong) as
    ...
    if list_empty(&mut (*ts).os_timers) == 0 {
        ...
        tv.tv_usec =
            (min_delay % 1000 as libc::c_int * 1000 as libc::c_int) as
                __suseconds_t;
        tvp = &mut tv
    ...
    let fresh31 =
        (::std::mem::size_of::<fd_set>() as
             libc::c_ulong).wrapping_div(::std::mem::size_of::<__fd_mask>() as
                                             libc::c_ulong);
    let fresh32 =
        &mut *wfds.fds_bits.as_mut_ptr().offset(0 as libc::c_int as isize) as
            *mut __fd_mask;
...
unsafe extern "C" fn js_os_mkdir(mut ctx: *mut JSContext,
    ...
    ret =
        js_get_errno(mkdir(path, mode as __mode_t) as ssize_t) as libc::c_int;
        ...
        loop  {
            *__errno_location() = 0 as libc::c_int;
            ...
            if d.is_null() {
                ...
                JS_DefinePropertyValueUint32(ctx, obj, fresh33,
                                             JS_NewString(ctx,
                                                          (*d).d_name.as_mut_ptr()),
                                             (1 as libc::c_int) <<
                                                 0 as libc::c_int |
...
unsafe extern "C" fn ms_to_timeval(mut tv: *mut timeval, mut v: uint64_t) {
    (*tv).tv_sec =
        v.wrapping_div(1000 as libc::c_int as libc::c_ulong) as __time_t;
    (*tv).tv_usec =
...
unsafe extern "C" fn js_os_utimes(mut ctx: *mut JSContext,
    ...
    ms_to_timeval(&mut *times.as_mut_ptr().offset(1 as libc::c_int as isize),
                  mtime as uint64_t);
    ret =
        js_get_errno(utimes(path, times.as_mut_ptr() as *const timeval) as
                         ssize_t) as libc::c_int;
    JS_FreeCString(ctx, path);
    return JS_NewInt32(ctx, ret);
}
...
unsafe extern "C" fn build_envp(mut ctx: *mut JSContext, mut obj: JSValue)
 -> *mut *mut libc::c_char {
    ...
    if envp.is_null() {
        ...
        loop  {
            if !(i < len) { current_block = 3322716925953924881; break ; }
            ...
            JS_FreeValue(ctx, val);
            if str.is_null() { current_block = 11032202465615545148; break ; }
...
unsafe extern "C" fn my_execvpe(mut filename: *const libc::c_char,
 ...
 -> libc::c_int {
    ...
    if !strchr(filename, '/' as i32).is_null() {
        return execve(filename, argv as *const *mut libc::c_char,
    ...
    while !p.is_null() {
        ...
        if !(path_len.wrapping_add(1 as libc::c_int as
            ...
            execve(buf.as_mut_ptr(), argv as *const *mut libc::c_char,
                   envp as *const *mut libc::c_char);
    ...
    if eacces_error != 0 { *__errno_location() = 13 as libc::c_int }
    return -(1 as libc::c_int);
}
...
unsafe extern "C" fn js_os_exec(mut ctx: *mut JSContext,
    ...
    loop  {
        ...
        str = JS_ToCString(ctx, val);
        JS_FreeValue(ctx, val);
        if str.is_null() { current_block = 6626686957411452786; break ; }
                    ...
                    if pid < 0 as libc::c_int {
                        ...
                        if pid == 0 as libc::c_int {
                            ...
                            let mut fd_max: libc::c_int =
                                sysconf(_SC_OPEN_MAX as libc::c_int) as
                                    libc::c_int;
                            ...
                            if use_path != 0 {
                                ...
                                ret =
                                    execve(file,
                                           exec_argv as *mut *mut libc::c_char
...
/* USE_WORKER */
#[no_mangle]
pub unsafe extern "C" fn js_std_set_worker_new_context_func(mut func:
        ...
        val =
            JS_GetPropertyStr(ctx, exception_val,
                              b"stack\x00" as *const u8 as
                                  *const libc::c_char);
        if JS_IsUndefined(val) == 0 { js_dump_obj(ctx, stderr, val); }
        JS_FreeValue(ctx, val);
    };
}
#[no_mangle]
...
pub unsafe extern "C" fn js_std_eval_binary(mut ctx: *mut JSContext,
    ...
    if !(JS_IsException(obj) != 0) {
        ...
        match current_block { 18159705403766749827 => { } _ => { return; } }
    }
    ...
    js_std_funcs =
        [{
         ...
         },
         {
             let mut init =
                 JSCFunctionListEntry{name:
                                          b"getenviron\x00" as *const u8 as
                                              *const libc::c_char,
                                      prop_flags:
                                          ((1 as libc::c_int) <<
                                               1 as libc::c_int |
